...
#Region " PAGE"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not IsPostBack Then
            ...
            If Me.cboPosicao.CallPosicao = 3 Then Me.cboFilial.Visible_cboCorporacao = False 'Caso Loja, esconde corporação
...
#End Region
    ...
    Sub PreencherGrupo()
        ...
        Select Case LCase(Trim(oProjeto.BuscarDepartamentoDoUsuario(Page.User.Identity.Name)))
            Case "administração", "diretor", "marketing"
