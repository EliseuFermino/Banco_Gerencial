...
Partial Class MemberPages_Inventario_Programa_InsercaoLotes
    ...
    Protected Sub Page_PreRenderComplete(sender As Object, e As System.EventArgs) Handles Me.PreRenderComplete
        CType(Master.Master.FindControl("lblTitle"), Label).Text = "Cadastro de Lotes"
    End Sub
    ...
    Protected Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles btnSalvar.Click
        ...
        clData_gerInv.usp4("Programa.uspSalvarLote", "@numInv", "@codEquipe", "@loteInicial", "@loteFinal", 8, Me.txtEquipe.Text, Me.txtLoteInicial.Text, Me.txtLoteFinal.Text)

        oVem.UserMsgBox(Me, "Lotes salvos com sucesso!!!")
