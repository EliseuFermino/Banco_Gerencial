<%@ Page Title="Analise Seções do Departamento 4 - Textil" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="menuPrincipal_Depto4.aspx.vb" Inherits="MemberPages_menuPrincipal_Depto4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><span class="glyphicon glyphicon-shopping-cart"></span> Numero de Clientes &nbsp e &nbsp <span class="glyphicon glyphicon-list-alt"></span> Ticket Médio - Comparativo com o Ano Anterior - Todas as Seções do Departamento 4 - Textil </h3>
				...
				<div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="glyphicon glyphicon-shopping-cart"></span> Numero de Clientes &nbsp e &nbsp <span class="glyphicon glyphicon-list-alt"></span> Ticket Médio - Secao 40 - Calçados</h4>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <dxchartsui:WebChartControl ID="graph_Secao40" runat="server" DataSourceID="dsClientesNumerosSecao40" Height="550px" Width="900px" AppearanceNameSerializable="Nature Colors" CrosshairEnabled="True">
                                    <diagramserializable>
                                        <cc1:XYDiagram>
    ...
    <cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                ...
                                <asp:SqlDataSource ID="dsClientesNumerosSecao40" runat="server" ConnectionString="<%$ ConnectionStrings:DW_VendasConnectionString %>" SelectCommand="uspBuscarNumeroDeClientes_12Meses_Secao" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="idFilial" SessionField="sFILIAL" Type="Byte" />
                                        <asp:SessionParameter Name="idSecao" DefaultValue="40" Type="Byte" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
				...
				<div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="glyphicon glyphicon-shopping-cart"></span> Numero de Clientes &nbsp e &nbsp <span class="glyphicon glyphicon-list-alt"></span> Ticket Médio - Secao 41 - Confecções</h4>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <dxchartsui:WebChartControl ID="graph_Secao41" runat="server" DataSourceID="dsClientesNumerosSecao41" Height="550px" Width="900px" AppearanceNameSerializable="Nature Colors" CrosshairEnabled="True">
                                    <diagramserializable>
                                        <cc1:XYDiagram>
                                            <axisx visibleinpanesserializable="-1" minorcount="1" visible="False">
                                                <range sidemarginsenabled="True" />
    ...
    <cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                ...
                                <asp:SqlDataSource ID="dsClientesNumerosSecao41" runat="server" ConnectionString="<%$ ConnectionStrings:DW_VendasConnectionString %>" SelectCommand="uspBuscarNumeroDeClientes_12Meses_Secao" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="idFilial" SessionField="sFILIAL" Type="Byte" />
                                        <asp:SessionParameter Name="idSecao" DefaultValue="41" Type="Byte" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
				...
				<div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="glyphicon glyphicon-shopping-cart"></span> Numero de Clientes &nbsp e &nbsp <span class="glyphicon glyphicon-list-alt"></span> Ticket Médio - Secao 42 - Cama, Mesa e Banho</h4>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <dxchartsui:WebChartControl ID="graph_Secao42" runat="server" DataSourceID="dsClientesNumerosSecao42" Height="550px" Width="900px" AppearanceNameSerializable="Nature Colors" CrosshairEnabled="True">
                                    <diagramserializable>
                                        <cc1:XYDiagram>
                                            <axisx visibleinpanesserializable="-1" minorcount="1" visible="False">
                                                <range sidemarginsenabled="True" />
    ...
    <cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                ...
                                <asp:SqlDataSource ID="dsClientesNumerosSecao42" runat="server" ConnectionString="<%$ ConnectionStrings:DW_VendasConnectionString %>" SelectCommand="uspBuscarNumeroDeClientes_12Meses_Secao" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="idFilial" SessionField="sFILIAL" Type="Byte" />
                                        <asp:SessionParameter Name="idSecao" DefaultValue="42" Type="Byte" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
				...
				<div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"<span class="glyphicon glyphicon-shopping-cart"></span> Numero de Clientes &nbsp e &nbsp <span class="glyphicon glyphicon-list-alt"></span> Ticket Médio - Secao 49 - Puericultura Leve e Acessorios	</h4>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <dxchartsui:WebChartControl ID="graph_Secao49" runat="server" DataSourceID="dsClientesNumerosSecao49" Height="550px" Width="900px" AppearanceNameSerializable="Nature Colors" CrosshairEnabled="True">
                                    <diagramserializable>
                                        <cc1:XYDiagram>
                                            <axisx visibleinpanesserializable="-1" minorcount="1" visible="False">
                                                <range sidemarginsenabled="True" />
    ...
    <cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                ...
                                <asp:SqlDataSource ID="dsClientesNumerosSecao49" runat="server" ConnectionString="<%$ ConnectionStrings:DW_VendasConnectionString %>" SelectCommand="uspBuscarNumeroDeClientes_12Meses_Secao" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="idFilial" SessionField="sFILIAL" Type="Byte" />
                                        <asp:SessionParameter Name="idSecao" DefaultValue="49" Type="Byte" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
