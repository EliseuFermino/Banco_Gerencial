<%@ Page Title="Analise Campanha" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="c001.aspx.vb" Inherits="MemberPages_Campanhas_Analises_c001" %>
    ...
    <div id="moldura">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div id="divBordaCampanha" class="myBorder">
                ...
                <div class="Titulo">
                    <asp:Label ID="lblTituloGrafico1" runat="server" Text=""></asp:Label>   
                </div>
                    ...
                    <dx:ASPxCallbackPanel ID="cbPanel" runat="server" Width="1020px" ClientInstanceName="cbPanel" Theme="Metropolis" SettingsLoadingPanel-Text="Aguarde. Atualizando&amp;hellip;">
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttributes="both">
                               ...
                               <div id="divGrafico1">
                    <dxchartsui:WebChartControl ID="grafico1" runat="server" DataSourceID="dsdGrafico1" Height="400px" Width="1000px" BackColor="Transparent">
                    ...
                    <asp:SqlDataSource ID="dsdGrafico1" runat="server" ConnectionString="<%$ ConnectionStrings:DW_Condor_One_ConnectionString %>" SelectCommand="Campanha.c001" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:SessionParameter Name="numCampanha" SessionField="sCAMPANHA" Type="Int32" />
                               ...
                               <div id="divGrafico2">
                                    <dxchartsui:WebChartControl ID="grid2" runat="server" DataSourceID="dsdGrafico2" Height="400px" Width="1000px" SideBySideEqualBarWidth="True" BackColor="Transparent">
                                        <borderoptions color="Gainsboro" />
                                    <diagramserializable>
                                        <cc1:XYDiagram>
                                            <axisx visibleinpanesserializable="-1"><label EnableAntialiasing="True"><resolveoverlappingoptions minindent="1" allowhide="False" /></label><range sidemarginsenabled="True" /></axisx>
                        ...
                        <PanelCollection>
                            <dx:PanelContent runat="server" SupportsDisabledAttributes="both">
                                ...
                                <div id="divDescProdutos">
                                    <asp:Label ID="lblDescProdutos" runat="server" Text="Produtos " Visible="true" Font-Size="14px" ></asp:Label>
                                </div>

                                <div id="divListaProdutos">
                                        <dx:ASPxComboBox ID="cboProdutos" runat="server" DataSourceID="dsListaProduto" AutoPostBack="true"  HorizontalAlign="Left" Visible="false"  ValueField="idProduto" Width="500px" DropDownRows="15" Font-Size="14px" SettingsLoadingPanel-Text="Carregando. Aguarde&amp;hellip;" ForeColor="#333333">
                                            <Columns>
                                ...
                                <div id="divGraficoItem1">
                                    <dxchartsui:WebChartControl ID="graficoItem1" runat="server" DataSourceID="dsGraficoItem1" Height="400px" Width="1000px" BackColor="Transparent">
                                        <borderoptions color="Gainsboro" />
                                        <diagramserializable>
                                            <cc1:XYDiagram>
                                                <axisx visibleinpanesserializable="-1"><label EnableAntialiasing="True"><resolveoverlappingoptions minindent="1" allowhide="False" /></label><range sidemarginsenabled="True" /></axisx>
                                ...
                                <div id="divGraficoItem2">
                                    ...
                                    <dxchartsui:WebChartControl ID="graficoItem2" runat="server" DataSourceID="dsGraficoItem2" Height="400px" Width="1000px" SideBySideEqualBarWidth="True" BackColor="Transparent">
                                        <borderoptions color="Gainsboro" />
                                    <diagramserializable>
                                        <cc1:XYDiagram>
                                            <axisx visibleinpanesserializable="-1"><label EnableAntialiasing="True"><resolveoverlappingoptions minindent="1" allowhide="False" /></label><range sidemarginsenabled="True" /></axisx>
