...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
 ...
 <script lang="javascript" type ="text/javascript">
     ...
     function OnGridFocusedRowChanged() {
         grid.GetRowValues(grid.GetFocusedRowIndex(), 'CODPRODUTO;nomeProduto;NROSERIE;VLRCSTCOML;VLRPRECOVENDA;PRECOVENDA;MRGVENDA;DataInclusao;DataDesativacao;Ativo;Fornecedor;NIVELAVARIA', OnGetRowValues);
     }
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">        
        ...
        <div class="row">
            ...
            <div class="col-md-3"  style="text-align:left">
                  <dx:ASPxComboBox ID="cboCampanha" runat="server" ClientInstanceName="cboCampanha" DataSourceID="dsListaCampanha" EnableIncrementalFiltering="True" EnableTheming="True" HorizontalAlign="Left" IncrementalFilteringMode="StartsWith" TextField="idCampanha" Theme="Metropolis" ValueField="idCampanha" Width="300px" DropDownRows="15">
            ...
            <div class="col-md-3">
                 <asp:Label runat="server" ID="lblError" Text="Eliseu Fermino"></asp:Label>
              ...
              <div class="active tab-pane" id="activity">
                ...
                cpPanelImagem.PerformCallback();
                                      ...
                                      <Columns>
                                          ...
                                          <dx:GridViewDataTextColumn FieldName="nomeProduto" VisibleIndex="1" Caption="Descrição do Produto" FixedStyle="Left" Width="170px">
                                          ...
                                          <dx:GridViewDataTextColumn FieldName="SITUACAO" VisibleIndex="14" Visible="False">
                                          </dx:GridViewDataTextColumn>
                       
                                          <dx:GridViewDataTextColumn FieldName="idCampanha" ShowInCustomizationForm="True" VisibleIndex="13">
                                          </dx:GridViewDataTextColumn>
    ...
    <div id="opcaoSalvar" runat="server" class="post">
                <div class="post">                        
                  ...
                  <!-- /.row -->
                    ...
                    <div id=idSalvar style="clear:both; padding-left: 1px; padding-top: 5px ">
                            <dx:ASPxButton ID="btnSalvarImagem" runat="server" Text="Salvar Imagem" CssClass="btn btn-success" Native="True"  >
                            </dx:ASPxButton>
                    </div>
