...
Partial Class MemberPages_LancamentoVendasOuroFino
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = " Lançamento de Vendas - Ouro Fino - PGR442"
        End If
    End Sub
    ...
    Public Function Salvar() As Boolean
        ...
        Dim comando As New SqlCommand("OuroFino.uspInsert", con)
