<%@ Page Title="Lançamento de Vendas - OuroFino" Language="VB" MasterPageFile="~/MemberPages/SiteOuroFino.master" AutoEventWireup="false" CodeFile="LancamentoVendasOuroFino.aspx.vb" Inherits="MemberPages_LancamentoVendasOuroFino" %>
                            ...
                            <dx:LayoutItem Caption="Quantidade" ColSpan="1">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer6" runat="server">
                                        <dx:ASPxTextBox ID="txtQtde" runat="server" Width="70px" AutoPostBack="True" Text="0" HorizontalAlign="Right" TabIndex="4" Theme="Mulberry" DisplayFormatString="{0:n2}"></dx:ASPxTextBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
