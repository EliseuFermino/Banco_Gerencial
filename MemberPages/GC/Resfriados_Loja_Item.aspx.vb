...
Partial Class MemberPages_GC_Resfriados_Loja_Item
...
#Region " Page"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            oVen.AtualizarEstatisticaPrograma(412, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Gerenciamento de Categoria - Abertura por Item - PGR412"
        End If
    End Sub
...
#End Region
    ...
    Protected Sub grid_CustomSummaryCalculate(sender As Object, e As DevExpress.Data.CustomSummaryEventArgs) Handles grid.CustomSummaryCalculate
        ...
        oFun.Grid_Footer_Calculate(sender, e, grid, "percTotalPerda", "vlrTotalPerda", "vlrVenda", Funcoes.CalculateType.ValueOverRevenue)
