<%@ Page Language="VB" AutoEventWireup="false" CodeFile="viewDespMesAberta.aspx.vb" Inherits="MemberPages_Despesas_Gestor_viewDespMesTotal" %>
    ...
    <div>
        ...
        <div>
            <table class="style1">
                <tr>
                    <td class="style2">
                        Meta x Realizado - Despesa Aberta - por Gestor - Mês</td>
                </tr>
                <tr>
                    <td>
            <b>Ano:</b>
...
&nbsp;&nbsp;&nbsp; <b>Gestor:</b>
                        <asp:DropDownList ID="cboGestor" runat="server" AutoPostBack="True" 
                            BackColor="#FFFFCC">
                        </asp:DropDownList>
                    </td>
                </tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            <asp:BoundField DataField="CatLinhaDesc" HeaderText="Conta" 
    ...
    <asp:SqlDataSource ID="dsGestorTotalMes" runat="server" 
        ...
        SelectCommand="uspGestorDespesas_Mes_Aberta" 
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="cboGestor" Name="Gestor" 
