...
Partial Class MemberPages_Despesas_DashBoard_DespesaLoja_New
    ...
    Private Sub OcultarMesAnterior()
        If CInt(Session("sMES")) < 13 Then
            Me.gridGrupoMes.Columns("bandMesAnterior").Visible = True
            oFun.Grid_Column_Visible(gridGrupoMes, "percCrescMA", True)
        Else
            Me.gridGrupoMes.Columns("bandMesAnterior").Visible = False
            oFun.Grid_Column_Visible(gridGrupoMes, "percCrescMA", False)
        End If
    ...
    Protected Sub gridN3_BeforePerformDataSelect(sender As Object, e As EventArgs)
    ...
    Protected Sub gridNota_BeforePerformDataSelect(sender As Object, e As EventArgs)
        Session("sN3") = (TryCast(sender, ASPxGridView)).GetMasterRowKeyValue()
    End Sub

    Protected Sub gridN3_HtmlDataCellPrepared(sender As Object, e As ASPxGridViewTableDataCellEventArgs)
        On Error Resume Next
    ...
    Protected Sub gridN3_CustomSummaryCalculate(sender As Object, e As DevExpress.Data.CustomSummaryEventArgs)
        Dim oBI As New BI
    ...
    Protected Sub gridN3_Load(sender As Object, e As EventArgs)
        Dim gridView As ASPxGridView = TryCast(sender, ASPxGridView)

        'Mosta / Oculta - Meta do Ano
        If Me.cboMes.rndPeriodo_Checked = False Then
    ...
    Protected Sub chkFixarCabecalho_CheckedChanged(sender As Object, e As EventArgs) Handles chkFixarCabecalho.CheckedChanged
        If Me.chkFixarCabecalho.Checked = False Then
            Me.gridGrupoMes.Settings.ShowVerticalScrollBar = False
        Else
            Me.gridGrupoMes.Settings.ShowVerticalScrollBar = True
        End If
    End Sub

#Region " Controles Atualizaveis"
...
#End Region
    ...
    Private Sub CallSession()
        ...
        Dim varTipo As Byte
        Dim varGrupo As Int16

        'Define Session("sTIPO")
        If Me.chkSubgrupo.Checked = True Then
            varTipo = 2
            varGrupo = cboSubgrupo.Value
        Else
            varTipo = 1
            varGrupo = cboGrupo.Value
        End If

        'Session("sANO") = Me.cboAno.CallAno
        'Session("sMES") = Me.cboMes.CallMes
        Session("sFILIAL") = Me.cboFilialNew.CallFilial
        Session("sTIPO") = varTipo
        Session("sGRUPO") = varGrupo
...
#Region " Page"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If LCase(Trim(oProj.BuscarLocalDoUsuario(Page.User.Identity.Name))) = "cd" Then btnShowButton.Visible = False
            ...
            cboFilialNew.AutoPostBack = False


            Me.cboAno.AnoInicial = 2012
            Me.cboAno.AnoFinal = Year(Now())

            Me.cboMes.AutoPostBack_cboMes = True
            'Me.cboMes.rndPeriodo_Enabled = False
    ...
    Protected Sub Page_PreRenderComplete(sender As Object, e As EventArgs) Handles Me.PreRenderComplete
        If Not IsPostBack Then
            CallSession()
            Me.gridGrupoMes.DataBind()
            If cboFilialNew.IsLoja = True Then btnShowButton.Visible = False
            If cboFilialNew.IsRegional = True Then btnShowButton.Visible = False
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Despesas por Grupo, Sub-grupo e Item - PGR15"
        End If
...
#End Region
    ...
    Protected Sub PopupControl_WindowCallback(source As Object, e As DevExpress.Web.PopupWindowCallbackArgs) Handles PopupControl.WindowCallback
    ...
    Protected Sub cboSize_SelectedIndexChanged_cboSize(sender As Object, e As EventArgs) Handles cboSize.SelectedIndexChanged_cboSize
        oFun.Grid_Size(gridGrupoMes, cboSize.CallSize)
    End Sub
