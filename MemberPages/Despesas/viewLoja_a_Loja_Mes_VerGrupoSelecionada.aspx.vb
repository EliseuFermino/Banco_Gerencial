...
Partial Class MemberPages_Despesas_Gestor_viewDespMesTotal
    ...
    Protected Sub GridView1_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowCreated
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If DataBinder.Eval(e.Row.DataItem, "difPerc") < 0D Then e.Row.Cells(6).ForeColor = Drawing.Color.Red
        End If
    End Sub

    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        With Me.GridView1
            .Columns(0).ItemStyle.Width = 180
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            'Se a coluna "Dif. Valor" for igual a Zero então a coluna "Dif. Perc." ficara zero.
            If e.Row.Cells(5).Text = 0 Then e.Row.Cells(6).Text = 0
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        oVEM.ListaDeGrupo(Me.cboGrupo, "CatLinhaCod", "CatLinhaDesc", 7)
    End Sub
