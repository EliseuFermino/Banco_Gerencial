...
Partial Class MemberPages_Dashboard
    ...
    Protected Sub cboMes_rndMesChanged(sender As Object, e As EventArgs) Handles cboMes.rndMesChanged
        Me.cboMes.Enabled_cboMes = True
        Me.cboMes.CallMes = Month(DateAndTime.Now()) - 1
        Session("sMES") = Me.cboMes.CallMes
        Me.dsGrupoMes.DataBind()
        If cboMes.rndMes_Checked = True Then
            Me.gridGrupoMes.Columns.Item("bandMesAnterior").Visible = True
        End If
    End Sub

    Protected Sub cboMes_rndPeriodoChanged(sender As Object, e As EventArgs) Handles cboMes.rndPeriodoChanged
        Me.cboMes.CallMes = 99
        Session("sMES") = Me.cboMes.CallMes
        Me.cboMes.Enabled_cboMes = False
        Me.dsGrupoMes.DataBind()
        If cboMes.rndPeriodo_Checked = True Then
            Me.gridGrupoMes.Columns.Item("bandMesAnterior").Visible = False
        End If
    End Sub
    ...
    Protected Sub gridSub_CustomSummaryCalculate(sender As Object, e As DevExpress.Data.CustomSummaryEventArgs)
        ...
        oBI.BI_Buscar_Ori_Rev_Real_RealAA(Me.cboAno.CallAno, Me.cboMes.CallMes, Me.cboFilial.CallFilial, (TryCast(sender, ASPxGridView)).GetMasterRowKeyValue())
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            If Me.rndGrupo.Checked = True Then
                ...
                Session("sTIPO") = 1
            Else
                Session("sGRUPO") = Me.cboGrupo.CallSubgrupo
                Session("sTIPO") = 2
            End If
            Session("sANO") = Me.cboAno.CallAno
            Session("sMES") = Me.cboMes.CallMes
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        CType(Master.Master.FindControl("lblTitle"), Label).Text = "Despesas por Grupo, Sub-grupo e Item"
    End Sub

    Protected Sub btnExcel_BotaoClick(sender As Object, e As EventArgs) Handles btnExcel.BotaoClick
        Me.btnExcel.CallGridViewID = "gridGrupoMes"
    End Sub

    Protected Sub cboGrupo_ListGrupoChanged(sender As Object, e As EventArgs) Handles cboGrupo.ListGrupoChanged
        Session("sGRUPO") = Me.cboGrupo.CallGrupo
        Me.gridGrupoFiliais.SettingsText.Title = "Conta: " & Me.cboGrupo.CallGrupoDesc & "."
    End Sub

    Protected Sub gridGrupoFiliais_HtmlDataCellPrepared(sender As Object, e As ASPxGridViewTableDataCellEventArgs) Handles gridGrupoFiliais.HtmlDataCellPrepared
        On Error Resume Next
    ...
    Protected Sub rndSubgrupo_CheckedChanged(sender As Object, e As EventArgs) Handles rndSubgrupo.CheckedChanged
        ...
        If rndSubgrupo.Checked = True Then
            Me.cboGrupo.Visible_cboSubgrupo = True
            Me.cboGrupo.Visible_LabelSubGrupo = True
            Me.cboGrupo.Subgrupo_Label_ForeColor = Drawing.Color.White
            Session("sTIPO") = 2
            '          Session("sGRUPO") = Me.cboGrupo.CallSubgrupo
            '        Me.gridGrupoFiliais.SettingsText.Title = "Conta: " & Me.cboGrupo.CallGrupoDesc & " -> " & Me.cboGrupo.CallSubgrupoDesc & "."
        End If
    End Sub
