...
Partial Class MemberPages_Campanha_Pascoa_Bombom
...
#Region " Page"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Not IsPostBack Then
            ...
            oVem.AtualizarEstatisticaPrograma(97, User.Identity.Name)
            Session("sCAMPANHA") = 1
            ...
            Session("sCAMPANHA") = 1
            Session("sCOD") = 1 'Caixa de Bombons
            Session("sFILIAL") = 99
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        CType(Master.Master.FindControl("lblTitle"), Label).Text = "Análise de Caixa de Bombom " & Me.cboAno.CallAno & " - PGR97"
    End Sub
...
#Region " Meus Scipts"
    ...
    Private Sub myLegendas()
        ...
        oFun.Grid_Title(Me.ASPxGridView1, "Análise de Caixa de Bombom " & anoAT)
        oFun.Grid_Title(Me.gridMeta, "Comparativo - Caixa de Bombom - Meta x Realizado " & anoAT)
        oFun.Grid_Title(Me.gridTodosItens, "Caixa de Bombom - Todos os Itens - " & anoAT)
