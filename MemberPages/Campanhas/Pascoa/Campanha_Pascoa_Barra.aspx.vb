...
Partial Class MemberPages_Campanha_Pascoa_Barra
...
#Region " Page"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Not IsPostBack Then
            ...
            oVem.AtualizarEstatisticaPrograma(103, User.Identity.Name)
            Session("sCAMPANHA") = 1
            ...
            Session("sCAMPANHA") = 1
            Session("sCOD") = 6 'Barra de Chocolate
            Session("sFILIAL") = 99
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            oFun.Grid_Column_BorderRight(gridTodosItens, "percCrescQtde", Drawing.Color.Gray, BorderStyle.Solid, 1)
            oFun.Grid_Column_BorderRight(gridTodosItens, "percCrescVenda", Drawing.Color.Gray, BorderStyle.Solid, 1)
            oFun.Grid_Column_BorderRight(gridTodosItens, "percCrescLucro", Drawing.Color.Gray, BorderStyle.Solid, 1)
            oFun.Grid_Column_BorderRight(gridTodosItens, "difPercMargem", Drawing.Color.Gray, BorderStyle.Solid, 1)
        End If
    End Sub


    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        CType(Master.Master.FindControl("lblTitle"), Label).Text = "Análise de Barra de Chocolate " & Me.cboAno.CallAno & " - PGR103"
    End Sub
...
#Region " Meus Scipts"
    ...
    Private Sub myLegendas()
        ...
        oFun.Grid_Title(Me.ASPxGridView1, "Análise de Barras de Chocolate " & anoAT)
        oFun.Grid_Title(Me.gridMeta, "Comparativo - Barras de Chocolate - Meta x Realizado " & anoAT)
        oFun.Grid_Title(Me.gridTodosItens, "Barras de Chocolate - Todos os Itens - " & anoAT)
...
#Region " gridTodosItens"
    ...
    Protected Sub gridTodosItens_CustomSummaryCalculate(sender As Object, e As DevExpress.Data.CustomSummaryEventArgs) Handles gridTodosItens.CustomSummaryCalculate
        ...
        oFun.Grid_Footer_Calculate(sender, e, Me.gridTodosItens, "percMargemAA", "LucroComercialAA", "VendaAA", Funcoes.CalculateType.ValueOverRevenue)
        oFun.Grid_Footer_Calculate(sender, e, Me.gridTodosItens, "percCrescVenda", "Venda", "VendaAA", Funcoes.CalculateType.Growth)
        oFun.Grid_Footer_Calculate(sender, e, Me.gridTodosItens, "percCrescQtde", "QtdVendas", "QtdVendasAA", Funcoes.CalculateType.Growth)
        oFun.Grid_Footer_Calculate(sender, e, Me.gridTodosItens, "percCrescLucro", "LucroComercial", "LucroComercialAA", Funcoes.CalculateType.Growth)
        oFun.Grid_Footer_Calculate(sender, e, Me.gridTodosItens, "difPercMargem", "PercMargem", "PercMargemAA", Funcoes.CalculateType.Decrease)
    ...
    Protected Sub gridTodosItens_HtmlFooterCellPrepared(sender As Object, e As ASPxGridViewTableFooterCellEventArgs) Handles gridTodosItens.HtmlFooterCellPrepared
        oFun.Grid_RedIsNegativeFooter(sender, e)
    End Sub
