      ...
      <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-2">
                ...
                <Items>
                    <dx:ListEditItem Selected="True" Text="0-Total Páscoa" Value="0" />
                    <dx:ListEditItem Text="2-Ovos" Value="2" />
                    <dx:ListEditItem Text="1-Caixa de Bombom" Value="1" />
                    <dx:ListEditItem Text="9-Outros Chocolates" Value="9" />
                    <dx:ListEditItem Text="4-Colomba" Value="4" />
                    <dx:ListEditItem Text="5-Bacalhau" Value="5" />
                    <dx:ListEditItem Text="6-Barras de Chocolate" Value="6" />
                    <dx:ListEditItem Text="7-Chocolate Presentes" Value="7" />
                    <dx:ListEditItem Text="10-Azeitonas" Value="10" />
                    <dx:ListEditItem Text="11-Peixes Enlatados" Value="11" />
                    <dx:ListEditItem Text="12-Azeites" Value="12" />
                    <dx:ListEditItem Text="100-Mundo Chocolates" Value="100" />
                </Items>
            </dx:ASPxComboBox>
            </div>
                                    ...
                                    <table class="auto-style1"> 
                                        ...
                                        <tr>
                                            <td style="border:solid; border-width:1px; font-size:20px; background-color:darkblue;color:white; height:70px; text-align:center; width:220px">
                                                <asp:Label ID="lblTituloQtdeAT" runat="server" Text="Realizado Volume"></asp:Label> <br />
                                        ...
                                        <tr>
                                             ...
                                             <td style="border:solid; border-width:1px; font-size:20px; background-color:darkblue;color:white; height:70px; text-align:center; width:220px">
                                                <asp:Label ID="lblTituloQtdeAA" runat="server" Text="Realizado Volume"></asp:Label> <br />
                                        ...
                                        <tr>
                                             ...
                                             <td style="border:solid; border-width:1px; font-size:20px; background-color:darkblue;color:white; height:70px; text-align:center; width:220px">
                                                <asp:Label ID="lblTituloVolumeAA1" runat="server" Text="Realizado Volume"></asp:Label> <br />
                                        ...
                                        <tr>
                                             ...
                                             <td style="border:solid; border-width:1px; font-size:20px; background-color:darkblue;color:white; height:70px; text-align:center; width:220px">
                                                <asp:Label ID="Label13" runat="server" Text="Realizado Volume"></asp:Label> <br />
                                            ...
                                            <td style="border:solid; border-width:1px; font-size:20px; background-color:darkred; color:white; height:70px; text-align:center; width:220px">
                                                <asp:Label ID="Label15" runat="server" Text="% Cresc"></asp:Label> <br />
