<%@ Page Title="Bombom - Páscoa" Language="VB" MasterPageFile="~/MemberPages/mpCampanha_Pascoa.master" AutoEventWireup="false" CodeFile="Campanha_Pascoa_Bombom.aspx.vb" Inherits="MemberPages_Campanha_Pascoa_Bombom" %>
...
<dxwgv:ASPxGridView ID="gridTodosItens" runat="server" AutoGenerateColumns="False" DataSourceID="dsTodos" EnableTheming="True" Theme="DevEx" Width="990px" >
                            ...
                            <Columns>
                                ...
                                <dxwgv:GridViewBandColumn Caption="Estoques" VisibleIndex="9">
                                    <Columns>
                                        <dxwgv:GridViewDataTextColumn Caption="Volume" FieldName="qtdeEstoque" VisibleIndex="0" Width="70px">
                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                            </PropertiesTextEdit>
                            ...
                            <Settings ShowTitlePanel="True" ShowFooter="True" ShowVerticalScrollBar="True" VerticalScrollableHeight="450" ShowGroupPanel="true" ShowGroupFooter="VisibleAlways" ShowFilterRow="True"  />
                            <SettingsText Title="Caixa de Bombom - Todos Itens" EmptyDataRow="Não há informações disponiveis" GroupPanel="Arraste o cabeçalho de uma coluna abaixo aqui dentro para agrupar" />
                            <Styles>
