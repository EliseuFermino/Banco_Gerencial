<%@ Page Title="" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="Analise_Inverno.aspx.vb" Inherits="MemberPages_Campanhas_Inverno_Analise_Inverno" %>
    ...
    <div class="container-fluid">
        ...
        <div class="container justify-content-center" style="padding: 15px 0 15px 0">
            <div class="row col-md-12 justify-content-center text-center">
                <div class="col col-auto" style="max-width: 250px; max-height: 30px;">
                    <div class="input-group input-group md">
                        <div class="input-group-prepend" style="max-height: 30px">
                            <div class="input-group-text" style="font-size: 12px">Filtro</div>
                        </div>
                        <asp:DropDownList class="form-control" Font-Size="14px" Height="30px" ID="selCod" runat="server" DataTextField="Desc">
                            <asp:ListItem Selected="True" Text="0-Total Páscoa" Value="0" />
                            <asp:ListItem Text="2-Ovos" Value="2" />
                            <asp:ListItem Text="1-Caixa de Bombom" Value="1" />
                            <asp:ListItem Text="9-Outros Chocolates" Value="9" />
                            <asp:ListItem Text="4-Colomba" Value="4" />
                            <asp:ListItem Text="5-Bacalhau" Value="5" />
                            <asp:ListItem Text="6-Barras de Chocolate" Value="6" />
                            <asp:ListItem Text="7-Chocolate Presentes" Value="7" />
                            <asp:ListItem Text="10-Azeitonas" Value="10" />
                            <asp:ListItem Text="11-Peixes Enlatados" Value="11" />
                            <asp:ListItem Text="12-Azeites" Value="12" />
                            <asp:ListItem Text="100-Mundo Chocolates" Value="100" />
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col col-auto" style="max-width: 250px; max-height: 30px;">
                    <div class="input-group input-group md">
                        <div class="input-group-prepend" style="max-height: 30px">
                            <div class="input-group-text" style="font-size: 12px">Filial</div>
                        </div>
                        <asp:DropDownList class="form-control" Font-Size="14px" Height="30px" ID="selFilial" runat="server" DataTextField="Desc"></asp:DropDownList>
                    </div>
                </div>
                <div class="col col-auto" style="width: auto;">
                    <div class="input-group ">
                        <div class="input-group-prepend" style="max-height: 30px">
                            <div class="input-group-text" style="font-size: 12px">Tipo</div>
                        </div>
                        <asp:DropDownList class="form-control" ID="selTipo" Font-Size="14px" Width="110px" Height="30px" runat="server" DataTextField="Desc" AutoPostBack="true" OnSelectedIndexChanged="selTipo_SelectedIndexChanged"></asp:DropDownList>
                    </div>
                </div>
                <div class="col-auto">
        ...
        <dx:ASPxCallbackPanel ID="cboPanel" runat="server" Width="100%" ClientInstanceName="cbPanel" Theme="Metropolis" Images-LoadingPanel-AlternateText="Aguarde. Atualizando">
            ...
            <PanelCollection>
                <dx:PanelContent>
                        ...
                        <div class="row col-md-12 justify-content-center text-center">
                            ...
                            <div class="col-auto">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h4 class="widget-title"><span class="fa fa-pie-chart">&nbsp</span> Gráfico de Participação das Categorias de Inverno</h4>
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <dxchartsui:WebChartControl ID="graf_Participacao" runat="server"
                                                ...
                                                Height="350px" CrosshairEnabled="True" AutoLayout="True" Width="500px">
                                                <SeriesSerializable>
                            ...
                            <div class="col-auto">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h4 class="widget-title"><span class="fa fa-pie-chart">&nbsp</span> Gráfico de Participação - Inverno X ??????</h4>
                                    ...
                                    <div class="widget-main">
                                        ...
                                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" DataSourceID="SqlDataSource2" AutoGenerateColumns="False" KeyFieldName="Dia" Width="100%">
                                            ...
                                            <TotalSummary>
                                                ...
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="OutrosChocolatesVlr" SummaryType="Sum" />
                                                ...
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="OutrosChocolatesVolume" SummaryType="Sum" />
                                                ...
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="OutrosChocolatesMargemVlr" SummaryType="Sum" />
                                                ...
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="ChocolatePresenteVlr" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeitonaVlr" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="PeixeEnlatadoVlr" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeiteVlr" SummaryType="Sum" />

                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="ChocolatePresenteVolume" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeitonaVolume" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="PeixeEnlatadoVolume" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeiteVolume" SummaryType="Sum" />

                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="ChocolatePresenteMargemVlr" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeitonaMargemVlr" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="PeixeEnlatadoMargemVlr" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeiteMargemVlr" SummaryType="Sum" />
                                                ...
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="OutrosChocolatesMargem" SummaryType="Custom" />
                                                ...
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="ChocolatePresenteMargem" SummaryType="Custom" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="AzeitonaMargem" SummaryType="Custom" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="PeixeEnlatadoMargem" SummaryType="Custom" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="AzeiteMargem" SummaryType="Custom" />
                                            </TotalSummary>
                                            <GroupSummary>
                                                ...
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="OutrosChocolatesVlr" ShowInGroupFooterColumn="OutrosChocolatesVlr" SummaryType="Sum" />
                                                ...
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="OutrosChocolatesVolume" ShowInGroupFooterColumn="OutrosChocolatesVolume" SummaryType="Sum" />
                                                ...
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="OutrosChocolatesMargemVlr" ShowInGroupFooterColumn="OutrosChocolatesMargemVlr" SummaryType="Sum" />
                                                ...
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="ChocolatePresenteVlr" ShowInGroupFooterColumn="ChocolatePresenteVlr" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeitonaVlr" ShowInGroupFooterColumn="AzeitonaVlr" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="PeixeEnlatadoVlr" ShowInGroupFooterColumn="PeixeEnlatadoVlr" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeiteVlr" ShowInGroupFooterColumn="AzeiteVlr" SummaryType="Sum" />

                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="ChocolatePresenteVolume" ShowInGroupFooterColumn="ChocolatePresenteVolume" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeitonaVolume" ShowInGroupFooterColumn="AzeitonaVolume" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="PeixeEnlatadoVolume" ShowInGroupFooterColumn="PeixeEnlatadoVolume" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeiteVolume" ShowInGroupFooterColumn="AzeiteVolume" SummaryType="Sum" />

                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="ChocolatePresenteMargemVlr" ShowInGroupFooterColumn="ChocolatePresenteMargemVlr" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeitonaMargemVlr" ShowInGroupFooterColumn="AzeitonaMargemVlr" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="PeixeEnlatadoMargemVlr" ShowInGroupFooterColumn="PeixeEnlatadoMargemVlr" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeiteMargemVlr" ShowInGroupFooterColumn="AzeiteMargemVlr" SummaryType="Sum" />

                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="ChocolatePresenteMargem" ShowInGroupFooterColumn="ChocolatePresenteMargem" SummaryType="Custom" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeitonaMargem" ShowInGroupFooterColumn="AzeitonaMargem" SummaryType="Custom" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="PeixeEnlatadoMargem" ShowInGroupFooterColumn="PeixeEnlatadoMargem" SummaryType="Custom" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="AzeiteMargem" ShowInGroupFooterColumn="AzeiteMargem" SummaryType="Custom" />
                                                ...
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="OutrosChocolatesMargem" ShowInGroupFooterColumn="OutrosChocolatesMargem" SummaryType="Custom" />
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewBandColumn Caption="Outros Chocolates" VisibleIndex="7">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn FieldName="OutrosChocolatesVolume" VisibleIndex="0" Caption="Volume" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="OutrosChocolatesVlr" VisibleIndex="1" Caption="R$" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                            <CellStyle ForeColor="Blue">
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="OutrosChocolatesMargem" VisibleIndex="3" Caption="Margem" Width="60px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                            <CellStyle>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Lucro" FieldName="OutrosChocolatesMargemVlr" VisibleIndex="2" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                        </dx:GridViewDataTextColumn>
                                                    </Columns>
                                                ...
                                                <dx:GridViewBandColumn Caption="Bacalhau" VisibleIndex="12">
                                                    <Columns>
                                                ...
                                                <dx:GridViewBandColumn Caption="Barras" VisibleIndex="14">
                                                    <Columns>
                                                ...
                                                <dx:GridViewBandColumn Caption="Chocolates Presentes" ShowInCustomizationForm="True" VisibleIndex="15">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="Volume" FieldName="ChocolatePresenteVolume" ShowInCustomizationForm="True" VisibleIndex="0" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="R$" FieldName="ChocolatePresenteVlr" ShowInCustomizationForm="True" VisibleIndex="1" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Lucro" FieldName="ChocolatePresenteMargemVlr" ShowInCustomizationForm="True" VisibleIndex="2" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Margem" FieldName="ChocolatePresenteMargem" ShowInCustomizationForm="True" VisibleIndex="3" Width="60px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                ...
                                                <dx:GridViewBandColumn Caption="Azeitonas" ShowInCustomizationForm="True" VisibleIndex="16">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="Volume" FieldName="AzeitonaVolume" ShowInCustomizationForm="True" VisibleIndex="0" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="R$" FieldName="AzeitonaVlr" ShowInCustomizationForm="True" VisibleIndex="1" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Lucro" FieldName="AzeitonaMargemVlr" ShowInCustomizationForm="True" VisibleIndex="2" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Margem" FieldName="AzeitonaMargem" ShowInCustomizationForm="True" VisibleIndex="3" Width="60px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                ...
                                                <dx:GridViewBandColumn Caption="Peixes Enlatados" ShowInCustomizationForm="True" VisibleIndex="17">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="Volume" FieldName="PeixeEnlatadoVolume" ShowInCustomizationForm="True" VisibleIndex="0" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="R$" FieldName="PeixeEnlatadoVlr" ShowInCustomizationForm="True" VisibleIndex="1" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Lucro" FieldName="PeixeEnlatadoMargemVlr" ShowInCustomizationForm="True" VisibleIndex="2" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Margem" FieldName="PeixeEnlatadoMargem" ShowInCustomizationForm="True" VisibleIndex="3" Width="60px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                ...
                                                <dx:GridViewBandColumn Caption="Azeite" ShowInCustomizationForm="True" VisibleIndex="18">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="Volume" FieldName="AzeiteVolume" ShowInCustomizationForm="True" VisibleIndex="0" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="R$" FieldName="AzeiteVlr" ShowInCustomizationForm="True" VisibleIndex="1" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Lucro" FieldName="AzeiteMargemVlr" ShowInCustomizationForm="True" VisibleIndex="2" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="Margem" FieldName="AzeiteMargem" ShowInCustomizationForm="True" VisibleIndex="3" Width="60px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        </dx:GridViewDataTextColumn>
                    ...
                    <div id="divRowParticipacao" class="row" runat="server">
                                        ...
                                        <dx:ASPxGridView ID="gridParticipacao" runat="server" AutoGenerateColumns="False" DataSourceID="dsParticipacao" EnableTheming="True" Theme="SoftOrange" Width="100%" KeyboardSupport="True" KeyFieldName="DateAbrev1">
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewBandColumn Caption="2021" ShowInCustomizationForm="True" VisibleIndex="3" Name="gridParticipacao_AA">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="Venda" FieldName="vlrVendaAA" ShowInCustomizationForm="True" VisibleIndex="1" Width="90px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="% Part" FieldName="percPartVendaAA" ShowInCustomizationForm="True" ToolTip="Percentual de Atingimento" VisibleIndex="2" Width="75px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <Settings AllowAutoFilter="False" />
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Volume" FieldName="VolumeAA" ShowInCustomizationForm="True" VisibleIndex="0">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                        </dx:GridViewDataTextColumn>
                                                    </Columns>
                                                </dx:GridViewBandColumn>
                                                <dx:GridViewBandColumn Caption="Vendas 2023" ShowInCustomizationForm="True" VisibleIndex="5" Name="gridParticipacao_AT">
                                                    <Columns>
                                                ...
                                                <dx:GridViewBandColumn Caption="2021 x 2022" ShowInCustomizationForm="True" VisibleIndex="6" Name="gridParticipacao_Diferenca">
                                                    <Columns>
                                                ...
                                                <dx:GridViewBandColumn Caption="Participação Acumulada" ShowInCustomizationForm="True" VisibleIndex="9">
                                                    <HeaderStyle BackColor="Gray" />
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="2021" FieldName="running_percPartVendaAA" ShowInCustomizationForm="True" VisibleIndex="0" Width="85px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <HeaderStyle BackColor="Gray" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="2022" FieldName="running_percPartVendaAT" ShowInCustomizationForm="True" VisibleIndex="1" Width="85px">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                            <HeaderStyle BackColor="Gray" />
                                                        </dx:GridViewDataTextColumn>
                                                ...
                                                <dx:GridViewBandColumn Caption="Venda Acumulada" ShowInCustomizationForm="True" VisibleIndex="8">
                                                    <HeaderStyle BackColor="Gray" />
                                                    <Columns>
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="Datekey" ShowInCustomizationForm="True" SortIndex="1" SortOrder="Ascending" Visible="False" VisibleIndex="10">
                                                </dx:GridViewDataTextColumn>


                                                <dx:GridViewBandColumn Caption="Volume 2023" ShowInCustomizationForm="True" VisibleIndex="4">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn FieldName="VolumeAT" ShowInCustomizationForm="True" VisibleIndex="0">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="% Cresc" ShowInCustomizationForm="True" VisibleIndex="1" FieldName="percCrescVolume">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                        </dx:GridViewDataTextColumn>
                                                    </Columns>
                                                ...
                                                <dx:GridViewBandColumn Caption="Volume Acumulada" ShowInCustomizationForm="True" VisibleIndex="7">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="2022" FieldName="running_VolumeAA" ShowInCustomizationForm="True" VisibleIndex="0">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="2023" FieldName="running_VolumeAT" ShowInCustomizationForm="True" VisibleIndex="1">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="% Cresc" FieldName="running_percCrescVolume" ShowInCustomizationForm="True" VisibleIndex="2">
                                                            <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                            </PropertiesTextEdit>
                                                        </dx:GridViewDataTextColumn>
                                                    </Columns>
                                            ...
                                            <GroupSummary>
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="VolumeAA" ShowInGroupFooterColumn="VolumeAA" SummaryType="Sum" />
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="VolumeAT" ShowInGroupFooterColumn="VolumeAT" SummaryType="Sum" />
                                                ...
                                                <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="percCrescVolume" ShowInGroupFooterColumn="percCrescVolume" SummaryType="Custom" />
