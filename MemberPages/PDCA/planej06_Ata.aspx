<%@ Page Title="Diário de Bordo - PDCA" Language="VB" MasterPageFile="~/MemberPages/PDCA/mpPlanejamento.master" AutoEventWireup="false" CodeFile="planej06_Ata.aspx.vb" Inherits="Ranking_planej06_DiarioBordo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="panGeral" runat="server" BackColor="White" BorderColor="#8ab216" 
        ...
        <table class="style1">
            <tr>
                ...
                <td align="left" rowspan="9" valign="top">
                    <asp:Panel ID="panMemoriaTable" runat="server" BorderColor="#8ab216"
                        ...
                        <table class="style1">
                            <tr>
                                <td class="style9" style="font-weight: bold; color: #336600; width: 144px">
                                    Nome do Projeto:</td>
                                <td>
                        ...
                        <table class="style1">
                            <tr>
                                <td class="style8" style="font-weight: bold; color: #336600; width: 149px" 
                                    align="left" valign="top">
                                    Atividade Desenvolvida:</td>
                                <td style="width: 409px" align="left" valign="top">
                                    
                                    <dxe:ASPxMemo ID="txtMemo" runat="server" Height="245px" Width="360px" Font-Size="Medium"></dxe:ASPxMemo>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <dxe:ASPxButton ID="btnNovo" runat="server" 
                                                    ...
                                                    Text="Novo" Width="90px" Theme="Youthful">
                                                </dxe:ASPxButton>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <dxe:ASPxButton ID="btnCancelar" runat="server" 
                                                    CssFilePath="~/App_Themes/Aqua/{0}/styles.css" CssPostfix="Aqua" 
                                                    Text="Cancelar" Width="90px" Theme="Youthful">
                                                </dxe:ASPxButton>
                                            </td>
                                        </tr>
                                        <tr>
            ...
            <tr>
                <td align="center" class="style4" valign="top" 
                    style="width: 209px; font-weight: bold; color: #336600;">
            ...
            <tr>
                <td align="center" class="style4" 
                    ...
                    <dxe:ASPxComboBox ID="cboList" runat="server" AutoPostBack="True" 
                        ...
                        ValueField="ID" Width="151px" Theme="Youthful">
