...
#Region " Buscar Atas"
    ...
    Sub BuscarAtas()
        ...
        Else
            ...
            comando.Parameters.Add(New SqlParameter("@idAta", Data.SqlDbType.Int))
            comando.Parameters("@idAta").Value = CInt(Me.txtAtaID.Value)
...
#Region " Page"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            cboAcompProjeto.Visible_btnSubprojeto = False
            cboAcompProjeto.Visible_cboSubProjeto = False
            cboAcompProjeto.Visible_lblSubConta = False
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.Master.FindControl("lblTitle"), Label).Text = "Plano de Ação Loja - PDCA"
        End If
