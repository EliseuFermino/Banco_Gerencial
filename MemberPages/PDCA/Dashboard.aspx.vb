...
Partial Class MemberPages_PDCA_Dashboard
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            oVem.AtualizarEstatisticaPrograma(314, Page.User.Identity.Name)
    ...
    Protected Sub btnExcluir_Click(sender As Object, e As EventArgs) Handles btnExcluir.Click
        ...
        oDB.ExecuteStoredProcedure("PDCA.usp_Excluir_PlanoAcao", Conexao.gerProjetos.ConnectionString, "@ID", CInt(txtID.Text))
        oVem.UserMsgBox(Me, "O Plano de Ação foi excluido!!!")
        grid_PlanoAcao.DataBind()
    ...
    Protected Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        Call Linkar("cadPlanoAcao.aspx", CInt(txtID.Text), CByte(cboFilial.CallFilial))
    End Sub
