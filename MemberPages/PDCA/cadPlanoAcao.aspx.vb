...
Partial Class MemberPages_cadPlanoAcao
    ...
    Protected Sub btnNovo_Click(sender As Object, e As EventArgs) Handles btnNovo.Click
        ...
        If cboTarefa.SelectedValue > 0 Or IsNothing(cboTarefa.SelectedValue) Then
    ...
    Protected Sub Page_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
        If Not IsPostBack Then
            ...
            lblError.Text = "Filial: " & Session("sFILIAL") & " cboArea: " & Session("sAREA") & " cboConta: " & Session("sCONTA") & " sID: " & Session("sID")
        End If
    End Sub
End Class
