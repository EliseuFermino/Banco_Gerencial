...
#Region " Public Property"
    ...
    Public Property Visible_cboSubProjeto() As Boolean
        Get
            Return cboSubProjeto.Visible
        End Get
        Set(ByVal value As Boolean)
            cboSubProjeto.Visible = value
        End Set
    End Property

    Public Property Visible_lblSubConta() As Boolean
        Get
            Return lblSubconta.Visible
        End Get
        Set(ByVal value As Boolean)
            lblSubconta.Visible = value
        End Set
    End Property
    ...
    Public Property Visible_btnSubprojeto() As Boolean
        Get
            Return btnSubprojeto.Visible
        End Get
        Set(ByVal value As Boolean)
            btnSubprojeto.Visible = value
        End Set
    End Property
