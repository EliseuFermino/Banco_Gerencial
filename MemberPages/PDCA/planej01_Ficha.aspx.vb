...
Partial Class Ranking_planej01_Ficha
    ...
    Sub Salvar()
        ...
        cmdTest.Parameters.Add(New SqlParameter("@Problemas,", Data.SqlDbType.VarChar))
        cmdTest.Parameters("@Objetivos").Value = Me.txtProblema.Text
        ...
        cmdTest.Parameters("@idFilial").Value = Session("sFILIAL")
    ...
    Protected Sub btnExcluir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExcluir.Click
        ...
        Try
            ...
            If IsNothing(txtSubProjeto.Text) Then LimparControles()
            Call Ativa_SomenteLeitura()
        Catch ex As Exception
...
#Region " Page"
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.Master.FindControl("lblTitle"), Label).Text = "Plano de Ação Loja - Ficha"
        End If
