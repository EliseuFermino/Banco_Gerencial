<%@ Page Title="Ata - PDCA" Language="VB" MasterPageFile="~/MemberPages/PDCA/mpPlanejamento.master" AutoEventWireup="false" CodeFile="planej06_DiarioBordo.aspx.vb" Inherits="Ranking_planej06_DiarioBordo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td style="width: 469px">
                    <asp:Panel ID="panMemoriaTable" runat="server" BorderColor="#8ab216" 
                ...
                BackColor="White" Width="466px">
                        <table class="style1">
                            ...
                            <tr>
                                <td class="style9" 
                                    style="font-weight: bold; width: 82px; padding-top: 4px; color: #336600;">
                                    Atas:</td>
                                <td colspan="2" style="padding-top: 4px">
                                    <dxe:ASPxComboBox ID="cboList" runat="server" AutoPostBack="True" 
                                        ...
                                        ValueField="ataID" Width="140px"                                          
                                         SettingsLoadingPanel-Text="" ShowShadow="False" Theme="Youthful" DataSourceID="dsAta" EnableTheming="True">
                        ...
                        <table class="style1" style="width: 75%">
                            <tr>
                                <td class="style8" style="font-weight: bold; width: 103px; color: #336600;">
                                    Participantes:</td>
                                <td style="width: 406px">                                   
                                    
                                    <dxe:ASPxMemo ID="txtMemoParticipantes" runat="server" Height="61px" Width="363px" Theme="Youthful" Font-Size="Medium"></dxe:ASPxMemo>
                            ...
                            <tr>
                                ...
                                <dxe:ASPxMemo ID="txtMemoObjetivos" runat="server" Height="98px" Width="363px" Theme="Youthful" Font-Size="Medium"></dxe:ASPxMemo>
                                </td>
                            </tr>
                            <tr>
                                <td class="style8" style="font-weight: bold; width: 103px; color: #336600;">
                                    Discussão:</td>
                                <td style="width: 406px">                                    
                                    <dxe:ASPxMemo ID="txtMemoDiscussao" runat="server" Height="165px" Width="363px" Theme="Youthful" Font-Size="Medium"></dxe:ASPxMemo>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="height: 23px">
                                    <dxe:ASPxButton ID="btnNovo" runat="server" 
                                        ...
                                        ImageSpacing="5px" Text="Novo " Width="70px" Theme="Youthful">
                                    </dxe:ASPxButton>
                                </td>
                                <td>
                                    <dxe:ASPxButton ID="btnAlterar" runat="server" 
                                        ...
                                        style="height: 20px" Theme="Youthful">
                                    </dxe:ASPxButton>
                                </td>
                                <td>
                                    <dxe:ASPxButton ID="btnCancelar" runat="server" 
                                        CssFilePath="~/App_Themes/Aqua/{0}/styles.css" CssPostfix="Aqua" 
                                        Enabled="False" Text="Cancelar" Width="70px" Theme="Youthful">
                                    </dxe:ASPxButton>
                                </td>
                                <td style="height: 23px">
                                ...
                                <td style="width: 90px">
                                    <dxe:ASPxButton ID="btnExcluir" runat="server" 
                                        ...
                                        Enabled="False" Text="Excluir" Width="70px" Theme="RedWine">
                                    </dxe:ASPxButton>
                                </td>
                                <td style="height: 23px">
        ...
        <td align="left" valign="top">
            <asp:Panel ID="Panel2" runat="server" BackColor="White" BorderColor="#8ab216" 
                    ...
                    <tr>
                        <td>
                            <dxe:ASPxButton ID="btnAbrirPA" runat="server" Text="Inserir Plano de Ação" 
                                ...
                                CssPostfix="Aqua" Theme="Youthful">
	...
	frmPlanoAcao.Show();
                        ...
                        <td align="center">
                            <dxe:ASPxButton ID="btnAlterarPAGrid" runat="server" 
                                CssFilePath="~/App_Themes/Aqua/{0}/styles.css" CssPostfix="Aqua" 
                                ImageSpacing="5px" Text="Alterar ou Excluir" Width="130px" Theme="Youthful">
                                <ClientSideEvents Click="function(s, e) {
	frmPlanoAcao.Show();
}" />
                            </dxe:ASPxButton>
                    ...
                    <tr>
                        <td align="left" valign="top">
                            <dxwgv:ASPxGridView ID="gridViewPlanoAcao" runat="server" 
                                ...
                                CssPostfix="Office2003_Blue" Width="490px" Theme="Youthful" EnableTheming="True">
