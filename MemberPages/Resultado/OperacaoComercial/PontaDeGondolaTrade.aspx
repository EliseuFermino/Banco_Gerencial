<%@ Page Title="Ponta de Gondola" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="PontaDeGondolaTrade.aspx.vb" Inherits="MemberPages_Resultado_OperacaoComercial_PontaDeGondola_Trade" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div id="divDados">
                ...
                <dx:PanelContent>
                    ...
                    <dx:ASPxPivotGrid ID="grid" runat="server" DataSourceID="dsDados" Height="100%" Width="100%">
                        <Fields>
                            ...
                            <dx:PivotGridField ID="fielddescAgenda" AreaIndex="7" FieldName="descAgenda">
                            </dx:PivotGridField>
                        </Fields>
		...
		<asp:SqlDataSource ID="dsDados" runat="server" ConnectionString="<%$ ConnectionStrings:gerContasReceberConnectionString2 %>" SelectCommand="usp_PontaDeGondola_Todas_por_Ano_Selecionado_Trade" SelectCommandType="StoredProcedure">
                        <SelectParameters>
