...
Partial Class MemberPages_Resultado_OperacaoComercial_PontaDeGondola
...
#Region " Page"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            oVen.AtualizarEstatisticaPrograma(343, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Ponta de Gondola por Vencimento - PGR343"
        End If
    End Sub
