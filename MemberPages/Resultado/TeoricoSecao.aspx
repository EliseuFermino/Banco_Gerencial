<%@ Page Title="Resultado Teórico por Seção" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="TeoricoSecao.aspx.vb" Inherits="MemberPages_TeoricoSecao" %>
                ...
                <PanelCollection>
                    <dx:PanelContent>
                        ...
                        <asp:SqlDataSource ID="dsGrupoMes" runat="server" 
                            ...
                            SelectCommand="Resultados.uspBuscarTeorico_Secao" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:SessionParameter Name="Ano" SessionField="sANO" />
                                <asp:SessionParameter Name="mesInicial" SessionField="sMES_INICIAL" />
                                <asp:SessionParameter Name="mesFinal" SessionField="sMES_FINAL" />
