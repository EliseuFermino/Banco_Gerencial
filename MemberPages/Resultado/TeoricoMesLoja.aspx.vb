...
Partial Class MemberPages_Resultado_TeoricoMesLoja
    ...
    '    lblOBS.Text = "Session sANO = " & Session("sANO") & _
    '                     " Session sMES = " & Session("sMES") & _
    '                     " Session sFILIAL = " & Session("sFILIAL") & _
    '                     " Session sCORPORACAO = " & Session("sCORPORACAO")
    ...
    Protected Sub cboPanelTeorico_Callback(sender As Object, e As CallbackEventArgsBase) Handles cboPanelTeorico.Callback
        Session("sANO") = Me.cboAno.CallAno
        Session("sMES") = Me.cboMes.CallMes
        Session("sFILIAL") = Me.cboFilial.CallFilial
        gridGrupoMes.DataBind()
    End Sub
End Class
