...
Partial Class MemberPages_TeoricoPeriodoPorSecao
...
#Region " PAGE"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Select Case DateTime.Today.Month
                Case 1 To 3
                    Me.chkPeriodo_1.Checked = True
                    Me.chkPeriodo_2.Checked = False
                    Me.chkPeriodo_3.Checked = False
                    Me.chkPeriodo_4.Checked = False
                Case 4 To 6
                    Me.chkPeriodo_1.Checked = False
                    Me.chkPeriodo_2.Checked = True
                    Me.chkPeriodo_3.Checked = False
                    Me.chkPeriodo_4.Checked = False
                Case 7 To 9
                    Me.chkPeriodo_1.Checked = False
                    Me.chkPeriodo_2.Checked = False
                    Me.chkPeriodo_3.Checked = True
                    Me.chkPeriodo_4.Checked = False
                Case 10 To 12
                    Me.chkPeriodo_1.Checked = False
                    Me.chkPeriodo_2.Checked = False
                    Me.chkPeriodo_3.Checked = False
                    Me.chkPeriodo_4.Checked = True
            End Select
...
#Region "Funções internas"
    ...
    Protected Sub selZoom_SelectedIndexChanged_cboZoom(sender As Object, e As EventArgs)
        oFun.Grid_Size(ASPxGridView1, Me.selZoom.SelectedItem.Value)
    End Sub
    ...
    Protected Sub selFilial_SelectedIndexChanged(sender As Object, e As EventArgs) Handles selFilial.SelectedIndexChanged
    ...
    Protected Sub selAno_SelectedIndexChanged(sender As Object, e As EventArgs)
...
#Region "Codigo comentado"
    ...
    'Dim li = New ListItem()
    'li.Text = "00 - Selecione um Depto"
    'li.Value = "0"
    'Me.cboDepto.Items.Insert(0, li)
    'Me.cboDepto.SelectedIndex = 0

    'Me.cboDepto.Items.Insert(0, New ListItem("00 - Selecione uma Seção", "0"))
    'Me.cboDepto.SelectedValue = "0"

    'Me.cboSecao.Items.Insert(0, New ListItem("00 - Selecione uma Seção", "0"))
    'Me.cboSecao.SelectedValue = "0"

    'Protected Sub selFilial_ListCorporacaoChanged(sender As Object, e As EventArgs) Handles selFilial.ListCorporacaoChanged
    '    If Me.selFilial.CallCorporacao = 3 Then
    '        Me.selFilial.CallFilial = 3
    '    ElseIf Me.selFilial.CallCorporacao = 199 Then
    '        Me.selFilial.CallFilial = 199
    '    End If
