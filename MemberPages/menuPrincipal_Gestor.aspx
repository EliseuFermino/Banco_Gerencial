<%@ Page Title="Gestor Comercial - Tela Inicial" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="menuPrincipal_Gestor.aspx.vb" Inherits="MemberPages_menuPrincipal_Gestor" %>
...
<%@ Register Src="~/Controles/wuc_KPI_Gestor.ascx" TagPrefix="uc1" TagName="wuc_KPI_Gestor" %>
<%@ Register Src="~/Controles/wuc_Gestor_Meta_x_Real_Mes_Graph_Gestor.ascx" TagPrefix="uc1" TagName="wuc_Gestor_Meta_x_Real_Mes_Graph_Gestor" %>
<%@ Register Src="~/Controles/wuc_Gestor_Meta_x_Real_Ano_Graph_Gestor.ascx" TagPrefix="uc1" TagName="wuc_Gestor_Meta_x_Real_Ano_Graph_Gestor" %>
                ...
                <div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="fa fa-bar-chart" ></span>&nbsp Margem Negativa - TOP 50 - Gestor: <span><asp:Label ID="Label1" runat="server" Text="" ></asp:Label></span> </h4>
...
cboPaneLucroItemNegativo.PerformCallback();	
                         ...
                         <div id="divTop30_Lucro_Negativo" class="Separacao_Separacao">
                          ...
                          <dx:ASPxGridView ID="grid_Top30_Lucro_Negativo" runat="server" DataSourceID="ds_Top30_Lucro_Negativo" AutoGenerateColumns="False" Width="1010px" KeyFieldName="CodProduto">
                              <Toolbars>
                            ...
                            <Columns>
                                ...
                                <dx:GridViewBandColumn Caption="Vendas" VisibleIndex="6">
                                    <Columns>
                                ...
                                <dx:GridViewBandColumn Caption="Margem Praticada" VisibleIndex="7">
                                    <Columns>
                                ...
                                <dx:GridViewBandColumn Caption="Sell Out" VisibleIndex="8">
                                    <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Comprador" FieldName="DescCompradorAbrev" ShowInCustomizationForm="True" VisibleIndex="5" Width="100px">
                                    <Settings AutoFilterCondition="Contains" />
                                    <CellStyle Wrap="False">
                                        <BorderRight BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" />
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Filial" FieldName="FilialDesc" ShowInCustomizationForm="True" VisibleIndex="2" Width="150px">
                                    <Settings AllowAutoFilter="True" AutoFilterCondition="Contains" />
                                </dx:GridViewDataTextColumn>
                            </Columns>
                        ...
                        <asp:SqlDataSource ID="ds_Top30_Lucro_Negativo" runat="server" ConnectionString="<%$ ConnectionStrings:gerVendaItemConnectionString %>" SelectCommand="Dia.uspAtualizar_TOP_LucroFinal_Negativo_Gestor" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:SessionParameter DbType="Date" Name="Dia" SessionField="sDIA" />
                                <asp:SessionParameter DbType="String" Name="idGestor" SessionField="sCOMPRADOR" />
                            </SelectParameters>
                        </asp:SqlDataSource>
      ...
      <div class="row Quebra_Pagina_Row">
                ...
                <div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="fa fa-bar-chart" ></span>&nbsp Margem entre 0,00 e 5,00 - Gestor: <span><asp:Label ID="Label2" runat="server" Text="" ></asp:Label></span> </h4>
                     ...
                     <dx:ASPxCallbackPanel ID="cboPaneLucroItemNegativo5" runat="server" Width="100%" ClientInstanceName="cboPaneLucroItemNegativo5" Theme="Metropolis" SettingsLoadingPanel-Text="Aguarde. Atualizando">
<SettingsLoadingPanel Text="Aguarde. Atualizando"></SettingsLoadingPanel>
                <PanelCollection>
                    <dx:PanelContent>  
                        
                        <dx:ASPxDateEdit ID="ASPxDateEdit1" runat="server" Theme="Mulberry" Caption="Selecione um Dia" Date="11/12/2019 11:04:48" Width="130px" >
                            <ClientSideEvents DateChanged="function(s, e) {
cboPaneLucroItemNegativo.PerformCallback();	
}" />
                        </dx:ASPxDateEdit>
                             
                         <div id="div1" class="Separacao_Separacao">

                          <dx:ASPxGridView ID="gridNegativa5" runat="server" DataSourceID="ds_Top30_Lucro_Negativo_5" AutoGenerateColumns="False" Width="1010px" KeyFieldName="CodProduto">
                              <Toolbars>
                                <dx:GridViewToolbar EnableAdaptivity="true">
                                    <Items>
                                        <dx:GridViewToolbarItem Command="ExportToXls" Text="Exportar para Excel - XLS" ToolTip="Versão do Excel 2007 para baixo" />
                        ...
                        <asp:SqlDataSource ID="ds_Top30_Lucro_Negativo_5" runat="server" ConnectionString="<%$ ConnectionStrings:gerVendaItemConnectionString %>" SelectCommand="Dia.uspAtualizar_TOP_LucroFinal_Negativo_Gestor_5" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:SessionParameter DbType="Date" Name="Dia" SessionField="sDIA" />
                                <asp:SessionParameter DbType="String" Name="idGestor" SessionField="sCOMPRADOR" />
                            </SelectParameters>
      ...
      <div class="row Quebra_Pagina_Row">
                ...
                <div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title">Crescimento de Vendas Total - Gestor: <span><asp:Label ID="lblComprador_GR1" runat="server" Text="" ></asp:Label></span> </h4>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <uc1:wuc_KPI_Gestor runat="server" ID="wuc_KPI_Gestor" />        
                                <small>O Crescimento do <span class="bolder">Mês Atual</span> é composto pelo <span class="blue bolder">Realizado</span> até ontem mais a <span class="green bolder">Meta de Venda</span> de hoje até o final do Mês</small>
      ...
      <div class="row Quebra_Pagina_Row">
                ...
                <div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="fa fa-bar-chart" ></span> &nbsp Gráfico de Metas x Realizado <span class="bolder"> por Mês </span><span>- Gestor: <asp:Label ID="lblComprador_GR3" runat="server" Text="" ></asp:Label></span></h4>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <uc1:wuc_Gestor_Meta_x_Real_Mes_Graph_Gestor runat="server" id="wuc_Gestor_Meta_x_Real_Mes_Graph_Gestor" />      
      ...
      <div class="row Quebra_Pagina_Row">
                ...
                <div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="fa fa-bar-chart" ></span> &nbsp Gráfico de Metas x Realizado <span class="bolder"> por Ano </span><span> - Gestor: <asp:Label ID="lblComprador_GR2" runat="server" Text="" ></asp:Label></span></h4>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <uc1:wuc_Gestor_Meta_x_Real_Ano_Graph_Gestor runat="server" ID="wuc_Gestor_Meta_x_Real_Ano_Graph_Gestor" />    
