<%@ Page Title="Analise Seções do Departamento 5 - Eletrodomésticos" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="menuPrincipal_Depto5.aspx.vb" Inherits="MemberPages_menuPrincipal_Depto5" %>
...
<div id="divFilial" class="row Quebra_Pagina_Row">
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><span class="glyphicon glyphicon-shopping-cart"></span> Numero de Clientes &nbsp e &nbsp <span class="glyphicon glyphicon-list-alt"></span> Ticket Médio - Comparativo com o Ano Anterior - Todas as Seções do Departamento 5 - Eletrodomésticos </h3>
				...
				<div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="glyphicon glyphicon-shopping-cart"></span> Numero de Clientes &nbsp e &nbsp <span class="glyphicon glyphicon-list-alt"></span> Ticket Médio - Secao 50 - Eletrodomésticos</h4>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <dxchartsui:WebChartControl ID="graph_Secao50" runat="server" DataSourceID="dsClientesNumerosSecao50" Height="550px" Width="900px" AppearanceNameSerializable="Nature Colors" CrosshairEnabled="True">
                                    <diagramserializable>
                                        <cc1:XYDiagram>
    ...
    <cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                ...
                                <asp:SqlDataSource ID="dsClientesNumerosSecao50" runat="server" ConnectionString="<%$ ConnectionStrings:DW_VendasConnectionString %>" SelectCommand="uspBuscarNumeroDeClientes_12Meses_Secao" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="idFilial" SessionField="sFILIAL" Type="Byte" />
                                        <asp:SessionParameter Name="idSecao" DefaultValue="50" Type="Byte" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
				...
				<div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="glyphicon glyphicon-shopping-cart"></span> Numero de Clientes &nbsp e &nbsp <span class="glyphicon glyphicon-list-alt"></span> Ticket Médio - Secao 51 - Eletroportateis</h4>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <dxchartsui:WebChartControl ID="graph_Secao51" runat="server" DataSourceID="dsClientesNumerosSecao51" Height="550px" Width="900px" AppearanceNameSerializable="Nature Colors" CrosshairEnabled="True">
                                    <diagramserializable>
                                        <cc1:XYDiagram>
                                            <axisx visibleinpanesserializable="-1" minorcount="1" visible="False">
                                                <range sidemarginsenabled="True" />
    ...
    <cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                ...
                                <asp:SqlDataSource ID="dsClientesNumerosSecao51" runat="server" ConnectionString="<%$ ConnectionStrings:DW_VendasConnectionString %>" SelectCommand="uspBuscarNumeroDeClientes_12Meses_Secao" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="idFilial" SessionField="sFILIAL" Type="Byte" />
                                        <asp:SessionParameter Name="idSecao" DefaultValue="51" Type="Byte" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
				...
				<div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="glyphicon glyphicon-shopping-cart"></span> Numero de Clientes &nbsp e &nbsp <span class="glyphicon glyphicon-list-alt"></span> Ticket Médio - Secao 52 - Telefonia</h4>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <dxchartsui:WebChartControl ID="graph_Secao52" runat="server" DataSourceID="dsClientesNumerosSecao52" Height="550px" Width="900px" AppearanceNameSerializable="Nature Colors" CrosshairEnabled="True">
                                    <diagramserializable>
                                        <cc1:XYDiagram>
                                            <axisx visibleinpanesserializable="-1" minorcount="1" visible="False">
                                                <range sidemarginsenabled="True" />
    ...
    <cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                ...
                                <asp:SqlDataSource ID="dsClientesNumerosSecao52" runat="server" ConnectionString="<%$ ConnectionStrings:DW_VendasConnectionString %>" SelectCommand="uspBuscarNumeroDeClientes_12Meses_Secao" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="idFilial" SessionField="sFILIAL" Type="Byte" />
                                        <asp:SessionParameter Name="idSecao" DefaultValue="52" Type="Byte" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
				...
				<div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="glyphicon glyphicon-shopping-cart"></span> Numero de Clientes &nbsp e &nbsp <span class="glyphicon glyphicon-list-alt"></span> Ticket Médio - Secao 53 - Informática</h4>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <dxchartsui:WebChartControl ID="graph_Secao53" runat="server" DataSourceID="dsClientesNumerosSecao53" Height="550px" Width="900px" AppearanceNameSerializable="Nature Colors" CrosshairEnabled="True">
                                    <diagramserializable>
                                        <cc1:XYDiagram>
                                            <axisx visibleinpanesserializable="-1" minorcount="1" visible="False">
                                                <range sidemarginsenabled="True" />
    ...
    <cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                ...
                                <asp:SqlDataSource ID="dsClientesNumerosSecao53" runat="server" ConnectionString="<%$ ConnectionStrings:DW_VendasConnectionString %>" SelectCommand="uspBuscarNumeroDeClientes_12Meses_Secao" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="idFilial" SessionField="sFILIAL" Type="Byte" />
                                        <asp:SessionParameter Name="idSecao" DefaultValue="53" Type="Byte" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
				...
				<div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="glyphicon glyphicon-shopping-cart"></span> Numero de Clientes &nbsp e &nbsp <span class="glyphicon glyphicon-list-alt"></span> Ticket Médio - Secao 54 - Cine, Foto e Som</h4>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <dxchartsui:WebChartControl ID="graph_Secao54" runat="server" DataSourceID="dsClientesNumerosSecao54" Height="550px" Width="900px" AppearanceNameSerializable="Nature Colors" CrosshairEnabled="True">
                                    <diagramserializable>
                                        <cc1:XYDiagram>
                                            <axisx visibleinpanesserializable="-1" minorcount="1" visible="False">
                                                <range sidemarginsenabled="True" />
    ...
    <cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                ...
                                <asp:SqlDataSource ID="dsClientesNumerosSecao54" runat="server" ConnectionString="<%$ ConnectionStrings:DW_VendasConnectionString %>" SelectCommand="uspBuscarNumeroDeClientes_12Meses_Secao" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="idFilial" SessionField="sFILIAL" Type="Byte" />
                                        <asp:SessionParameter Name="idSecao" DefaultValue="54" Type="Byte" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
