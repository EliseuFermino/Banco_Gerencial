...
Partial Class MemberPages_Quebras_Quebra_Agenda23_Top10_Mes
...
#Region " Page"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            oVen.AtualizarEstatisticaPrograma(326, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Top 10 das Perdas por Produto da Agenda 23 por Mês - PGR326"
        End If
    End Sub
