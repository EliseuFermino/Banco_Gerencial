...
Partial Class MemberPages_Quebras_Validade_AlteraProdutosVencidos
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            oVem.AtualizarEstatisticaPrograma(309, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Manutenção dos Produtos Vencidos - PGR309"
        End If
    End Sub
