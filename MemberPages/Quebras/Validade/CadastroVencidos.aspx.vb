...
Partial Class MemberPages_Quebras_Validade_CadastroVencidos
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            cboDia.Attributes.Add("autocomplete", "off")
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            ...
            CType(Master.FindControl("lblTitle"), Label).Text = "Cadastro de Produtos Vencidos - PGR243"
    ...
    Public Function Salvar() As Boolean
        ...
        Dim comando As New SqlCommand("Vencidos.uspInsert", con)
        comando.CommandType = CommandType.StoredProcedure
        ...
        comando.Parameters("@dataVencimento").Value = cboDia.Text
    ...
    Protected Sub cboDia_TextChanged(sender As Object, e As EventArgs) Handles cboDia.TextChanged

        Dim DiaHoje As Date

        DiaHoje = DateAndTime.Today.Date

        If CType(cboDia.Text, Date) >= DiaHoje Then
            oVem.UserMsgBox(Me, "A Data de Vecimento deve ser menor que " & DiaHoje)
        Else
            txtQtde.Focus()
        End If
