<%@ Page Title="Lista de Produtos à Vencer" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="ListaProdutosVencidos.aspx.vb" Inherits="MemberPages_Quebras_Validade_ListaProdutosVencidos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate >
            ...
            <dx:ASPxGridView ID="grid" runat="server" DataSourceID="dsData" AutoGenerateColumns="False" KeyFieldName="ID" Width="1010px">
                <Toolbars>
                ...
                <Columns>
                    <dx:GridViewDataTextColumn Caption="Filial" FieldName="nomeFilialLista" VisibleIndex="2" Width="150px">
                        <Settings AutoFilterCondition="Contains" />
                        <CellStyle Wrap="False">
                        </CellStyle>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataDateColumn Caption="Vencimento" FieldName="dataVencimento" GroupIndex="0" SortIndex="0" SortOrder="Ascending" VisibleIndex="1" Width="80px">
                        <CellStyle HorizontalAlign="Center">
                        </CellStyle>
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataTextColumn FieldName="Setor" VisibleIndex="3">
                        <Settings AutoFilterCondition="Contains" />
                        <CellStyle Wrap="False">
                        </CellStyle>
                    </dx:GridViewDataTextColumn>
            ...
            <asp:SqlDataSource ID="dsData" runat="server" ConnectionString="<%$ ConnectionStrings:DW_Condor_One_ConnectionString %>" SelectCommand="Validade.uspListaProdutosVencer" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
