<%@ Page Title="Agenda 23, Divergência e Perda Total por Loja" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="QuebraSecaoItemPorLoja.aspx.vb" Inherits="MemberPages_Quebra_Secao_PorLoja" %>
   ...
   <div id="divSecao">
    ...
    <div id="divTipo">
        <dx:ASPxComboBox ID="cboTipo" runat="server" Native="True" SelectedIndex="4">
            <Items>
                <dx:ListEditItem Selected="True" Text="Agenda 23 - Qtde" Value="1" /> 
                <dx:ListEditItem Text="Agenda 23 - Valor" Value="2" />
                <dx:ListEditItem Text="Divergência - Qtde" Value="3" />          
                <dx:ListEditItem Text="Divergência - Valor" Value="4" />   
                <dx:ListEditItem Text="Total Perda - Qtde" Value="5" />      
                <dx:ListEditItem Text="Total Perda - Valor" Value="6" /> 
            </Items>
        </dx:ASPxComboBox>
    </div>
...
<AdaptiveDetailLayoutProperties ColCount="1">
    <SettingsAdaptivity AdaptivityMode="SingleColumnWindowLimit">
		...
		<asp:SqlDataSource ID="dsDados" runat="server" ConnectionString="<%$ ConnectionStrings:gerPerdasConnectionString %>" SelectCommand="dbo.usp_Eder_Quebras_Referencia_Cruzada" SelectCommandType="StoredProcedure">
                        <SelectParameters>
