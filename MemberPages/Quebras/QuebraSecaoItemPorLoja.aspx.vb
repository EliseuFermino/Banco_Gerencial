...
Partial Class MemberPages_Quebra_Secao_PorLoja
...
#Region " Page"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            oVen.AtualizarEstatisticaPrograma(426, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Análise da Agenda 23, Divergência e Perda Total por Item - Loja a Loja - PGR426"
        End If
    End Sub
    ...
    Protected Sub grid_DataBound(sender As Object, e As EventArgs) Handles grid.DataBound
        Select Case cboTipo.Value
            ...
            Case Else
                ...
                oFun.Grid_Decimals(grid, "L_TotalAtacarejo", Funcoes.CasaDecimais.Duas)
        End Select
