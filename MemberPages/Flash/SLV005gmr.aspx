<%@ Page Title="" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="SLV005gmr.aspx.vb" Inherits="MemberPages_SLV_SLV005gmr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <%--<div id="moldura">--%>
        ...
        <div id="divBotaoExcel">
            ...
            <uc1:wucBotaoExcel runat="server" ID="wucBotaoExcel_Meta" CallGridViewID="gridMetaVersusRealizado" ClientInstanceName="Excel_Meta" />
        </div>
            ...
            <dx:ASPxCallbackPanel ID="cbPanelGrid" runat="server" Width="1020px" ClientInstanceName="cbPanelGrid" Theme="Metropolis" SettingsLoadingPanel-Text="Aguarde&amp;hellip;">
                ...
                <PanelCollection>
                    <dx:PanelContent runat="server" SupportsDisabledAttributes="both">
                        ...
                        <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>                                           
                                            ...
                                            <dx:GridViewBandColumn Caption="Meta de Venda" Name="bandMeta"
                                                VisibleIndex="6" ToolTip="Exibe as informações de crescimento de Quantidade, Venda e Lucratividade em relação ao ano anterior.">
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="% Ating." FieldName="percAtingMetaVlr" ShowInCustomizationForm="True" ToolTip="Atingimento entre Realizado versus Meta" UnboundType="Decimal" VisibleIndex="2" Width="60px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <Settings AllowAutoFilter="False" />
                                            ...
                                            <dx:GridViewBandColumn Caption="Preço Médio" Name="bandPrecoMedio" 
                                                ToolTip="Exibe as informações de Preço Médio" VisibleIndex="5 ">
                                                <Columns>
                                                    <dx:GridViewDataTextColumn Caption="Ano Anterior" FieldName="precoMedio_AA" ToolTip="Preço Médio da Seção no mesmo periodo do Ano Passado" 
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Ano Atual" FieldName="precoMedio_AT" ToolTip="Preço Médio da Seção no mesmo periodo do Ano Atual" 
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="% Cresc" FieldName="precoMedio_Cresc" UnboundType="Decimal" ToolTip="Percentual de Crescimento Médio da Seção" 
                                            ...
                                            <dx:GridViewBandColumn Caption="Meta de Lucro" Name="bandMetaLucro" ShowInCustomizationForm="True" VisibleIndex="6">
                                                <Columns>
                                            ...
                                            <dx:GridViewBandColumn Caption="Meta de Margem" Name="bandMetaMargem" ShowInCustomizationForm="True" VisibleIndex="7">
                                                <Columns>
                                            ...
                                            <dx:GridViewBandColumn Caption="Meta de Agenda 23" ShowInCustomizationForm="True" VisibleIndex="8" Name="bandMetaAg23">
                                                <Columns>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DW_Condor_One_ConnectionString %>" SelectCommand="Vendas_Dia.SLV004" SelectCommandType="StoredProcedure" CacheExpirationPolicy="Absolute" EnableCaching="True" >
                            <SelectParameters>
                                        ...
                                        <Columns>                                           
                                            ...
                                            <dx:GridViewBandColumn Caption="Meta x Realizado - Lucro" Name="bandMetaLucro" ShowInCustomizationForm="True" VisibleIndex="6">
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Realizado" FieldName="vlrLucro_AT" ShowInCustomizationForm="True" ToolTip="Valor do lucro do período selecionado" VisibleIndex="0" Width="90px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <Settings AllowAutoFilter="False" />
                                                        <HeaderStyle BackColor="#3399FF" HorizontalAlign="Center" />
                                            ...
                                            <dx:GridViewBandColumn Caption="Meta x Realizado - Agenda 23" ShowInCustomizationForm="True" VisibleIndex="8" Name="bandMetaAg23">
                                                <Columns>
                                                    <dx:GridViewDataTextColumn Caption="Agenda 23" FieldName="vlrAg23_meta" ShowInCustomizationForm="True" VisibleIndex="0" Width="90px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
