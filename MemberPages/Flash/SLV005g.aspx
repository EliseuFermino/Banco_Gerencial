<%@ Page Title="" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="SLV005g.aspx.vb" Inherits="MemberPages_SLV_SLV005g" %>
                ...
                <PanelCollection>
                    <dx:PanelContent >
                        ...
                        <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <TotalSummary>
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="Qtde_AA" SummaryType="Sum" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="vlrVenda_AA" SummaryType="Sum" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="vlrLucro_AA" SummaryType="Sum" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="vlrLucroSellout_AA" SummaryType="Sum" />
                                            ...
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="vlrLucro_AT" SummaryType="Sum" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="vlrLucroSellout_AT" SummaryType="Sum" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="vlrCAI_AT" SummaryType="Sum" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="vlrVenda_meta" SummaryType="Sum" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="vlrLucro_meta" SummaryType="Sum" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="difValorMeta" SummaryType="Sum" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="difValorMetaLucro" SummaryType="Sum" />
                                            ...
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="percPart_AA" SummaryType="Sum" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="percPart_AT" SummaryType="Sum" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="percPartDepto_AT" SummaryType="Sum" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="vlrLucroFinal_Ag23" SummaryType="Sum" />
                                            ...
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="vlrLucroFinal_AA" SummaryType="Sum" />
                                            ...
                                            <dx:ASPxSummaryItem DisplayFormat="{0:p1}" FieldName="percAtingMetaVlrG" SummaryType="Custom" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="percCrescReal" SummaryType="Custom" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="percAg23_AT" SummaryType="Custom" />
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="percLucroFinal_Ag23" SummaryType="Custom" />
                                        ...
                                        <Columns>                                           
                                            ...
                                            <dx:GridViewBandColumn Caption="Ano Anterior" Name="bandAnoAnterior" 
                                                ToolTip="Exibe informações do Ano Anterior" VisibleIndex="5" 
                                                Visible="False">
                                                <Columns>
                                            ...
                                            <dx:GridViewBandColumn Caption="Ano Atual" Name="bandAnoAtual" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Sell-Out" FieldName="percMargemSellout_AT" 
                                                        VisibleIndex="11" Width="60px" Visible="False">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="% Marg F" FieldName="percMargemFinal_AT" ShowInCustomizationForm="True" ToolTip="Percentual da Margem Final" VisibleIndex="4" Width="70px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <HeaderStyle BackColor="#84C1FF" />
                                                        <CellStyle ForeColor="#0984FF">
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Part T" FieldName="percPart_AT" ShowInCustomizationForm="True" ToolTip="Percentual de participação da venda da seção sobre a venda total" VisibleIndex="12" Width="60px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <Settings AllowAutoFilter="False" />
                                                        <HeaderStyle BackColor="#3399FF" HorizontalAlign="Center" />
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Sell-Out" FieldName="vlrLucroSellout_AT" ShowInCustomizationForm="True" VisibleIndex="9" Width="90px" Visible="False">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <HeaderStyle BackColor="#84C1FF" />
                                                        <CellStyle ForeColor="#0984FF">
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Lucro Final" FieldName="vlrLucroFinal_AT" ShowInCustomizationForm="True" VisibleIndex="3" Width="100px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <HeaderStyle BackColor="#84C1FF" />
                                                        <CellStyle ForeColor="#0984FF">
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="% Marg" FieldName="percMargem_AT" ShowInCustomizationForm="True" ToolTip="Percentual de margem do período selecionado" VisibleIndex="10" Width="60px" Visible="False">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <Settings AllowAutoFilter="False" />
                                                        <HeaderStyle BackColor="#3399FF" HorizontalAlign="Center" />
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Part D" FieldName="percPartDepto_AT" ShowInCustomizationForm="True" ToolTip="Percentual de participação da venda da seção sobre a venda do Departamento" VisibleIndex="13" Width="60px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <HeaderStyle BackColor="#3399FF" HorizontalAlign="Center" />
                                                        <CellStyle ForeColor="Blue">
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Agenda 23" FieldName="vlrAg23" ShowInCustomizationForm="True" ToolTip="Valor da Agenda 23 (Quebra Conhecida)" VisibleIndex="5" Width="80px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <Settings AllowAutoFilter="False" />
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="% Ag23" FieldName="percAg23_AT" ShowInCustomizationForm="True" UnboundType="Decimal" VisibleIndex="6" Width="70px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <HeaderStyle BackColor="#FF3300" ForeColor="White" />
                                                    </dx:GridViewDataTextColumn>
                                                    <dx:GridViewDataTextColumn Caption="Lucro F - Ag23" FieldName="vlrLucroFinal_Ag23" ShowInCustomizationForm="True" ToolTip="Lucro Final - Agenda 23" UnboundType="Decimal" VisibleIndex="7" Width="100px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <HeaderStyle BackColor="#FF9F9F" />
                                                    </dx:GridViewDataTextColumn>
                                                    <dx:GridViewDataTextColumn Caption="% LF - Ag23" FieldName="percLucroFinal_Ag23" ShowInCustomizationForm="True" ToolTip="% Margem Final - % Agenda 23" UnboundType="Decimal" VisibleIndex="8" Width="80px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <HeaderStyle BackColor="#FF9F9F" />
                                                    </dx:GridViewDataTextColumn>
                                            ...
                                            <dx:GridViewBandColumn Caption="Meta de Venda" Name="bandMeta"
                                                VisibleIndex="11" ToolTip="Exibe as informações de crescimento de Quantidade, Venda e Lucratividade em relação ao ano anterior.">
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn FieldName="percAtingMetaVlrG" VisibleIndex="4" Caption="Ating." Width="100px" >
                                                        <DataItemTemplate>
                                            ...
                                            <dx:GridViewBandColumn Caption="Crescimento em %" Name="bandCrescimento" 
                                                ToolTip="Exibe as informações do ano atual" VisibleIndex="7">
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Lucro" FieldName="percCresc_LucroTotal" 
                                            ...
                                            <dx:GridViewBandColumn Caption="CAI Ano Anterior" ShowInCustomizationForm="True" VisibleIndex="15" Visible="False" Name="bandCAI_AnoAnterior">
                                                <Columns>
                                            ...
                                            <dx:GridViewBandColumn Caption="CAI Ano Atual" ShowInCustomizationForm="True" VisibleIndex="16" Visible="False" Name="bandCAI_AnoAtual">
                                                <Columns>
                                            ...
                                            <dx:GridViewBandColumn Caption="Meta de Lucro" Name="bandMetaLucro" ShowInCustomizationForm="True" VisibleIndex="12">
                                                <Columns>
                                            ...
                                            <dx:GridViewBandColumn Caption="Meta de Margem" Name="bandMetaMargem" ShowInCustomizationForm="True" VisibleIndex="13">
                                                <Columns>
                                            ...
                                            <dx:GridViewBandColumn Caption="Meta de Agenda 23" ShowInCustomizationForm="True" VisibleIndex="14" Name="bandMetaAg23">
                                                <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn Caption="Código" FieldName="idSecao" FixedStyle="Left" ShowInCustomizationForm="True" ToolTip="Código do produto" VisibleIndex="1" Width="70px" Visible="False">
                                            </dx:GridViewDataTextColumn>
                                            ...
                                            <dx:GridViewDataTextColumn Caption="Inflação &lt;br&gt; Interna" FieldName="precoMedioCresc" ShowInCustomizationForm="True" VisibleIndex="9" Width="70px">
                                                <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                </PropertiesTextEdit>
                                                <HeaderStyle HorizontalAlign="Center" BackColor="#666666" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="% Cresc &lt;br&gt; Real" FieldName="percCrescReal" ShowInCustomizationForm="True" VisibleIndex="10" Width="75px">
                                                <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                </PropertiesTextEdit>
                                                <HeaderStyle HorizontalAlign="Center" BackColor="#666666" />
                                                <CellStyle>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="Comprador" ShowInCustomizationForm="True" VisibleIndex="4">
                                                <Settings AllowHeaderFilter="False" />
                                                <SettingsHeaderFilter Mode="CheckedList">
                                                </SettingsHeaderFilter>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Gestor" FieldName="idGestor" ShowInCustomizationForm="True" VisibleIndex="3">
                                                <Settings AllowHeaderFilter="False" AllowAutoFilter="True" AutoFilterCondition="Contains" />
                                                <SettingsHeaderFilter Mode="CheckedList">
                                                </SettingsHeaderFilter>
                                            </dx:GridViewDataTextColumn>
                            ...
                            <SettingsExport EnableClientSideExportAPI="true" ExcelExportMode="WYSIWYG"></SettingsExport>
                                        <FormatConditions>
                                            ...
                                            <dx:GridViewFormatConditionIconSet FieldName="percCresc_LucroTotal" Format="PositiveNegativeArrowsColored" />
                                        </FormatConditions>
                                        <Styles>
                                        ...
                                        <Settings ShowVerticalScrollBar="True" VerticalScrollableHeight="420" 
                                        ...
                                        <Columns>                                           
                                            ...
                                            <dx:GridViewBandColumn Caption="Meta x Realizado - Vendas" Name="bandAnoAtual" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataProgressBarColumn Caption="Ating" FieldName="percAtingMetaVlrG" ShowInCustomizationForm="True" VisibleIndex="4" Width="100px">
                                                        <PropertiesProgressBar DisplayFormatString="{0:n}">
