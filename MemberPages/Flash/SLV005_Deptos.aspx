<%@ Page Title="" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="SLV005_Deptos.aspx.vb" Inherits="MemberPages_SLV_SLV005_Deptos" %>
            ...
            <dx:ASPxCallbackPanel ID="cbPanelGrid" runat="server" Width="1020px" ClientInstanceName="cbPanelGrid" Theme="Metropolis" SettingsLoadingPanel-Text="Aguarde&amp;hellip;">
                ...
                <PanelCollection>
                    <dx:PanelContent runat="server" SupportsDisabledAttributes="both">
                        ...
                        <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>                                           
                                            ...
                                            <dx:GridViewBandColumn Caption="Meta de Venda" Name="bandMeta"
                                                VisibleIndex="5" ToolTip="Exibe as informações de crescimento de Quantidade, Venda e Lucratividade em relação ao ano anterior.">
                                                <Columns>
                                                    <dx:GridViewDataTextColumn Caption="Venda" FieldName="vlrVenda_meta" VisibleIndex="0" 
                                                        Width="100px" ToolTip="Valor de meta de venda do período selecionado">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <Settings AllowAutoFilter="False" />
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Diferença" FieldName="difValorMeta" ShowInCustomizationForm="True" ToolTip="Diferença entre o valor da Meta e o valor do Realizado" UnboundType="Decimal" VisibleIndex="1" Width="80px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <HeaderStyle BackColor="#009900" />
                                                        <CellStyle ForeColor="Blue">
                                            ...
                                            <dx:GridViewBandColumn Caption="Meta de Lucro" Name="bandMetaLucro" ShowInCustomizationForm="True" VisibleIndex="6">
                                                <Columns>
                                                    <dx:GridViewDataTextColumn Caption="Lucro" FieldName="vlrLucro_meta" ShowInCustomizationForm="True" ToolTip="Meta de lucro" VisibleIndex="0" Width="90px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <Settings AllowAutoFilter="False" />
                                                        <HeaderStyle BackColor="#009900" />
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Diferença" FieldName="difValorMetaLucro" ShowInCustomizationForm="True" ToolTip="Diferença entre o valor da Meta de Lucro e o valor do Realizado do Lucro" UnboundType="Decimal" VisibleIndex="1" Width="70px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <HeaderStyle BackColor="#009900" />
                                                        <CellStyle ForeColor="Blue">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DW_Condor_One_ConnectionString %>" SelectCommand="Vendas_Dia.SLV004_Deptos" SelectCommandType="StoredProcedure" EnableCaching="True"  >
                            <SelectParameters>
