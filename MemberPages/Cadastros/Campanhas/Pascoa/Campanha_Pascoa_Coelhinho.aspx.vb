...
Partial Class MemberPages_Campanha_Pascoa_Coelhinho
...
#Region " Page"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Not IsPostBack Then
            ...
            oVem.AtualizarEstatisticaPrograma(98, User.Identity.Name)
            Session("sCAMPANHA") = 1
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        CType(Master.Master.FindControl("lblTitle"), Label).Text = "Análise de Coelhinhos " & Me.cboAno.CallAno & " - PGR98"
    End Sub
...
#Region " Meus Scipts"
    ...
    Private Sub myLegendas()
        ...
        oFun.Grid_Title(Me.ASPxGridView1, "Análise de Coelhinhos " & anoAT)
        oFun.Grid_Title(Me.gridMeta, "Comparativo - Coelhinhos - Meta x Realizado " & anoAT)
        oFun.Grid_Title(Me.gridTodosItens, "Coelhinhos - Todos os Itens - " & anoAT)
