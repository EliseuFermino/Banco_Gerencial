...
#Region " Page"
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        CType(Master.Master.FindControl("lblTitle"), Label).Text = "Análise de Bacalhau " & Me.cboAno.CallAno & " - PGR100"
    End Sub
...
#Region " Meus Scipts"
    ...
    Private Sub myLegendas()
        ...
        oFun.Grid_Title(Me.ASPxGridView1, "Análise de Bacalhau " & anoAT)
        oFun.Grid_Title(Me.gridMeta, "Comparativo - Bacalhau - Meta x Realizado " & anoAT)
        oFun.Grid_Title(Me.gridTodosItens, "Bacalhau - Todos os Itens - " & anoAT)
