<%@ Page Title="Ovos por Peso" Language="VB" MasterPageFile="~/MemberPages/mpCampanha_Pascoa.master" AutoEventWireup="false" CodeFile="OvosGramagem.aspx.vb" Inherits="MemberPages_Campanhas_Pascoa_OvosGramagem" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <div id="divDados">
        ...
        <dx:ASPxGridView ID="grid" runat="server" DataSourceID="ds" AutoGenerateColumns="False" Width="1035px" KeyFieldName="Gramagem">
            ...
            <Columns>
                <dx:GridViewBandColumn Caption="Estoque de Ovos em Unidade" VisibleIndex="3" Visible="False">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="qtdeEstoque_AA_Fechada" VisibleIndex="0" Width="85px" Caption="2014" Visible="False">
                ...
                <dx:GridViewBandColumn Caption="Estoque Em R$" VisibleIndex="5" Visible="False">
                    <Columns>
                ...
                <dx:GridViewBandColumn Caption="Vendas de Ovos em R$" VisibleIndex="4">
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="Projeção" FieldName="ProjecaoVenda" VisibleIndex="6" Width="85px">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                            </PropertiesTextEdit>
                        ...
                        <dx:GridViewDataTextColumn Caption="Real+Projeção" FieldName="VendaProjecaoReal" VisibleIndex="7" Width="90px">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                            </PropertiesTextEdit>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="% Cresc" FieldName="percCrescVenda" ToolTip="% de Crescimento de Venda" VisibleIndex="8" Width="80px">
                            <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                            </PropertiesTextEdit>
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="Estoque Atual" FieldName="qtdeEstoque_AT_Parcial" ShowInCustomizationForm="True" VisibleIndex="5" Width="85px">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                            </PropertiesTextEdit>
                            <HeaderStyle BackColor="Gray" ForeColor="White" />
                            <FooterCellStyle ForeColor="Blue">
            ...
            <Templates>
                <DetailRow>
                    <dx:ASPxGridView ID="gridDetail" runat="server" DataSourceID="dsDetail" OnBeforePerformDataSelect="gridDetail_BeforePerformDataSelect" AutoGenerateColumns="False" KeyFieldName="idProduto" OnHtmlDataCellPrepared="gridDetail_HtmlDataCellPrepared" Width="950px" OnLoad="gridDetail_Load">

                        <Columns>
                            <dx:GridViewBandColumn Caption="Estoque de Ovos em Unidade" VisibleIndex="3" Visible="False">
                                <Columns>
                                    <dx:GridViewDataTextColumn FieldName="qtdeEstoque_AA_Fechada" VisibleIndex="0" Width="85px" Caption="2014">
                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                        </PropertiesTextEdit>
                                        <CellStyle Font-Bold="True">
                                        </CellStyle>
                            ...
                            <dx:GridViewBandColumn Caption="Vendas de Ovos em R$" VisibleIndex="4">
                                <Columns>
                                    <dx:GridViewDataTextColumn FieldName="Venda_AT_Parcial" VisibleIndex="3" Width="85px">
                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                        </PropertiesTextEdit>
                                        <CellStyle ForeColor="Blue">
                                        </CellStyle>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="percCrescVendaAA" VisibleIndex="1" Width="60px" Caption="%">
                                        <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                        </PropertiesTextEdit>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Venda_AA_Parcial" VisibleIndex="2" Width="85px">
                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                        </PropertiesTextEdit>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="2014" FieldName="Venda_AA_Fechada" VisibleIndex="1" Width="85px">
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Estoque Atual" FieldName="qtdeEstoque_AT_Parcial" ShowInCustomizationForm="True" VisibleIndex="4" Width="85px">
                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                        </PropertiesTextEdit>
                                        <HeaderStyle BackColor="Gray" ForeColor="White" />
                                        <CellStyle ForeColor="Blue">
                            ...
                            <dx:GridViewBandColumn Caption="Lucro dos Ovos" VisibleIndex="11">
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="% Cresc" FieldName="percCrescLucro" ToolTip="% de Crescimento de Venda" VisibleIndex="7" Width="80px">
                                        <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                        </PropertiesTextEdit>
                                    </dx:GridViewDataTextColumn>
                                </Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="Descricao" FixedStyle="Left" VisibleIndex="0" Width="240px">
                    ...
                    <asp:SqlDataSource ID="dsDetail" runat="server" ConnectionString="<%$ ConnectionStrings:gerManagerConnectionString %>" SelectCommand="Gerencial.uspBuscarOvosPorGramagem_Produto" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:SessionParameter Name="Ano" SessionField="sANO" Type="Int16" />
                            <asp:SessionParameter Name="idFilial" SessionField="sFILIAL" Type="Byte" />
                            <asp:SessionParameter Name="idGramagem" SessionField="sGRAMAGEM" Type="Int16" />
                        </SelectParameters>
                    </asp:SqlDataSource>
