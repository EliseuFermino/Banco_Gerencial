...
Partial Class MemberPages_Campanha_Pascoa_Ovos
...
#Region " Page"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Not IsPostBack Then
            ...
            oVem.AtualizarEstatisticaPrograma(96, User.Identity.Name)
            Session("sCAMPANHA") = 1
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        CType(Master.Master.FindControl("lblTitle"), Label).Text = "Análise Ovos de Páscoa " & Me.cboAno.CallAno & " - PGR96"
    End Sub
...
#Region " Meus Scipts"
    ...
    Private Sub myLegendas()
        ...
        oFun.Grid_Title(Me.ASPxGridView1, "Análise Total dos Ovos de Páscoa " & anoAT)
        oFun.Grid_Title(Me.gridMeta, "Comparativo - Ovos de Páscoa - Meta x Realizado " & anoAT)
        oFun.Grid_Title(Me.gridTodosItens, "Ovos de Páscoa - Todos os Itens - " & anoAT)
