                    ...
                    <table id="gradient-style" summary="Meeting Results">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>O transporte e o armazenamento dos alimentos é realizado de forma adequada (carrinhos ou cubas exclusivos do setor; armazenamento em caixas limpas, uso de caixas não vazadas para alimentos em processo de manipulação)? <asp:TextBox
                            ...
                            <tr>
                                ...
                                <td>A produção armazenada está de acordo com a venda diária (a produção estocada na câmara foi manipulada no dia ou no máximo no dia anterior)? <asp:TextBox
                            ...
                            <tr>
                                ...
                                <td>O tempo mininimo de exposição para produtos perecíveis que estão fora da camara (maximo 1 hora) esta sendo respeitado ? <asp:TextBox
...
<asp:Panel ID="panTitle19" runat="server" CssClass="pnl_Azul" Width="890">  
...
<asp:Panel ID="panDados19" runat="server" Height="0" Style="border: solid 1px #c0c0c0; padding: 5px;" Width="890">      
    <p>  
                    <table id="gradient-style" summary="Meeting Results">
                        <thead>
    	                    <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Os equipamentos (fatiadoras, floculadora, máquina de vácuo) estão sendo bem higienizados, com frequência adequada e de forma a retirar completamente os resíduos (sem sujidades antigas)? <asp:TextBox
                            ...
                            <tr>
                                ...
                                <td align="center"><asp:RadioButton ID="rnd9_8_Sim" runat="server" GroupName="grupo9_8" /></td>
                                <td align="center"><asp:RadioButton ID="rnd9_8_Nao" runat="server" GroupName="grupo9_8" /></td>                                
                                <td align="center"><asp:RadioButton ID="rnd9_8_NA" runat="server" GroupName="grupo9_8" /></td>    
                                <td align="center">
                                     <div class="fileEscondido">
                            ...
                            <tr>
                                ...
                                <td align="center"><asp:RadioButton ID="rnd9_9_Sim" runat="server" GroupName="grupo9_9" /></td>
                                <td align="center"><asp:RadioButton ID="rnd9_9_Nao" runat="server" GroupName="grupo9_9" /></td>                                
                                <td align="center"><asp:RadioButton ID="rnd9_9_NA" runat="server" GroupName="grupo9_9" /></td> 
                                <td align="center">
                                     <div class="fileEscondido">
                            ...
                            <tr>
                                ...
                                <td align="center"><asp:RadioButton ID="rnd9_10_Sim" runat="server" GroupName="grupo9_10" /></td>
                                <td align="center"><asp:RadioButton ID="rnd9_10_Nao" runat="server" GroupName="grupo9_10" /></td>                                
                                <td align="center"><asp:RadioButton ID="rnd9_10_NA" runat="server" GroupName="grupo9_10" /></td> 
                                <td align="center">
                                     <div class="fileEscondido">
                            ...
                            <tr>
                                ...
                                <td align="center"><asp:RadioButton ID="rnd9_11_Sim" runat="server" GroupName="grupo9_11" /></td>
                                <td align="center"><asp:RadioButton ID="rnd9_11_Nao" runat="server" GroupName="grupo9_11" /></td>                                
                                <td align="center"><asp:RadioButton ID="rnd9_11_NA" runat="server" GroupName="grupo9_11" /></td>    
                                <td align="center">
                                     <div class="fileEscondido">
                            ...
                            <tr>
                                ...
                                <td align="center"><asp:RadioButton ID="rnd9_12_Sim" runat="server" GroupName="grupo9_12" /></td>
                                <td align="center"><asp:RadioButton ID="rnd9_12_Nao" runat="server" GroupName="grupo9_12" /></td>                                
                                <td align="center"><asp:RadioButton ID="rnd9_12_NA" runat="server" GroupName="grupo9_12" /></td>  
                                <td align="center">
                                     <div class="fileEscondido">
                            ...
                            <tr>
                                ...
                                <td align="center"><asp:RadioButton ID="rnd9_13_Sim" runat="server" GroupName="grupo9_13" /></td>
                                <td align="center"><asp:RadioButton ID="rnd9_13_Nao" runat="server" GroupName="grupo9_13" /></td>                                
                                <td align="center"><asp:RadioButton ID="rnd9_13_NA" runat="server" GroupName="grupo9_13" /></td>
                                <td align="center">
                                     <div class="fileEscondido">
...
<asp:Panel ID="panTitle20" runat="server" CssClass="pnl_Azul" Width="890">  
...
<asp:Panel ID="panDados20" runat="server" Height="0" Style="border: solid 1px #c0c0c0; padding: 5px;" Width="890">      
    <p>  
                    <table id="gradient-style" summary="Meeting Results">
                        <thead>
    	                    <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Os equipamentos (geladeira, multiprocessador, fogão, forno, fritadeira, liquidificador, suqueira, buffet) estão sendo bem higienizados, com frequência adequada e de forma a retirar completamente os resíduos (sem sujidades antigas)? <asp:TextBox
                            ...
                            <tr>
                                ...
                                <td>A coleta de amostras de todas as refeições preparadas é realizada diariamente (200g de cada alimento)? São mantidas armazenadas por 3 dias?  <asp:TextBox
                            ...
                            <tr>
                                ...
                                <td>O tempo mininimo de exposição para produtos perecíveis e as preparações prontas que estão fora da camara (maximo 1 hora) esta sendo respeitado ?  <asp:TextBox
                            ...
                            <tr>
                                ...
                                <td align="center"><asp:RadioButton ID="rnd10_12_Sim" runat="server" GroupName="grupo10_12" /></td>
                                <td align="center"><asp:RadioButton ID="rnd10_12_Nao" runat="server" GroupName="grupo10_12" /></td>                                
                                <td align="center"><asp:RadioButton ID="rnd10_12_NA" runat="server" GroupName="grupo10_12" /></td>  
                                <td align="center">
                                     <div class="fileEscondido">
                            ...
                            <tr>
                                ...
                                <td align="center"><asp:RadioButton ID="rnd10_13_Sim" runat="server" GroupName="grupo10_13" /></td>
                                <td align="center"><asp:RadioButton ID="rnd10_13_Nao" runat="server" GroupName="grupo10_13" /></td>                                
                                <td align="center"><asp:RadioButton ID="rnd10_13_NA" runat="server" GroupName="grupo10_13" /></td>
                                <td align="center">
                                     <div class="fileEscondido">
                            ...
                            <tr>
                                ...
                                <td align="center"><asp:RadioButton ID="rnd10_14_Sim" runat="server" GroupName="grupo10_14" /></td>
                                <td align="center"><asp:RadioButton ID="rnd10_14_Nao" runat="server" GroupName="grupo10_14" /></td>                                
                                <td align="center"><asp:RadioButton ID="rnd10_14_NA" runat="server" GroupName="grupo10_14" /></td>  
                                <td align="center">
                                     <div class="fileEscondido">
...
<asp:Panel ID="panTitle21" runat="server" CssClass="pnl_Azul" Width="890">  
...
<asp:Panel ID="panDados21" runat="server" Height="0" Style="border: solid 1px #c0c0c0; padding: 5px;" Width="890">      
    <p>  
                    <table id="gradient-style" summary="Meeting Results">
                        <thead>
    	                    <tr>
                        ...
                        <tbody>
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td>O transporte e o armazenamento dos alimentos é realizado de forma adequada (carrinhos ou cubas exclusivos do setor; armazenamento em caixas/ carrinhos furgões limpos)? <asp:TextBox
...
<asp:Panel ID="panTitle22" runat="server" CssClass="pnl_Azul" Width="890">  
...
<asp:Panel ID="panDados22" runat="server" Height="0" Style="border: solid 1px #c0c0c0; padding: 5px;" Width="890">      
    <p>  
                    <table id="gradient-style" summary="Meeting Results">
                        <thead>
    	                    <tr>
...
<asp:Panel ID="panTitle23" runat="server" CssClass="pnl_Azul" Width="890">  
...
<asp:Panel ID="panDados23" runat="server" Height="0" Style="border: solid 1px #c0c0c0; padding: 5px;" Width="890">      
    <p>  
                    <table id="gradient-style" summary="Meeting Results">
                        <thead>
    	                    <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Está sendo realizado o controle de temperatura dos produtos perecíveis recebidos (todas as cargas)? A planilha está corretamente preenchida? <asp:TextBox
...
<asp:Panel ID="panTitle24" runat="server" CssClass="pnl_Azul" Width="890">  
...
<asp:Panel ID="panDados24" runat="server" Height="0" Style="border: solid 1px #c0c0c0; padding: 5px;" Width="890">      
    <p>  
                    <table id="gradient-style" summary="Meeting Results">
                        <thead>
    	                    <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>As instalações sanitárias estão limpas, íntegras, em bom estado de conservação e sem acúmulo de lixo? (Bolor, água estagnada, vetores, presença de fiação exposta, fechamento das portas adequado, vasos sanitários com tampa e assento) <asp:TextBox
...
<asp:Panel ID="panTitle25" runat="server" CssClass="pnl_Azul" Width="890">  
...
<asp:Panel ID="panDados25" runat="server" Height="0" Style="border: solid 1px #c0c0c0; padding: 5px;" Width="890">      
    <p>  
                    <table id="gradient-style" summary="Meeting Results">
                        <thead>
    	                    <tr>
                        ...
                        <tbody>
                           ...
                           <tr>
                                ...
                                <td>As edificações estão limpas e íntegras? Os ralos, luminárias e portas de acesso são mantidos limpos e em bom estado de conservação? (bolor, água estagnada, mau cheiro, acesso a pragas e vetores, infiltrações ou danos estruturais) <asp:TextBox
                            ...
                            <tr>
                                ...
                                <td>As estantes e os pallets do depósito de embalagens estão limpos e íntegros? O mesmo está organizado, sem fardos abertos e embalagens soltas pelo setor? <asp:TextBox
