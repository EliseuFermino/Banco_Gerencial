...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div id="divQuadrante2_1" class="Quadrante">
        <dx:ASPxRadioButtonList ID="chkTipoGiro" runat="server" SelectedIndex="1" Theme="Mulberry" Height="75px" Width="155px"  >
               <Items>
                   <dx:ListEditItem Selected="true" Text="Pela Venda" Value="1" />
                   <dx:ListEditItem Text="Pela Compra" Value="2" />
               </Items>
    ...
    <div id="divQuadrante4" class="Quadrante">
        <div id="divQuadrante4_1">
            ...
            <dx:ASPxCheckBox ID="chkExibirDias" runat="server" Text="Exibir Dias" BackColor="#009900" ForeColor="White" Font-Bold="True"  OnCheckedChanged="chk_CheckedChanged" Theme="DevEx" CheckState="Unchecked" ClientInstanceName="chk_ExibirDias">
    ...
    <div id="divDados">
        ...
        <dx:ASPxGridView ID="grid" runat="server" DataSourceID="dsDados" AutoGenerateColumns="False" KeyFieldName="ID" Width="100%" ClientInstanceName="grid">
            ...
            <Columns>
                ...
                <dx:GridViewBandColumn Caption="Perdas de Vendas" VisibleIndex="29">
                    <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Vendas &lt;br&gt; nos Últimos &lt;br&gt; 10 Dias" FieldName="mediaQtde10Dias" VisibleIndex="18" Width="90px">
                    <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                    </PropertiesTextEdit>
                    <Settings AllowAutoFilter="True" AutoFilterCondition="Greater" />
                    <HeaderStyle BackColor="#009900" ForeColor="White" />
                    <CellStyle Font-Bold="False" ForeColor="#009900" HorizontalAlign="Center">
                    </CellStyle>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="10" VisibleIndex="17" Visible="False">
                    <Settings AllowAutoFilter="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="9" VisibleIndex="16" Visible="False">
                    <Settings AllowAutoFilter="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="8" VisibleIndex="15" Visible="False">
                    <Settings AllowAutoFilter="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="7" VisibleIndex="14" Visible="False">
                    <Settings AllowAutoFilter="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="6" VisibleIndex="13" Visible="False">
                    <Settings AllowAutoFilter="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="5" VisibleIndex="12" Visible="False">
                    <Settings AllowAutoFilter="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="4" VisibleIndex="11" Visible="False">
                    <Settings AllowAutoFilter="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="3" VisibleIndex="10" Visible="False">
                    <Settings AllowAutoFilter="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="2" VisibleIndex="9" Visible="False">
                    <Settings AllowAutoFilter="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="1" VisibleIndex="8" Visible="False">
                    <PropertiesTextEdit ClientInstanceName="col_1">
                    </PropertiesTextEdit>
                    <Settings AllowAutoFilter="False" />
                </dx:GridViewDataTextColumn>
            </Columns>
