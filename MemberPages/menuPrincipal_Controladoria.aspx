...
<%@ Register Src="~/Controles/wucListaDiaD.ascx" TagPrefix="uc1" TagName="wucListaDiaD" %>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <dx:ASPxGridView ID="grid_Top5_LucroPDV" runat="server" AutoGenerateColumns="False" DataSourceID="ds_Dashboard_Top5_LucroPDV" EnableTheming="True" Theme="PlasticBlue" Width="100%">
                                    ...
                                    <Settings VerticalScrollBarMode="Visible" VerticalScrollableHeight="334" />
                                    <SettingsBehavior AllowFocusedRow="True" />
...
<Legend Name="Default Legend" Visibility="False"></Legend>
                ...
                <div class="col-xs-12 col-sm-4">
					<div class="widget-box">
						...
						<div class="widget-header"><h6 class="widget-title"><span class="fa fa-desktop" ></span> &nbsp; % Cresc. por Filial <asp:Label ID="lblCresc_Filial" runat="server"></asp:Label></h6>
						...
						<div class="widget-body">
                            <div class="widget-main">
                                 ...
                                 <dxchartsui:WebChartControl ID="grafico_Crescimento_Filial" runat="server" DataSourceID="dsGrafico_Crescimento_Filial" Height="370px" Width="585px">
...
<Legend Name="Default Legend" Visibility="False"></Legend>
							    ...
							    <asp:SqlDataSource ID="dsGrafico_Crescimento_Filial" runat="server" ConnectionString="<%$ ConnectionStrings:DWConnectionString %>" SelectCommand="Dashboard.uspCrescimentoNegativoPorFilial" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
      ...
      <div class="row Quebra_Pagina_Row">
                     ...
                     <dx:ASPxGridView ID="gridItem" runat="server" AutoGenerateColumns="False"                       
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="FilialDesc" VisibleIndex="0" 
                                Caption="Filial" FixedStyle="Left">
                            ...
                            <dx:GridViewDataCheckColumn Caption="Camp" FieldName="descCampanha" ToolTip="Em Campnha ? " VisibleIndex="3" Width="40px">
                                <PropertiesCheckEdit>
              ...
              <div class="col-xs-12 col-sm-4">
					<div class="widget-box">
						<div class="widget-header"><h6 class="widget-title"><span class="fa fa-desktop" ></span> &nbsp; USO e CONSUMO - Comparativo com Ano Anterior</h6>
	...
	ShowLoginWindow(); 
                                    ...
                                    <Settings VerticalScrollBarMode="Visible" ShowFooter="True" VerticalScrollableHeight="209" />
                                    <SettingsBehavior AllowFocusedRow="True" />
                                    <SettingsResizing ColumnResizeMode="Control" />
                                    <SettingsText Title="Projeção Venda Hoje" />
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="vlr245_AA" ShowInCustomizationForm="True" VisibleIndex="2">
                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                            </PropertiesTextEdit>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="vlrProjecao" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="4">
                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                            </PropertiesTextEdit>
                                        </dx:GridViewDataTextColumn>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="vlr245_MA" ShowInCustomizationForm="True" VisibleIndex="3">
                                            <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                            </PropertiesTextEdit>
                                        </dx:GridViewDataTextColumn>
						...
						<div class="widget-body">
							<div class="widget-main" style="overflow-x:auto ">
                             ...
                             <dx:ASPxGridView ID="grid_Meta_Realizado_Ag23" runat="server" AutoGenerateColumns="False" DataSourceID="ds_Perdas_Loja_Metas_x_Realizado" EnableTheming="True" Theme="PlasticBlue" Width="100%">
                                    ...
                                    <Settings VerticalScrollBarMode="Visible" VerticalScrollableHeight="233" />
                                    <SettingsBehavior AllowFocusedRow="True" />
                                    <SettingsResizing ColumnResizeMode="Control" />
                                    <SettingsText Title="Projeção Venda Hoje" />
                                    <Columns>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <dx:ASPxGridView ID="grid_Loja_Nao_Fizeram_Checklist" runat="server" AutoGenerateColumns="False" DataSourceID="dsChecklist" EnableTheming="True" Theme="SoftOrange" Font-Size="Medium" Width="100%" KeyFieldName="Gestor">
                                    ...
                                    <Templates>
                                        <DetailRow>
                                            <dx:ASPxGridView ID="grid_Loja_Nao_Fizeram_Checklist" runat="server" AutoGenerateColumns="False" DataSourceID="dsComprador" EnableTheming="True" Font-Size="Medium" Theme="PlasticBlue" Width="100%" OnBeforePerformDataSelect="grid_Loja_Nao_Fizeram_Checklist_BeforePerformDataSelect" KeyFieldName="Comprador" OnCustomUnboundColumnData="grid_Loja_Nao_Fizeram_Checklist_CustomUnboundColumnData1" OnHtmlDataCellPrepared="grid_Loja_Nao_Fizeram_Checklist_HtmlDataCellPrepared2">
                                                <SettingsPager Mode="ShowAllRecords">
                                                </SettingsPager>
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Meta (1)" FieldName="vlrMeta_Venda" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="2">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False"></PropertiesTextEdit>
                                                        <CellStyle HorizontalAlign="Right">
                                                        </CellStyle>
                                                    </dx:GridViewDataTextColumn>
                                                    <dx:GridViewDataTextColumn Caption="Real (2)" FieldName="vlrVenda" ReadOnly="True" ShowInCustomizationForm="True" SortIndex="0" SortOrder="Descending" VisibleIndex="3">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False"></PropertiesTextEdit>
                                                        <CellStyle HorizontalAlign="Right">
                                                        </CellStyle>
                                                    </dx:GridViewDataTextColumn>
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Seção" FieldName="Secao" VisibleIndex="1">
                                                        <CellStyle HorizontalAlign="Left">
                                                        </CellStyle>
                                                    </dx:GridViewDataTextColumn>
                                                    <dx:GridViewDataTextColumn Caption="Dif (2) - (1)" FieldName="dif_MxR_Vlr" ShowInCustomizationForm="True" UnboundType="Decimal" VisibleIndex="4">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                    </dx:GridViewDataTextColumn>
                                                </Columns>
  ...
  <dx:TabPage Text="Acima da Quantidade - Condor">
                <ContentCollection>
                    <dx:ContentControl ID="ContentControl5" runat="server">
                        ...
                        <div style="clear:both; float:left; padding-bottom: 5px ; padding-right: 10px " >
                            <dx:ASPxRadioButton ID="rndTodos" runat="server" Text="Todas as Campanhas" GroupName="GroupCamp" Theme="Material"  AutoPostBack="false">
	...
	cbPanelAcima.PerformCallback() ;
                        ...
                        <div style="float:left; padding-bottom: 5px ; padding-right: 10px " >
                           ...
                           <dx:ASPxRadioButton ID="rndRadio" runat="server" Text="Campanhas de Rádio e TV" GroupName="GroupCamp" Checked="true" Theme="Material" AutoPostBack="false" >
                               <ClientSideEvents CheckedChanged="function(s, e) {
cbPanelAcima.PerformCallback() ;	
}" />
                        </dx:ASPxRadioButton> 
                        ...
                        <div style="float:left; padding-bottom: 5px ; padding-right: 10px " >
                           ...
                           <dx:ASPxRadioButton ID="rndAll" runat="server" Text="Todos Acima" GroupName="GroupCamp" Checked="true" Theme="Material" AutoPostBack="false" >
                               <ClientSideEvents CheckedChanged="function(s, e) {
cbPanelAcima.PerformCallback() ;	
}" />
                        </dx:ASPxRadioButton> 
...
<CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje"></CalendarProperties>
              ...
              <dx:TabPage Text="Acima da Quantidade - Atacarejo">
                <ContentCollection>
                    <dx:ContentControl ID="ContentControl2" runat="server">
                        ...
                        <div style="clear:both; float:left; padding-bottom: 5px ; padding-right: 10px " >
                            <dx:ASPxRadioButton ID="rndTodosAtacarejo" runat="server" Text="Todas as Campanhas" GroupName="GroupCampAtacarejo" Theme="Material"  AutoPostBack="false">
                                <ClientSideEvents CheckedChanged="function(s, e) {
	cbPanelAcimaAtacarejo.PerformCallback() ;
                        ...
                        <div style="float:left; padding-bottom: 5px ; padding-right: 10px " >
                           ...
                           <dx:ASPxRadioButton ID="rndRadioAtacarejo" runat="server" Text="Campanhas de Rádio e TV" GroupName="GroupCampAtacarejo" Checked="true" Theme="Material" AutoPostBack="false" >
                               <ClientSideEvents CheckedChanged="function(s, e) {
cbPanelAcimaAtacarejo.PerformCallback() ;	
}" />
                        </dx:ASPxRadioButton> 
                        ...
                        <div style="float:left; padding-bottom: 5px ; padding-right: 10px " >
                           ...
                           <dx:ASPxRadioButton ID="rndAllAtacarejo" runat="server" Text="Todos Acima" GroupName="GroupCampAtacarejo" Checked="true" Theme="Material" AutoPostBack="false" >
                               <ClientSideEvents CheckedChanged="function(s, e) {
cbPanelAcimaAtacarejo.PerformCallback() ;	
}" />
                        </dx:ASPxRadioButton> 
