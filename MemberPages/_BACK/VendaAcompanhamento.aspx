<%@ Page Title="Ranking de Vendas Diário - por Loja" Language="VB" MasterPageFile="~/MemberPages/SiteVendas.master" AutoEventWireup="false" CodeFile="VendaAcompanhamento.aspx.vb" Inherits="MemberPages_Vendas_VendaAcompanhamento" %>
...
<%--    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <%-- ********************* L U C R O   N E G A T I V O ************************* --%>
            ...
            <div id="div_Top30_Lucro_Negativa_Lojas" class="Separacao">                        
                <uc1:wucLista_Filial_Empresa_2 runat="server" ID="cboFilial_ItensLucroNegativo" AutoPostBack="false"  />

            </div>

            <div id="divBotao_PaneVendaItemLucroNegativo" >
                <dx:ASPxButton ID="btnAtualizar_ItemLucroNegativo" runat="server" Text="Atualizar" AutoPostBack="False" Theme="MetropolisBlue">
                    ...
                    <dx:PanelContent>   
                        ...
                        <asp:SqlDataSource ID="ds_Top30_Lucro_Negativo" runat="server" ConnectionString="<%$ ConnectionStrings:gerVendaItemConnectionString %>" SelectCommand="Dia.uspBuscar_Lucro_Negativo" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                ...
                                <asp:SessionParameter DbType="Byte" DefaultValue="99" Name="idFilial" SessionField="sFILIAL_LUCRO_NEGATIVO" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                ...
                <PanelCollection>
                    ...
                    <div id="divTop30_Volume" class="Separacao">
                        ...
                        <dx:ASPxGridView ID="gridItensMenosVendidos" runat="server" AutoGenerateColumns="False" DataSourceID="dsItensMenosVendidos" KeyFieldName="CodProduto" Width="910px">
                            ...
                            <SettingsText Title="Top 50 - Volume Mais Vendido na Empresa" />
                            <Styles>
                                <Header HorizontalAlign="Center">
                                </Header>
                                <AlternatingRow BackColor="#F2F2F2">
                    ...
                    <div id="divTop30_Lucro" class="Separacao">
                        ...
                        <dx:ASPxGridView ID="gridItensMaisVendidosLucro" runat="server" AutoGenerateColumns="False" DataSourceID="dsItensMaisVendidosLucro" KeyFieldName="CodProduto" Width="910px">
                            ...
                            <Settings ShowTitlePanel="True" VerticalScrollableHeight="230" VerticalScrollBarMode="Visible" />
                            <SettingsText Title="Top 50 - Lucro dos Itens Mais Vendidos na Empresa" />
                            <Styles>
                                <Header HorizontalAlign="Center">
                                </Header>
                                <AlternatingRow BackColor="#F2F2F2">
                    ...
                    <div id="divTop30_Menos" class="Separacao">
                        ...
                        <dx:ASPxGridView ID="gridItensMenosVendidosEmpresa" runat="server" AutoGenerateColumns="False" DataSourceID="dsItensMenosVendidosEmpresa" EnableTheming="True" KeyFieldName="CodProduto" Theme="Default" Width="910px">
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Situação" FieldName="Ativo" VisibleIndex="3" Width="100px">
                                    <CellStyle Wrap="False">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                            </Columns>
                            ...
                            <Settings ShowTitlePanel="True" VerticalScrollableHeight="230" VerticalScrollBarMode="Visible" />
                            <SettingsText Title="Top 50 - Itens Menos Vendidos na Empresa" />
                            <Styles>
                                <Header HorizontalAlign="Center">
                                </Header>
                                <AlternatingRow BackColor="#F2F2F2">
