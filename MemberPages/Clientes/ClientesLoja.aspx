<%@ Page Title="Vendas por Loja" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="ClientesLoja.aspx.vb" Inherits="MemberPages_Clientes_ClientesLoja" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
	...
	cbPanel.PerformCallback();
        ...
        <div class="clsRnds">
            <dx:ASPxRadioButton ID="rndAteOntem" runat="server" Text="Até Ontem" AutoPostBack="false" GroupName="meuGrupo" Theme="DevEx" Visible="true" Checked="True" >
                <ClientSideEvents CheckedChanged="function(s, e) {cbPanel.PerformCallback();}" />
            </dx:ASPxRadioButton>
        </div>

        <div class="clsRnds">
            <dx:ASPxRadioButton ID="rndAteHoje" runat="server" Text="Até Hoje" AutoPostBack="false" GroupName="meuGrupo" Theme="DevEx" ForeColor="Green" Visible="true">
                <ClientSideEvents CheckedChanged="function(s, e) {cbPanel.PerformCallback();}" />
            </dx:ASPxRadioButton>
        </div>
                    ...
                    <dx:PanelContent runat="server" SupportsDisabledAttributes="both"> 
                        ...
                        <div id="divDados_Tabela">
                                    ...
                                    <dx:ASPxGridView ID="ASPxGridView1" runat="server" 
                                        ...
                                        Theme="SoftOrange" style="margin-bottom: 0px" Width="1000px" DataSourceID="dsDadosVendas">
                                        <TotalSummary>                                            
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewBandColumn Caption="Vendas" VisibleIndex="2" 
                                                ToolTip="Grupo de vendas financeiras que compreende: Sugestão, Meta, Realizado e Percentual de Atingimento da Venda Realizada sobre a Meta de Venda." Visible="False">
                                                <Columns>
                                                    <dx:GridViewDataTextColumn Caption="Meta" FieldName="vlrMetaVenda" 
                                                        VisibleIndex="1" ToolTip="Meta de Venda" Width="90px" Visible="False" FixedStyle="Left" Name="bandMetaVenda">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <Settings AllowAutoFilter="False" />
                                            ...
                                            <dx:GridViewBandColumn Caption="Lucro" VisibleIndex="4" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Dif." FieldName="difVlrMargem" ShowInCustomizationForm="True" ToolTip="Diferença entre o lucro do ano atual e do lucro do ano anterior" VisibleIndex="2" Width="70px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <Settings AllowAutoFilter="False" />
                                                    </dx:GridViewDataTextColumn>
    ...
    <uc1:wucObsPrograma runat="server" ID="wucObsPrograma" Anotacao1="Principal: gerManager.Vendas_Dia.uspBuscar_AnaliseLojaAnoAnterior" Anotacao2="Detail: gerManager.Vendas_Dia.uspBuscar_AnaliseLojaLojaSecao" />
