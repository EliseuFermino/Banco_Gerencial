...
Partial Class MemberPages_Clientes_ClientesPorSecao
...
#Region " PAGE"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            oVem.AtualizarEstatisticaPrograma(271, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Análise de Clientes por Seção - PGR271"
        End If
    ...
    Protected Sub Page_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
        ...
        If Not IsPostBack Then
            If cboFilial.IsLoja = True Then
                ASPxGridView1.SettingsDetail.ShowDetailButtons = False
