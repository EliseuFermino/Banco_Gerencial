...
Partial Public Class MemberPages_Calendario_Comercial
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs)
        ...
        If Not IsPostBack Then
            oVem.AtualizarEstatisticaPrograma(345, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        CType(Master.FindControl("lblTitle"), Label).Text = "Agenda da Sala de Reunião do Comercial - PGR345"
    End Sub
End Class