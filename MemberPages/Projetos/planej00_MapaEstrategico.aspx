<%@ Page Title="" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="planej00_MapaEstrategico.aspx.vb" Inherits="Ranking_planej00_Planejamento" %>
            ...
            <tr>
                <td align="center" valign="top">
                    <dxe:ASPxImage ID="ASPxImage1" runat="server" 
                        ImageUrl="~/image/planejMapaEstrategicoCondor.png" Height="525px" 
                        Width="707px">
                        <Border BorderColor="#3399FF" BorderStyle="Solid" BorderWidth="2px" />
                    </dxe:ASPxImage>
                </td>
            </tr>
        </table>
