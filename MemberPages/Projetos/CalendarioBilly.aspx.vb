...
Partial Public Class MemberPages_Calendario_Billy
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs)
        ...
        If Not IsPostBack Then
            oVem.AtualizarEstatisticaPrograma(353, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        CType(Master.FindControl("lblTitle"), Label).Text = "Agenda do Auditório - Billy Zonta - PGR353"
    End Sub
End Class