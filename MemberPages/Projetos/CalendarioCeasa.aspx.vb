...
Partial Public Class MemberPages_Calendario_Ceasa
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs)
        ...
        If Not IsPostBack Then
            oVem.AtualizarEstatisticaPrograma(282, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        CType(Master.FindControl("lblTitle"), Label).Text = "Agenda CEASA - PGR282"
    End Sub
End Class