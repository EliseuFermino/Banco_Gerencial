<%@ Page Title="" Language="VB" MasterPageFile="~/MemberPages/Projetos/mpPlanejamento.master" AutoEventWireup="true" CodeFile="planej04_PlanoAcao.aspx.vb" Inherits="MemberPages_planej04_PlanoAcao" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server" BackColor="White" BorderColor="#003399" 
        BorderStyle="Solid" BorderWidth="2px" Height="1545px" Width="1100px">
        <table class="style1">
            <tr>
	...
	frmEdit.Show()
                                ...
                                <td>
                                    <dxe:ASPxButton ID="btnAta" runat="server" 
                                        ...
                                        CssPostfix="Office2003_Olive" Text="Ir para  Ata" Width="90px" Theme="Metropolis">
                                        <ClientSideEvents Click="function(s, e) {
	panAta.Show();
}" />
                                    </dxe:ASPxButton>
            ...
            <tr>
                <td>
                    ...
                    <dxwgv:ASPxGridView ID="grid" runat="server" DataSourceID="SqlDS2"  Width="1050px" 
                        ...
                        ClientInstanceName="grid" Theme="PlasticBlue">
