...
Partial Public Class MemberPages_Calendario_Camila
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs)
        ...
        If Not IsPostBack Then
            oVem.AtualizarEstatisticaPrograma(344, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        CType(Master.FindControl("lblTitle"), Label).Text = "Agenda da Universidade Corporativa Condor - PGR344"
    End Sub
End Class