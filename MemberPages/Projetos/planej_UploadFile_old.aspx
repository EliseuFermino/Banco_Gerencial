<%@ Page Title="Importar arquivo para projeto" Language="VB" MasterPageFile="~/MemberPages/mpPrincipal.master" AutoEventWireup="false" CodeFile="planej_UploadFile_old.aspx.vb" Inherits="MemberPages_planejUploadArquivo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <p>
            ...
            <table cellspacing="1" class="style1">
                ...
                <tr>
                    <td colspan="2">
                        <asp:Button ID="btnSubmit_Manutencao" runat="server" Text="Enviar arquivo" />
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
        ...
        <p>
            <table cellspacing="1" class="style1">
                <tr>
                    <td class="style9">
                        Localização e nome do arquivo:</td>
                    <td>
                        &nbsp;</td>
                    <td>
                        &nbsp;</td>
            ...
            <asp:SqlDataSource ID="dsListaProjeto" runat="server" 
                ...
                <td align="center" valign="top" class="style10">
                    <asp:Panel ID="panelDelete" runat="server" BorderColor="#D2E9FF" 
                        BorderStyle="Solid" BorderWidth="1px" Height="350px" Width="500px">
                        <table cellspacing="1" class="style1" 
    style="width: 88%; margin-left: 0px;">
                        ...
                        <dxwgv:ASPxGridView ID="gridView" runat="server" AutoGenerateColumns="False" 
                            ...
                            CssPostfix="Office2003_Blue" Width="500px">
            ...
            <tr>
                <td class="style11">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT idFile, NomeArquivo, Nome, ProjetoID, dataUpload  AS Data, linkFile FROM projArquivos WHERE (ProjetoID = @ProjetoID OR ProjetoID=999)">
                        <SelectParameters>
