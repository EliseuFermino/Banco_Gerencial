...
Partial Public Class MemberPages_Calendario_JoaoZonta
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs)
        ...
        If Not IsPostBack Then
            oVem.AtualizarEstatisticaPrograma(352, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        CType(Master.FindControl("lblTitle"), Label).Text = "Agenda do Auditório - Integração - PGR352"
    End Sub
End Class