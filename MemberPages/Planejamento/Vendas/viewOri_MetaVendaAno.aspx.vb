...
Partial Class MemberPages_viewOri_MetaVendaAno
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not IsPostBack Then
            ...
            oVem.AtualizarEstatisticaPrograma(173, Me.User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        CType(Master.Master.FindControl("lblTitle"), Label).Text = "Relatórios - Orçamento - Meta de Venda por Filial - Ano - PGR173"
    End Sub
