...
Partial Class MemberPages_Planejamento_Vendas_AnaliseMetaVendaPosto
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            oVem.AtualizarEstatisticaPrograma(211, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Orçamento - Analise de Meta de Vendas dos Postos - PGR211"
        End If
