...
Partial Class MemberPages_Consulta12MesesGigante
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Not IsPostBack Then
            ...
            Me.ASPxGridView1.Caption = "Meta Original das Vendas da Gigante do Ano de " & Me.cboAno.CallAno & "."
        End If
    End Sub
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Relatórios - Orçamento Gigante - Meta de Venda por Filial - 12 meses - PGR41"
        End If
