<%@ Page Title="Cadastro de Metas de Venda" Language="VB" AutoEventWireup="false" CodeFile="frmCadVenda.aspx.vb" Inherits="MemberPages_Planejamento_frmCadVenda" MasterPageFile="~/MemberPages/Site.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div id="divFilial">
        <uc3:wucListaLojasComCorporacao ID="cboFilial" runat="server" AutoPostBack="True" />
    </div>
   ...
   <div id="divDados">
    ...
    <table cellpadding="0" cellspacing="0" >
        ...
        <tr>
            ...
            <td align="right" bgcolor="#DFEEFF" class="auto-style5" 
            ...
            <td align="right" bgcolor="#DFEEFF" class="auto-style6" 
        ...
        <tr>
            ...
            <td align="right" bgcolor="#CCCCCC" class="auto-style6" 
            ...
            <td align="right" bgcolor="#CCCCCC" class="auto-style7" 
                ...
                <td class="style25" align="left" 
                    ...
                    <asp:Panel ID="Panel1" runat="server" Height="200px" ScrollBars="Vertical">
                        ...
                        <dxe:ASPxButton ID="link_DRE" runat="server" 
                            CssFilePath="~/App_Themes/Aqua/{0}/styles.css" CssPostfix="Aqua" 
                            HorizontalAlign="Left" Text="13 - D.R.E" Width="195px">
                        </dxe:ASPxButton>
                    </asp:Panel>
                    </td>
            </tr>
