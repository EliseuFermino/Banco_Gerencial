...
Partial Class MemberPages_Planejamento_frmCadVenda
    ...
    Sub Atualizar()
        ...
        cboPosicao.CallPosicao = 6
        cboGrupo_Sub.CallGrupo = 1
        ...
        Call PreencherCrescimento_Historico()
        Call PreencherCrescimento_Meta()
...
#Region " Calcular Valor da Meta"
    ...
    Protected Sub txt_vlrMeta01_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_vlrMeta01.TextChanged
        Call Totalizar()
        Me.txt_percMeta01.Text = CalcularCrescimento(txt_vlrMeta01.Text, lbl_vlrHist1_1.Text)
        Call FormatarNegativo_Texto(Me.txt_percMeta01)
    ...
    Protected Sub txt_vlrMeta02_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_vlrMeta02.TextChanged
        Call Totalizar()
        Me.txt_percMeta02.Text = CalcularCrescimento(txt_vlrMeta02.Text, lbl_vlrHist1_2.Text)
        Call FormatarNegativo_Texto(Me.txt_percMeta02)
    ...
    Protected Sub txt_vlrMeta03_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_vlrMeta03.TextChanged
        Call Totalizar()
        Me.txt_percMeta03.Text = CalcularCrescimento(txt_vlrMeta03.Text, lbl_vlrHist1_3.Text)
        Call FormatarNegativo_Texto(Me.txt_percMeta03)
    ...
    Protected Sub txt_vlrMeta04_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_vlrMeta04.TextChanged
        Call Totalizar()
        Me.txt_percMeta04.Text = CalcularCrescimento(txt_vlrMeta04.Text, lbl_vlrHist1_4.Text)
        Call FormatarNegativo_Texto(Me.txt_percMeta04)
    ...
    Protected Sub txt_vlrMeta05_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_vlrMeta05.TextChanged
        Call Totalizar()
        Me.txt_percMeta05.Text = CalcularCrescimento(txt_vlrMeta05.Text, lbl_vlrHist1_5.Text)
        Call FormatarNegativo_Texto(Me.txt_percMeta05)
    ...
    Protected Sub txt_vlrMeta06_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_vlrMeta06.TextChanged
        Call Totalizar()
        Me.txt_percMeta06.Text = CalcularCrescimento(txt_vlrMeta06.Text, lbl_vlrHist1_6.Text)
        Call FormatarNegativo_Texto(Me.txt_percMeta06)
    ...
    Protected Sub txt_vlrMeta07_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_vlrMeta07.TextChanged
        Call Totalizar()
        Me.txt_percMeta07.Text = CalcularCrescimento(txt_vlrMeta07.Text, lbl_vlrHist1_7.Text)
        Call FormatarNegativo_Texto(Me.txt_percMeta07)
    ...
    Protected Sub txt_vlrMeta08_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_vlrMeta08.TextChanged
        Call Totalizar()
        Me.txt_percMeta08.Text = CalcularCrescimento(txt_vlrMeta08.Text, lbl_vlrHist1_8.Text)
        Call FormatarNegativo_Texto(Me.txt_percMeta08)
    ...
    Protected Sub txt_vlrMeta09_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_vlrMeta09.TextChanged
        Call Totalizar()
        Me.txt_percMeta09.Text = CalcularCrescimento(txt_vlrMeta09.Text, lbl_vlrHist1_9.Text)
        Call FormatarNegativo_Texto(Me.txt_percMeta09)
    ...
    Protected Sub txt_vlrMeta10_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_vlrMeta10.TextChanged
        Call Totalizar()
        Me.txt_percMeta10.Text = CalcularCrescimento(txt_vlrMeta10.Text, lbl_vlrHist1_10.Text)
        Call FormatarNegativo_Texto(Me.txt_percMeta10)
    ...
    Protected Sub txt_vlrMeta11_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_vlrMeta11.TextChanged
        Call Totalizar()
        Me.txt_percMeta11.Text = CalcularCrescimento(txt_vlrMeta11.Text, lbl_vlrHist1_11.Text)
        Call FormatarNegativo_Texto(Me.txt_percMeta11)
    ...
    Protected Sub txt_vlrMeta12_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_vlrMeta12.TextChanged
        Call Totalizar()
        Me.txt_percMeta12.Text = CalcularCrescimento(txt_vlrMeta12.Text, lbl_vlrHist1_12.Text)
        Call FormatarNegativo_Texto(Me.txt_percMeta12)
...
#End Region
    ...
    Protected Sub btnPreencher_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPreencher.Click
        If Me.txt_Preencher12meses.Text <> "" Then
            ...
            Else
                ...
                Me.txt_vlrMeta01.Text = (((Me.lbl_vlrHist1_1.Text * Me.txt_percMeta01.Text) / 100) + Me.lbl_vlrHist1_1.Text).ToString("n")
                Me.txt_vlrMeta02.Text = (((Me.lbl_vlrHist1_2.Text * Me.txt_percMeta02.Text) / 100) + Me.lbl_vlrHist1_2.Text).ToString("n")
                Me.txt_vlrMeta03.Text = (((Me.lbl_vlrHist1_3.Text * Me.txt_percMeta03.Text) / 100) + Me.lbl_vlrHist1_3.Text).ToString("n")
                Me.txt_vlrMeta04.Text = (((Me.lbl_vlrHist1_4.Text * Me.txt_percMeta04.Text) / 100) + Me.lbl_vlrHist1_4.Text).ToString("n")
                Me.txt_vlrMeta05.Text = (((Me.lbl_vlrHist1_5.Text * Me.txt_percMeta05.Text) / 100) + Me.lbl_vlrHist1_5.Text).ToString("n")
                Me.txt_vlrMeta06.Text = (((Me.lbl_vlrHist1_6.Text * Me.txt_percMeta06.Text) / 100) + Me.lbl_vlrHist1_6.Text).ToString("n")
                Me.txt_vlrMeta07.Text = (((Me.lbl_vlrHist1_7.Text * Me.txt_percMeta07.Text) / 100) + Me.lbl_vlrHist1_7.Text).ToString("n")
                Me.txt_vlrMeta08.Text = (((Me.lbl_vlrHist1_8.Text * Me.txt_percMeta08.Text) / 100) + Me.lbl_vlrHist1_8.Text).ToString("n")
                Me.txt_vlrMeta09.Text = (((Me.lbl_vlrHist1_9.Text * Me.txt_percMeta09.Text) / 100) + Me.lbl_vlrHist1_9.Text).ToString("n")
                Me.txt_vlrMeta10.Text = (((Me.lbl_vlrHist1_10.Text * Me.txt_percMeta10.Text) / 100) + Me.lbl_vlrHist1_10.Text).ToString("n")
                Me.txt_vlrMeta11.Text = (((Me.lbl_vlrHist1_11.Text * Me.txt_percMeta11.Text) / 100) + Me.lbl_vlrHist1_11.Text).ToString("n")
                Me.txt_vlrMeta12.Text = (((Me.lbl_vlrHist1_12.Text * Me.txt_percMeta12.Text) / 100) + Me.lbl_vlrHist1_12.Text).ToString("n")
    ...
    Sub DefinirOpcaoSalvar()
        If Me.cboAno.CallAno = Year(DateAndTime.Now().AddYears(1)) Then
...
#Region " Salvar"
    ...
    Private Sub Salvar()
        Dim oVem As New VendaEmpresaMes
        'Salvar Subgrupo - Mes
        oVem.Salvar_Ori_Grupo_Mes(Me.cboPosicao.CallPosicao, Me.cboGrupo_Sub.CallGrupo, Me.cboAno.CallAno, 1, Me.cboFilial.CallFilial, Me.txt_vlrMeta01.Text, 100, User.Identity.Name, 0)
        oVem.Salvar_Ori_Grupo_Mes(Me.cboPosicao.CallPosicao, Me.cboGrupo_Sub.CallGrupo, Me.cboAno.CallAno, 2, Me.cboFilial.CallFilial, Me.txt_vlrMeta02.Text, 100, User.Identity.Name, 0)
        oVem.Salvar_Ori_Grupo_Mes(Me.cboPosicao.CallPosicao, Me.cboGrupo_Sub.CallGrupo, Me.cboAno.CallAno, 3, Me.cboFilial.CallFilial, Me.txt_vlrMeta03.Text, 100, User.Identity.Name, 0)
        oVem.Salvar_Ori_Grupo_Mes(Me.cboPosicao.CallPosicao, Me.cboGrupo_Sub.CallGrupo, Me.cboAno.CallAno, 4, Me.cboFilial.CallFilial, Me.txt_vlrMeta04.Text, 100, User.Identity.Name, 0)
        oVem.Salvar_Ori_Grupo_Mes(Me.cboPosicao.CallPosicao, Me.cboGrupo_Sub.CallGrupo, Me.cboAno.CallAno, 5, Me.cboFilial.CallFilial, Me.txt_vlrMeta05.Text, 100, User.Identity.Name, 0)
        oVem.Salvar_Ori_Grupo_Mes(Me.cboPosicao.CallPosicao, Me.cboGrupo_Sub.CallGrupo, Me.cboAno.CallAno, 6, Me.cboFilial.CallFilial, Me.txt_vlrMeta06.Text, 100, User.Identity.Name, 0)
        oVem.Salvar_Ori_Grupo_Mes(Me.cboPosicao.CallPosicao, Me.cboGrupo_Sub.CallGrupo, Me.cboAno.CallAno, 7, Me.cboFilial.CallFilial, Me.txt_vlrMeta07.Text, 100, User.Identity.Name, 0)
        oVem.Salvar_Ori_Grupo_Mes(Me.cboPosicao.CallPosicao, Me.cboGrupo_Sub.CallGrupo, Me.cboAno.CallAno, 8, Me.cboFilial.CallFilial, Me.txt_vlrMeta08.Text, 100, User.Identity.Name, 0)
        oVem.Salvar_Ori_Grupo_Mes(Me.cboPosicao.CallPosicao, Me.cboGrupo_Sub.CallGrupo, Me.cboAno.CallAno, 9, Me.cboFilial.CallFilial, Me.txt_vlrMeta09.Text, 100, User.Identity.Name, 0)
        oVem.Salvar_Ori_Grupo_Mes(Me.cboPosicao.CallPosicao, Me.cboGrupo_Sub.CallGrupo, Me.cboAno.CallAno, 10, Me.cboFilial.CallFilial, Me.txt_vlrMeta10.Text, 100, User.Identity.Name, 0)
        oVem.Salvar_Ori_Grupo_Mes(Me.cboPosicao.CallPosicao, Me.cboGrupo_Sub.CallGrupo, Me.cboAno.CallAno, 11, Me.cboFilial.CallFilial, Me.txt_vlrMeta11.Text, 100, User.Identity.Name, 0)
        oVem.Salvar_Ori_Grupo_Mes(Me.cboPosicao.CallPosicao, Me.cboGrupo_Sub.CallGrupo, Me.cboAno.CallAno, 12, Me.cboFilial.CallFilial, Me.txt_vlrMeta12.Text, 100, User.Identity.Name, 0)
        ...
        oVem.Salvar_Ori_Grupo_Ano(Me.cboPosicao.CallPosicao, Me.cboGrupo_Sub.CallGrupo, Me.cboAno.CallAno, Me.cboFilial.CallFilial, Me.lbl_vlrMetaTotal.Text, 100, User.Identity.Name, 0)
...
#Region " Links"
    ...
    Protected Sub link_DRE_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles link_DRE.Click
        Call Linkar("viewDRE_Loja.aspx", Me.lblCatCod.Text)
...
#Region " Page"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not IsPostBack Then
            ...
            Me.NewItem.Value = 1    'Traz lista de Vendas
            Call AdicionarItem()
            ...
            oVem.AtualizarEstatisticaPrograma(183, User.Identity.Name)
            ...
            Me.cboAno.AnoFinal = 2020

            If Month(Now()) > 9 Then
                Me.cboAno.CallAno = Year(Now()) + 2
            Else
            ...
            'Me.cboPosicao.CallPosicao = 3   'Definitivo

        End If
    End Sub

    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        CType(Master.FindControl("lblTitle"), Label).Text = "Orçamento " & Me.cboAno.CallAno & " - Venda Total - PGR183"
    End Sub

    Protected Sub Page_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
        If Not IsPostBack Then
            rnd_Subgrupo.Visible = False
            cboPosicao.CallPosicao = 6
            cboGrupo_Sub.CallGrupo = 1
            Me.txt_vlrMeta01.Focus()
        End If
...
#Region " Históricos"
    ...
    Sub Busca_Hist4(ByVal iMes As String)
        ...
        Dim comando As New SqlCommand("uspReaMesBuscaVenda", con)
        comando.CommandType = CommandType.StoredProcedure
...
#End Region
    ...
    Protected Sub cboGrupo_Sub_ListSubgrupoChanged(sender As Object, e As EventArgs) Handles cboGrupo_Sub.ListSubgrupoChanged
        Call Atualizar()
    ...
    Sub Busca_Rev(ByVal iMes As String)
        ...
        Dim comando As New SqlCommand("uspRevGrupoBuscaMes", con)
        comando.CommandType = CommandType.StoredProcedure

        If rnd_Grupo.Checked = True Then
            comando.Parameters.Add(New SqlParameter("@idCod", Data.SqlDbType.VarChar))
            comando.Parameters("@idCod").Value = 2  'Me.cboGrupo.SelectedValue
        Else
            comando.Parameters.Add(New SqlParameter("@idCod", Data.SqlDbType.VarChar))
            comando.Parameters("@idCod").Value = 1 ' Me.cboSubgrupo.SelectedValue
        End If
    ...
    Private Sub BuscarVendaAno()
        Session("VendaRealAA1") = oDW.BuscarVenda_AnoAtual(Session("IDFILIAL"))
        Session("VendaRealAA2") = oDW.BuscarVendaReal_AnoAnteriores(Me.cboAno.CallAno - 2, Session("IDFILIAL"))
    End Sub

#Region " Crescimento"

    Function CalcularCrescimento(ByVal vlrAtual As Decimal, ByVal vlrAnterior As Decimal) As Decimal
        Dim myPerc As Decimal
        If vlrAtual = 0 Then
            myPerc = 0
        ElseIf vlrAnterior = 0 Then
            myPerc = 0
        Else
            myPerc = (((vlrAtual / vlrAnterior) * 100) - 100)

        End If

        CalcularCrescimento = myPerc.ToString("n2")
    End Function

  

    Private Sub PreencherCrescimento_Historico()

        'Histórico 1
        Me.lbl_percHist3_1.Text = CalcularCrescimento(lbl_vlrHist3_1.Text, lbl_vlrHist4_1.Text)
        Me.lbl_percHist3_2.Text = CalcularCrescimento(lbl_vlrHist3_2.Text, lbl_vlrHist4_2.Text)
        Me.lbl_percHist3_3.Text = CalcularCrescimento(lbl_vlrHist3_3.Text, lbl_vlrHist4_3.Text)
        Me.lbl_percHist3_4.Text = CalcularCrescimento(lbl_vlrHist3_4.Text, lbl_vlrHist4_4.Text)
        Me.lbl_percHist3_5.Text = CalcularCrescimento(lbl_vlrHist3_5.Text, lbl_vlrHist4_5.Text)
        Me.lbl_percHist3_6.Text = CalcularCrescimento(lbl_vlrHist3_6.Text, lbl_vlrHist4_6.Text)
        Me.lbl_percHist3_7.Text = CalcularCrescimento(lbl_vlrHist3_7.Text, lbl_vlrHist4_7.Text)
        Me.lbl_percHist3_8.Text = CalcularCrescimento(lbl_vlrHist3_8.Text, lbl_vlrHist4_8.Text)
        Me.lbl_percHist3_9.Text = CalcularCrescimento(lbl_vlrHist3_9.Text, lbl_vlrHist4_9.Text)
        Me.lbl_percHist3_10.Text = CalcularCrescimento(lbl_vlrHist3_10.Text, lbl_vlrHist4_10.Text)
        Me.lbl_percHist3_11.Text = CalcularCrescimento(lbl_vlrHist3_11.Text, lbl_vlrHist4_11.Text)
        Me.lbl_percHist3_12.Text = CalcularCrescimento(lbl_vlrHist3_12.Text, lbl_vlrHist4_12.Text)
        'Me.lbl_percHist3_Total.Text = CalcularCrescimento(lbl_vlrHist3_Total.Text, lbl_vlrHist4_Total.Text)


        'Histórico 2
        Me.lbl_percHist2_1.Text = CalcularCrescimento(lbl_vlrHist2_1.Text, lbl_vlrHist3_1.Text)
        Me.lbl_percHist2_2.Text = CalcularCrescimento(lbl_vlrHist2_2.Text, lbl_vlrHist3_2.Text)
        Me.lbl_percHist2_3.Text = CalcularCrescimento(lbl_vlrHist2_3.Text, lbl_vlrHist3_3.Text)
        Me.lbl_percHist2_4.Text = CalcularCrescimento(lbl_vlrHist2_4.Text, lbl_vlrHist3_4.Text)
        Me.lbl_percHist2_5.Text = CalcularCrescimento(lbl_vlrHist2_5.Text, lbl_vlrHist3_5.Text)
        Me.lbl_percHist2_6.Text = CalcularCrescimento(lbl_vlrHist2_6.Text, lbl_vlrHist3_6.Text)
        Me.lbl_percHist2_7.Text = CalcularCrescimento(lbl_vlrHist2_7.Text, lbl_vlrHist3_7.Text)
        Me.lbl_percHist2_8.Text = CalcularCrescimento(lbl_vlrHist2_8.Text, lbl_vlrHist3_8.Text)
        Me.lbl_percHist2_9.Text = CalcularCrescimento(lbl_vlrHist2_9.Text, lbl_vlrHist3_9.Text)
        Me.lbl_percHist2_10.Text = CalcularCrescimento(lbl_vlrHist2_10.Text, lbl_vlrHist3_10.Text)
        Me.lbl_percHist2_11.Text = CalcularCrescimento(lbl_vlrHist2_11.Text, lbl_vlrHist3_11.Text)
        Me.lbl_percHist2_12.Text = CalcularCrescimento(lbl_vlrHist2_12.Text, lbl_vlrHist3_12.Text)
        'Me.lbl_percHist2_Total.Text = CalcularCrescimento(lbl_vlrHist2_Total.Text, lbl_vlrHist3_Total.Text)


        'Histórico 3
        Me.lbl_percHist1_1.Text = CalcularCrescimento(lbl_vlrHist1_1.Text, lbl_vlrHist2_1.Text)
        Me.lbl_percHist1_2.Text = CalcularCrescimento(lbl_vlrHist1_2.Text, lbl_vlrHist2_2.Text)
        Me.lbl_percHist1_3.Text = CalcularCrescimento(lbl_vlrHist1_3.Text, lbl_vlrHist2_3.Text)
        Me.lbl_percHist1_4.Text = CalcularCrescimento(lbl_vlrHist1_4.Text, lbl_vlrHist2_4.Text)
        Me.lbl_percHist1_5.Text = CalcularCrescimento(lbl_vlrHist1_5.Text, lbl_vlrHist2_5.Text)
        Me.lbl_percHist1_6.Text = CalcularCrescimento(lbl_vlrHist1_6.Text, lbl_vlrHist2_6.Text)
        Me.lbl_percHist1_7.Text = CalcularCrescimento(lbl_vlrHist1_7.Text, lbl_vlrHist2_7.Text)
        Me.lbl_percHist1_8.Text = CalcularCrescimento(lbl_vlrHist1_8.Text, lbl_vlrHist2_8.Text)
        Me.lbl_percHist1_9.Text = CalcularCrescimento(lbl_vlrHist1_9.Text, lbl_vlrHist2_9.Text)
        Me.lbl_percHist1_10.Text = CalcularCrescimento(lbl_vlrHist1_10.Text, lbl_vlrHist2_10.Text)
        Me.lbl_percHist1_11.Text = CalcularCrescimento(lbl_vlrHist1_11.Text, lbl_vlrHist2_11.Text)
        Me.lbl_percHist1_12.Text = CalcularCrescimento(lbl_vlrHist1_12.Text, lbl_vlrHist2_12.Text)
        ' Me.lbl_percHist1_Total.Text = CalcularCrescimento(lbl_vlrHist1_Total.Text, lbl_vlrHist2_Total.Text)

    End Sub

    Private Sub PreencherCrescimento_Meta()
...
#Region " Formatação de Cores"

    Private Sub FormatarNegativo_Texto(ByVal txtNumero As TextBox)
        If CSng(txtNumero.Text) < 0.0 Then
            txtNumero.ForeColor = Drawing.Color.Red
        Else
            txtNumero.ForeColor = Drawing.Color.Black
        End If
    End Sub

    Private Sub FormatarNegativo_Label(ByVal txtNumero As Label)
        If CSng(txtNumero.Text) < 0.0 Then
            txtNumero.ForeColor = Drawing.Color.Red
        Else
            txtNumero.ForeColor = Drawing.Color.Black
    ...
    Sub MudarNegativoParaVermelho()
        On Error Resume Next
        'Ano - 1 - Valor
        Call FormatarNegativo_Label(Me.lbl_vlrHist1_1)
        Call FormatarNegativo_Label(Me.lbl_vlrHist1_2)
        Call FormatarNegativo_Label(Me.lbl_vlrHist1_3)
        Call FormatarNegativo_Label(Me.lbl_vlrHist1_4)
        Call FormatarNegativo_Label(Me.lbl_vlrHist1_5)
        Call FormatarNegativo_Label(Me.lbl_vlrHist1_6)
        Call FormatarNegativo_Label(Me.lbl_vlrHist1_7)
        Call FormatarNegativo_Label(Me.lbl_vlrHist1_8)
        Call FormatarNegativo_Label(Me.lbl_vlrHist1_9)
        Call FormatarNegativo_Label(Me.lbl_vlrHist1_10)
        Call FormatarNegativo_Label(Me.lbl_vlrHist1_11)
        Call FormatarNegativo_Label(Me.lbl_vlrHist1_12)
        Call FormatarNegativo_Label(Me.lbl_vlrHist1_Total)

        'Ano - 2 - Valor
        Call FormatarNegativo_Label(Me.lbl_vlrHist2_1)
        Call FormatarNegativo_Label(Me.lbl_vlrHist2_2)
        Call FormatarNegativo_Label(Me.lbl_vlrHist2_3)
        Call FormatarNegativo_Label(Me.lbl_vlrHist2_4)
        Call FormatarNegativo_Label(Me.lbl_vlrHist2_5)
        Call FormatarNegativo_Label(Me.lbl_vlrHist2_6)
        Call FormatarNegativo_Label(Me.lbl_vlrHist2_7)
        Call FormatarNegativo_Label(Me.lbl_vlrHist2_8)
        Call FormatarNegativo_Label(Me.lbl_vlrHist2_9)
        Call FormatarNegativo_Label(Me.lbl_vlrHist2_10)
        Call FormatarNegativo_Label(Me.lbl_vlrHist2_11)
        Call FormatarNegativo_Label(Me.lbl_vlrHist2_12)
        Call FormatarNegativo_Label(Me.lbl_vlrHist2_Total)

        'Ano - 3 - Valor
        Call FormatarNegativo_Label(Me.lbl_vlrHist3_1)
        Call FormatarNegativo_Label(Me.lbl_vlrHist3_2)
        Call FormatarNegativo_Label(Me.lbl_vlrHist3_3)
        Call FormatarNegativo_Label(Me.lbl_vlrHist3_4)
        Call FormatarNegativo_Label(Me.lbl_vlrHist3_5)
        Call FormatarNegativo_Label(Me.lbl_vlrHist3_6)
        Call FormatarNegativo_Label(Me.lbl_vlrHist3_7)
        Call FormatarNegativo_Label(Me.lbl_vlrHist3_8)
        Call FormatarNegativo_Label(Me.lbl_vlrHist3_9)
        Call FormatarNegativo_Label(Me.lbl_vlrHist3_10)
        Call FormatarNegativo_Label(Me.lbl_vlrHist3_11)
        Call FormatarNegativo_Label(Me.lbl_vlrHist3_12)
        Call FormatarNegativo_Label(Me.lbl_vlrHist3_Total)

        'Ano - 4 - Valor
        Call FormatarNegativo_Label(Me.lbl_vlrHist4_1)
        Call FormatarNegativo_Label(Me.lbl_vlrHist4_2)
        Call FormatarNegativo_Label(Me.lbl_vlrHist4_3)
        Call FormatarNegativo_Label(Me.lbl_vlrHist4_4)
        Call FormatarNegativo_Label(Me.lbl_vlrHist4_5)
        Call FormatarNegativo_Label(Me.lbl_vlrHist4_6)
        Call FormatarNegativo_Label(Me.lbl_vlrHist4_7)
        Call FormatarNegativo_Label(Me.lbl_vlrHist4_8)
        Call FormatarNegativo_Label(Me.lbl_vlrHist4_9)
        Call FormatarNegativo_Label(Me.lbl_vlrHist4_10)
        Call FormatarNegativo_Label(Me.lbl_vlrHist4_11)
        Call FormatarNegativo_Label(Me.lbl_vlrHist4_12)
        Call FormatarNegativo_Label(Me.lbl_vlrHist4_Total)

        'Percentual
        Call FormatarNegativo_Label(Me.lbl_percHist1_1)
        Call FormatarNegativo_Label(Me.lbl_percHist1_2)
        Call FormatarNegativo_Label(Me.lbl_percHist1_3)
        Call FormatarNegativo_Label(Me.lbl_percHist1_4)
        Call FormatarNegativo_Label(Me.lbl_percHist1_5)
        Call FormatarNegativo_Label(Me.lbl_percHist1_6)
        Call FormatarNegativo_Label(Me.lbl_percHist1_7)
        Call FormatarNegativo_Label(Me.lbl_percHist1_8)
        Call FormatarNegativo_Label(Me.lbl_percHist1_9)
        Call FormatarNegativo_Label(Me.lbl_percHist1_10)
        Call FormatarNegativo_Label(Me.lbl_percHist1_11)
        Call FormatarNegativo_Label(Me.lbl_percHist1_12)
        Call FormatarNegativo_Label(Me.lbl_percHist1_Total)

        Call FormatarNegativo_Label(Me.lbl_percHist2_1)
        Call FormatarNegativo_Label(Me.lbl_percHist2_2)
        Call FormatarNegativo_Label(Me.lbl_percHist2_3)
        Call FormatarNegativo_Label(Me.lbl_percHist2_4)
        Call FormatarNegativo_Label(Me.lbl_percHist2_5)
        Call FormatarNegativo_Label(Me.lbl_percHist2_6)
        Call FormatarNegativo_Label(Me.lbl_percHist2_7)
        Call FormatarNegativo_Label(Me.lbl_percHist2_8)
        Call FormatarNegativo_Label(Me.lbl_percHist2_9)
        Call FormatarNegativo_Label(Me.lbl_percHist2_10)
        Call FormatarNegativo_Label(Me.lbl_percHist2_11)
        Call FormatarNegativo_Label(Me.lbl_percHist2_12)
        Call FormatarNegativo_Label(Me.lbl_percHist2_Total)

        Call FormatarNegativo_Label(Me.lbl_percHist3_1)
        Call FormatarNegativo_Label(Me.lbl_percHist3_2)
        Call FormatarNegativo_Label(Me.lbl_percHist3_3)
        Call FormatarNegativo_Label(Me.lbl_percHist3_4)
        Call FormatarNegativo_Label(Me.lbl_percHist3_5)
        Call FormatarNegativo_Label(Me.lbl_percHist3_6)
        Call FormatarNegativo_Label(Me.lbl_percHist3_7)
        Call FormatarNegativo_Label(Me.lbl_percHist3_8)
        Call FormatarNegativo_Label(Me.lbl_percHist3_9)
        Call FormatarNegativo_Label(Me.lbl_percHist3_10)
        Call FormatarNegativo_Label(Me.lbl_percHist3_11)
        Call FormatarNegativo_Label(Me.lbl_percHist3_12)
        Call FormatarNegativo_Label(Me.lbl_percHist3_Total)
        ...
        Call FormatarNegativo_Texto(Me.txt_percMeta11)
        Call FormatarNegativo_Texto(Me.txt_percMeta12)
        Call FormatarNegativo_Label(Me.lbl_percMetaTotal)
...
#End Region
    ...
    Private Sub Preencher_ValorMeta(ByVal txtValorMeta As TextBox, txtPercMetaFocus As TextBox, ByVal txtValor As Label, ByVal txtPercentual As TextBox)
        txtValorMeta.Text = CalcularMetaComBaseNoPercentual(txtValor, txtPercentual).ToString("n0")
        Call Totalizar()
        txtPercMetaFocus.Focus()
    End Sub

    Function CalcularMetaComBaseNoPercentual(ByVal txtValor As Label, ByVal txtPercentual As TextBox) As Decimal
        Dim vlr As Decimal
        If IsNothing(txtValor.Text) Then
            vlr = 0
        ElseIf IsNothing(txtPercentual.Text) Then
            vlr = 0
        Else
            vlr = ((txtValor.Text * txtPercentual.Text) / 100) + txtValor.Text
        End If
        Return vlr
    End Function

#Region " Calcular Percentual da Meta"

    Protected Sub txt_percMeta01_TextChanged(sender As Object, e As EventArgs) Handles txt_percMeta01.TextChanged
        Call Preencher_ValorMeta(Me.txt_vlrMeta01, Me.txt_percMeta02, Me.lbl_vlrHist1_1, Me.txt_percMeta01)
    End Sub

    Protected Sub txt_percMeta02_TextChanged(sender As Object, e As EventArgs) Handles txt_percMeta02.TextChanged
        Call Preencher_ValorMeta(Me.txt_vlrMeta02, Me.txt_percMeta03, Me.lbl_vlrHist1_2, Me.txt_percMeta02)
    End Sub

    Protected Sub txt_percMeta03_TextChanged(sender As Object, e As EventArgs) Handles txt_percMeta03.TextChanged
        Call Preencher_ValorMeta(Me.txt_vlrMeta03, Me.txt_percMeta04, Me.lbl_vlrHist1_3, Me.txt_percMeta03)
    End Sub

    Protected Sub txt_percMeta04_TextChanged(sender As Object, e As EventArgs) Handles txt_percMeta04.TextChanged
        Call Preencher_ValorMeta(Me.txt_vlrMeta04, Me.txt_percMeta05, Me.lbl_vlrHist1_4, Me.txt_percMeta04)
    End Sub

    Protected Sub txt_percMeta05_TextChanged(sender As Object, e As EventArgs) Handles txt_percMeta05.TextChanged
        Call Preencher_ValorMeta(Me.txt_vlrMeta05, Me.txt_percMeta06, Me.lbl_vlrHist1_5, Me.txt_percMeta05)
    End Sub

    Protected Sub txt_percMeta06_TextChanged(sender As Object, e As EventArgs) Handles txt_percMeta06.TextChanged
        Call Preencher_ValorMeta(Me.txt_vlrMeta06, Me.txt_percMeta07, Me.lbl_vlrHist1_6, Me.txt_percMeta06)
    End Sub

    Protected Sub txt_percMeta07_TextChanged(sender As Object, e As EventArgs) Handles txt_percMeta07.TextChanged
        Call Preencher_ValorMeta(Me.txt_vlrMeta07, Me.txt_percMeta08, Me.lbl_vlrHist1_7, Me.txt_percMeta07)
    End Sub

    Protected Sub txt_percMeta08_TextChanged(sender As Object, e As EventArgs) Handles txt_percMeta08.TextChanged
        Call Preencher_ValorMeta(Me.txt_vlrMeta08, Me.txt_percMeta09, Me.lbl_vlrHist1_8, Me.txt_percMeta08)
    End Sub

    Protected Sub txt_percMeta09_TextChanged(sender As Object, e As EventArgs) Handles txt_percMeta09.TextChanged
        Call Preencher_ValorMeta(Me.txt_vlrMeta09, Me.txt_percMeta10, Me.lbl_vlrHist1_9, Me.txt_percMeta09)
    End Sub

    Protected Sub txt_percMeta10_TextChanged(sender As Object, e As EventArgs) Handles txt_percMeta10.TextChanged
        Call Preencher_ValorMeta(Me.txt_vlrMeta10, Me.txt_percMeta11, Me.lbl_vlrHist1_10, Me.txt_percMeta10)
    End Sub

    Protected Sub txt_percMeta11_TextChanged(sender As Object, e As EventArgs) Handles txt_percMeta11.TextChanged
        Call Preencher_ValorMeta(Me.txt_vlrMeta11, Me.txt_percMeta12, Me.lbl_vlrHist1_11, Me.txt_percMeta10)
    End Sub

    Protected Sub txt_percMeta12_TextChanged(sender As Object, e As EventArgs) Handles txt_percMeta12.TextChanged
        Call Preencher_ValorMeta(Me.txt_vlrMeta12, Me.txt_percMeta11, Me.lbl_vlrHist1_12, Me.txt_percMeta10)
    End Sub
