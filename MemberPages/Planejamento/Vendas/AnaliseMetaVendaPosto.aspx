<%@ Page Title="Analise de Meta de Vendas dos Postos" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="AnaliseMetaVendaPosto.aspx.vb" Inherits="MemberPages_Planejamento_Vendas_AnaliseMetaVendaPosto" %>
        ...
        <div id="divDados">
            ...
            <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="100%" KeyFieldName="nomeFilial">
                ...
                <Columns>
                    ...
                    <dx:GridViewBandColumn Caption="Metas" VisibleIndex="5">
                        <Columns>
                            <%--Loja--%>
                            ...
                            <dx:GridViewDataTextColumn Caption="% Cresc" FieldName="pC_MCs1" ReadOnly="True" VisibleIndex="3" Width="60px">
                                <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                </PropertiesTextEdit>
                                <CellStyle>
                                    <BorderRight BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" />
                            ...
                            <dx:GridViewDataTextColumn Caption="Controladoria" FieldName="vlrMetaEstatistica" ReadOnly="True" VisibleIndex="4" Width="100px">
                                <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                </PropertiesTextEdit>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="% Cresc" FieldName="pC_MEs1" VisibleIndex="5" Width="60px">
                                <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                </PropertiesTextEdit>
                                <CellStyle>
                                    <BorderRight BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" />
                            ...
                            <%--Gilberto--%>
                            <dx:GridViewDataTextColumn Caption="Gilberto" FieldName="vlrMetaGilberto" VisibleIndex="6" Width="100px">
                                <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                </PropertiesTextEdit>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="% Cresc" FieldName="pC_MGs1" ReadOnly="True" VisibleIndex="7" Width="60px">
                                <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                </PropertiesTextEdit>
                                <CellStyle>
                                    <BorderRight BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" />
                            ...
                            <%--Definitiva--%>
                            <dx:GridViewDataTextColumn Caption="Definitiva" FieldName="vlrMetaDefinitiva" VisibleIndex="8" Width="100px">
                                <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                </PropertiesTextEdit>
                                <CellStyle ForeColor="#009900">
                                </CellStyle>
                            ...
                            <dx:GridViewDataTextColumn Caption="Diferença" FieldName="Diferenca" VisibleIndex="9" Width="80px">
                                <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                </PropertiesTextEdit>
                            </dx:GridViewDataTextColumn>
                            ...
                            <dx:GridViewDataTextColumn Caption="% Cresc" FieldName="pC_MDs1" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="10" Width="60px">
                                <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                </PropertiesTextEdit>
                            </dx:GridViewDataTextColumn>
