...
Partial Class MemberPages_Planejamento_Vendas_frmCadVendaSecao
    ...
    Sub BuscaVendaReal_Hist1(ByVal iFilial As Int16, ByVal iStatus As Byte)
    ...
    Private Sub Preencher_Hist1_Meta_Mes(ByVal iFilial As String, ByVal iSecao As String, ByVal iAno As Int32, ByVal iMes As String, iVlr As Label, iPerc As Label)
        ...
        iVlr.Text = oVem.vlrRev.ToString("n0")
        iPerc.Text = oVem.percRev.ToString("n2")
    End Sub 'Codigo REVISTO

    Private Sub Preencher_Hist1_Mes(ByVal iAno As Int32, ByVal iMes As Byte, ByVal iFilial As Int16, ByVal iSecao As Int32, ByVal iStatus As Byte, ByVal iVlr As Label, ByVal iPerc As Label)
    ...
    Private Sub BuscaMetaDet(ByVal iAno As Int32, ByVal iMes As Byte, ByVal iFilial As Int16, ByVal iSecao As Byte, ByVal iPosicao As Byte, ByVal iTipoSecao As Byte, ByVal iVlr As TextBox)
        oVem.BuscaSecao_VendaMargem_Ori(iAno, iMes, iFilial, iSecao, iPosicao, iTipoSecao)
        iVlr.Text = oVem.vlrOri
    End Sub 'Codigo REVISTO

    Private Sub BuscaMeta(ByVal iAno As Int32, ByVal iFilial As Int16, ByVal iSecao As Byte, ByVal iPosicao As Byte, ByVal iTipoSecao As Byte)
    ...
    Sub Atualizar()
        ...
        Dim vPosicao As String
        vPosicao = cboPosicao.CallPosicao
    ...
    '        Me.cboAno.AnoInicial = Year(DateAndTime.Now) - 1
    ...
    '        If oOrc.DefinirPosicao(cboAno.CallAno, 1) = True Then cboPosicao.CallPosicao = 1
