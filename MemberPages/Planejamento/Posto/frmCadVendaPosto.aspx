<%@ Page Title="Cadastro de Metas de Venda - Orçamento" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="frmCadVendaPosto.aspx.vb" Inherits="MemberPages_Planejamento_Vendas_frmCadVendaPosto" Culture="pt-BR" uiCulture="pt-BR" %>
            ...
            <dx:ASPxCallbackPanel ID="cbPanelDados" runat="server" Width="1200px" ClientInstanceName="cbPanelDados">
                <PanelCollection>
                    ...
                    <table class="style9">
                        ...
                        <tr>
                            <td class="auto-style37">001-Seca Pesada</td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA3_001" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist3_01" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA2_001" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist2_01" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA1_001" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist1_01" runat="server" Text="?"></asp:Label></td>                            
                               <%--Espaçamento--%><td class="Divisoria"></td>
                            <td class="auto-style18"><asp:TextBox ID="txt_vlrMeta_001" Text="?" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_B" ForeColor="#336600"></asp:TextBox></td>
                        ...
                        <tr>
                            <td class="auto-style38">002-Seca Salgada</td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA3_002" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist3_02" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA2_002" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist2_02" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA1_002" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist1_02" runat="server" Text="?"></asp:Label></td>                            
                               <%--Espaçamento--%><td class="Divisoria"></td>
                            <td class="auto-style19"><asp:TextBox ID="txt_vlrMeta_002" Text="?" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_V" ForeColor="#336600" ></asp:TextBox></td>
                        ...
                        <tr>
                             <td class="auto-style32">003-Seca Doce</td>
                            <td class="auto-style33" ><asp:Label ID="lbl_vlrHist_Secao_003" runat="server" Text="?"></asp:Label></td>
                            <td class="auto-style33" ><asp:Label ID="txt_percHist3_03" runat="server" Text="?"></asp:Label></td>
                            <td class="auto-style33" ><asp:Label ID="lbl_vlrHist_AA2_003" runat="server" Text="?"></asp:Label></td>
                            <td class="auto-style33" ><asp:Label ID="txt_percHist2_03" runat="server" Text="?"></asp:Label></td>
                            <td class="auto-style33" ><asp:Label ID="lbl_vlrHist_AA1_003" runat="server" Text="?"></asp:Label></td>
                            <td class="auto-style33" ><asp:Label ID="txt_percHist1_03" runat="server" Text="?"></asp:Label></td>                            
                               <%--Espaçamento--%><td class="auto-style34"></td>
                            <td class="auto-style35"><asp:TextBox ID="txt_vlrMeta_003" Text="?" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_B" ForeColor="#336600"></asp:TextBox></td>
                            <td class="auto-style36"><asp:TextBox ID="txt_percCresc03" Text="?" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Perc_B" ForeColor="#336600"></asp:TextBox></td>               
                               <%--Espaçamento--%><td class="auto-style34"></td>
                               <%--Espaçamento--%>
                            <td class="auto-style33"><asp:Label ID="lblCresc03_M3" Text="?" runat="server" CssClass="TB_Perc_B"></asp:Label></td>
                            <td class="auto-style33"><asp:Label ID="lblCresc03_M2" Text="?" runat="server" CssClass="TB_Perc_B"></asp:Label></td>
                            <td class="auto-style33"><asp:Label ID="lblCresc03_M1" Text="?" runat="server" CssClass="TB_Perc_B"></asp:Label></td>
                        </tr> <%--Mes 03--%><%--******************** A B R I L *************************************************************************--%>        
                        <tr>
                            <td class="auto-style38">004-Seca Leve</td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA3_004" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist3_04" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA2_004" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist2_04" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA1_004" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist1_04" runat="server" Text="?"></asp:Label></td>                            
                               <%--Espaçamento--%><td class="Divisoria"></td>
                            <td class="auto-style19"><asp:TextBox ID="txt_vlrMeta_004" Text="?" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_V" ForeColor="#336600"></asp:TextBox></td>
                        ...
                        <tr>
                            <td class="auto-style37">005-Limpeza</td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA3_005" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist3_05" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA2_005" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist2_05" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA1_005" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist1_05" runat="server" Text="?"></asp:Label></td>                            
                               <%--Espaçamento--%><td class="Divisoria"></td>
                            <td class="auto-style18"><asp:TextBox ID="txt_vlrMeta_005" Text="?" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_B" ForeColor="#336600"></asp:TextBox></td>
                        ...
                        <tr>
                            <td class="auto-style38">006-Perfumaria &amp; Higiene</td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA3_006" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist3_06" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA2_006" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist2_06" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA1_006" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist1_06" runat="server" Text="?"></asp:Label></td>                            
                               <%--Espaçamento--%><td class="Divisoria"></td>
                            <td class="auto-style19"><asp:TextBox ID="txt_vlrMeta_006" Text="?" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_V" ForeColor="#336600"></asp:TextBox></td>
                        ...
                        <tr>
                            <td class="auto-style37">007-Bebidas Quentes</td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA3_007" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist3_07" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA2_007" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist2_07" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA1_007" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist1_07" runat="server" Text="?"></asp:Label></td>                            
                               <%--Espaçamento--%><td class="Divisoria"></td>
                            <td class="auto-style18"><asp:TextBox ID="txt_vlrMeta_007" Text="?" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_B" ForeColor="#336600"></asp:TextBox></td>
                        ...
                        <tr>
                            <td class="auto-style38">008-Bebidas Frias</td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA3_008" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist3_08" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA2_008" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist2_08" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA1_008" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist1_08" runat="server" Text="?"></asp:Label></td>                            
                               <%--Espaçamento--%><td class="Divisoria"></td>
                            <td class="auto-style19"><asp:TextBox ID="txt_vlrMeta_008" Text="?" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_V" ForeColor="#336600"></asp:TextBox></td>
                        ...
                        <tr>
                            <td class="auto-style37"><strong>595-Alcool Aditivado Shell Etilico</strong></td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA3_595" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist3_09" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA2_595" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist2_09" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA1_595" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist1_09" runat="server" Text="?"></asp:Label></td>                            
                               <%--Espaçamento--%><td class="Divisoria"></td>
                            <td class="auto-style18"><asp:TextBox ID="txt_vlrMeta_595" Text="?" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_B" ForeColor="#336600"></asp:TextBox></td>
                        ...
                        <tr>
                            <td class="auto-style38"><strong>405-Alcool Etilico HD</strong></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA3_405" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist3_10" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA2_405" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist2_10" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA1_405" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist1_10" runat="server" Text="?"></asp:Label></td>                            
                               <%--Espaçamento--%><td class="Divisoria"></td>
                            <td class="auto-style19"><asp:TextBox ID="txt_vlrMeta_405" Text="?" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_V" ForeColor="#336600"></asp:TextBox></td>
                        ...
                        <tr>
                            <td class="auto-style37"><strong>587-Diesel B S10 Comum Shell</strong></td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA3_587" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist3_11" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA2_587" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist2_11" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="lbl_vlrHist_AA1_587" runat="server" Text="?"></asp:Label></td>
                            <td class="style37" ><asp:Label ID="txt_percHist1_11" runat="server" Text="?"></asp:Label></td>                            
                               <%--Espaçamento--%><td class="Divisoria"></td>
                            <td class="auto-style18"><asp:TextBox ID="txt_vlrMeta_587" Text="?" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_B" ForeColor="#336600"></asp:TextBox></td>
                        ...
                        <tr> 
                            <td class="auto-style38"><strong>454-Diesel B S500 Shell</strong></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA3_454" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist3_12" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA2_454" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist2_12" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="lbl_vlrHist_AA1_454" runat="server" Text="?"></asp:Label></td>
                            <td class="Padrao_V" ><asp:Label ID="txt_percHist1_12" runat="server" Text="?"></asp:Label></td>                            
                               <%--Espaçamento--%><td class="Divisoria"></td>
                            <td class="auto-style19"><asp:TextBox ID="txt_vlrMeta_454" Text="?" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_V" ForeColor="#336600"></asp:TextBox></td>
                        ...
                        <tr>
                            <td class="auto-style37"><strong>298-Gasolina Tipo C Shell</strong></td>
                            <td class="style37">
                                <asp:Label ID="lbl_vlrHist_AA3_298" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="style37"">&nbsp;</td>
                            <td class="style37"">
                                <asp:Label ID="lbl_vlrHist_AA2_298" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="style37"">&nbsp;</td>
                            <td class="style37"">
                                <asp:Label ID="lbl_vlrHist_AA1_298" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="auto-style19">
                                <asp:TextBox ID="txt_vlrMeta_298" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_B" ForeColor="#336600" Text="?"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            <td class="auto-style38"><strong>306-Gasolina V-Power Aditivada</strong></td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA3_306" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA2_306" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA1_306" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="auto-style19">
                                <asp:TextBox ID="txt_vlrMeta_306" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_V" ForeColor="#336600" Text="?"></asp:TextBox>
                            </td>
                            <td class="auto-style16">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="Padrao_V">&nbsp;</td>
                        ...
                        <tr>
                            <td class="auto-style37">011-Leite</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA3_011" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA2_011" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA1_011" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="auto-style19">
                                <asp:TextBox ID="txt_vlrMeta_011" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_B" ForeColor="#336600" Text="?"></asp:TextBox>
                            </td>
                            <td class="auto-style16">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="Padrao_V">&nbsp;</td>
                        ...
                        <tr>
                            <td class="auto-style38">016-Congelados</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA3_016" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA2_016" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA1_016" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="auto-style19">
                                <asp:TextBox ID="txt_vlrMeta_016" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_V" ForeColor="#336600" Text="?"></asp:TextBox>
                            </td>
                            <td class="auto-style16">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="Padrao_V">&nbsp;</td>
                        ...
                        <tr>
                            <td class="auto-style37">019-Pães e Bolos Industrializados</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA3_019" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA2_019" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA1_019" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="auto-style19">
                                <asp:TextBox ID="txt_vlrMeta_019" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_B" ForeColor="#336600" Text="?"></asp:TextBox>
                            </td>
                            <td class="auto-style16">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="Padrao_V">&nbsp;</td>
                        ...
                        <tr>
                            <td class="auto-style38">030-Ferragens &amp; Ferramentas</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA3_030" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA2_030" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA1_030" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="auto-style19">
                                <asp:TextBox ID="txt_vlrMeta_030" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_V" ForeColor="#336600" Text="?"></asp:TextBox>
                            </td>
                            <td class="auto-style16">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="Padrao_V">&nbsp;</td>
                        ...
                        <tr>
                            <td class="auto-style37">031-Papelaria / Viagem /Livros </td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA3_031" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA2_031" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA1_031" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="auto-style19">
                                <asp:TextBox ID="txt_vlrMeta_031" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_B" ForeColor="#336600" Text="?"></asp:TextBox>
                            </td>
                            <td class="auto-style16">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="Padrao_V">&nbsp;</td>
                        ...
                        <tr>
                            <td class="auto-style38">032-Casas e Utilidades</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA3_032" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA2_032" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA1_032" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="auto-style19">
                                <asp:TextBox ID="txt_vlrMeta_032" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_V" ForeColor="#336600" Text="?"></asp:TextBox>
                            </td>
                            <td class="auto-style16">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="Padrao_V">&nbsp;</td>
                        ...
                        <tr>
                            <td class="auto-style37">033-Brinquedos &amp; Lazer</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA3_033" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA2_033" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA1_033" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="auto-style19">
                                <asp:TextBox ID="txt_vlrMeta_033" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_B" ForeColor="#336600" Text="?"></asp:TextBox>
                            </td>
                            <td class="auto-style16">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="Padrao_V">&nbsp;</td>
                        ...
                        <tr>
                            <td class="auto-style38">052-Telefonia</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA3_052" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA2_052" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Padrao_V">
                                <asp:Label ID="lbl_vlrHist_AA1_052" runat="server" Text="?"></asp:Label>
                            </td>
                            <td class="Padrao_V">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="auto-style19">
                                <asp:TextBox ID="txt_vlrMeta_052" runat="server" AutoPostBack="True" BorderStyle="None" CssClass="TB_Vlr_V" ForeColor="#336600" Text="?"></asp:TextBox>
                            </td>
                            <td class="auto-style16">&nbsp;</td>
                            <td class="Divisoria">&nbsp;</td>
                            <td class="Padrao_V">&nbsp;</td>
