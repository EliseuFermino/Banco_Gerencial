...
Partial Class MemberPages_Planejamento_Margem_frmCadMargemSecao
...
#Region " Page"
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Orçamento " & Me.cboAno.CallAno & " - Margem por Seção - PGR49"
        End If
    End Sub
    ...
    Protected Sub Page_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
        If Not IsPostBack Then
            ...
            End If
            Me.cboPosicao.CallPosicao = oOrc.Status_Da_Posicao(vAno_Orcamento, 5, vDepartamento)
        End If
    End Sub
...
#End Region
    ...
    Protected Sub cbPanelDados_Callback(sender As Object, e As CallbackEventArgsBase) Handles cbPanelDados.Callback
        Call Atualizar()
    End Sub
End Class
