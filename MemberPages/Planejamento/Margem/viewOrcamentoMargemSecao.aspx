<%@ Page Title="Relatório de Vendas por Seção" Language="VB" MasterPageFile="~/MemberPages/SiteOrcamento.master" AutoEventWireup="false" CodeFile="viewOrcamentoMargemSecao.aspx.vb" Inherits="MemberPages_Planejamento_Vendas_viewOrcamentoMargemSecao" %>
                    ...
                    <Columns>
                        <dxwgv:GridViewBandColumn Caption="Ano 3" VisibleIndex="2" Name="Grupo_Ano3" 
                            ...
                            <Columns>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="%" FieldName="percA3" ReadOnly="True" 
                                    VisibleIndex="1" ShowInCustomizationForm="True" Width="50px" 
                                    ToolTip="Percentual de margem">
                        ...
                        <dxwgv:GridViewBandColumn Caption="Ano 2" VisibleIndex="3" Name="Grupo_Ano2" 
                            ...
                            <Columns>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="%" FieldName="percA2" ReadOnly="True" 
                                    VisibleIndex="1" ShowInCustomizationForm="True" Width="50px" 
                                    ToolTip="Percentual de margem">
                                    <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                    </PropertiesTextEdit>
                        ...
                        <dxwgv:GridViewBandColumn Caption="Ano 1" VisibleIndex="4" Name="Grupo_Ano1" 
                            ...
                            <Columns>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="%" FieldName="percA1" ReadOnly="True" 
                                    VisibleIndex="1" ShowInCustomizationForm="True" Width="50px" 
                                    ToolTip="Percentual de margem">
                                    <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                    </PropertiesTextEdit>
                        ...
                        <dxwgv:GridViewBandColumn Caption="Meta" VisibleIndex="5" Name="Grupo_Meta" 
                            ...
                            <Columns>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="%" FieldName="perc" ReadOnly="True" 
                                    VisibleIndex="1" ShowInCustomizationForm="True" Width="50px" 
                                    ToolTip="Percentual de margem">
                                    <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                    </PropertiesTextEdit>
