<%@ Page Title="Cadastro de Metas - Margens por Seção" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="frmCadMargemSecao.aspx.vb" Inherits="MemberPages_Planejamento_Margem_frmCadMargemSecao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div id="moldura">
        ...
        <div id="divSecao">
         ...
         <div id="divBotaoAtualizar">
            <dx:ASPxButton ID="btnAtualizar" runat="server" Text="Atualizar" AutoPostBack="False" Theme="Metropolis">
                <ClientSideEvents Click="function(s, e) {cbPanelDados.PerformCallback();}" />
            </dx:ASPxButton>
        </div>
        ...
        <div id="divHistorico">
            <dx:ASPxGridView ID="gridHistorico" runat="server" DataSourceID="dsHistorico" AutoGenerateColumns="False" Width="1000px">
                <TotalSummary>
