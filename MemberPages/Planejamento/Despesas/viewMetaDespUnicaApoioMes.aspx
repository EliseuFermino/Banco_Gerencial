<%@ Page Language="VB" AutoEventWireup="false" CodeFile="viewMetaDespUnicaApoioMes.aspx.vb" Inherits="MemberPages_Planejamento_Despesas_viewMetaDespUnicaLojaMes" %>
...
<body>
    ...
    <div>
        ...
        <dxe:ASPxButton ID="ASPxButton1" runat="server" 
            ...
            Text="Exportar para excel" Width="151px" Theme="DevEx">
        </dxe:ASPxButton>
                </td>
                <td>
                    &nbsp;</td>
            ...
            <tr>
                <td >
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="uspViewMetaDespesaOriginaisApoio" 
                        SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:SessionParameter DefaultValue="" Name="Ano" SessionField="sAno" Type="Int16" />
                            <asp:SessionParameter DefaultValue="" Name="Mes" SessionField="sMes" Type="Byte" />
