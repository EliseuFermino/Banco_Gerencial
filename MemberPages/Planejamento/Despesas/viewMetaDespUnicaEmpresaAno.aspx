<%@ Page Language="VB" AutoEventWireup="false" CodeFile="viewMetaDespUnicaEmpresaAno.aspx.vb" Inherits="MemberPages_Planejamento_Despesas_viewMetaDespUnicaLojaMes" %>
...
<body>
    ...
    <div>
        ...
        <dxe:ASPxButton ID="ASPxButton1" runat="server" 
            ...
            Text="Exportar para excel" Width="148px" Height="16px" Theme="DevEx">
        </dxe:ASPxButton>
                </td>
                <td>
                    &nbsp;</td>
            ...
            <tr>
                <td >
                    <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" 
                        ...
                        KeyFieldName="idCod" Width="600px" Theme="DevEx">
                        ...
                        <Styles CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css" 
                            ...
                            <GroupFooter BackColor="#EAEAEA" Font-Bold="True">
                            </GroupFooter>
                        ...
                        <TotalSummary>
                            <dxwgv:ASPxSummaryItem DisplayFormat="{0:n0}" FieldName="vlr" 
                                SummaryType="Sum" ShowInGroupFooterColumn="vlr" />
                        ...
                        <GroupSummary>
                            ...
                            <dxwgv:ASPxSummaryItem FieldName="perc" ShowInGroupFooterColumn="perc" 
                                SummaryType="Custom" />
                        </GroupSummary>
                        <Columns>
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="Gestor" FieldName="DescPessoalAdm" 
                                GroupIndex="0" SortIndex="0" SortOrder="Ascending" ToolTip="Gestor da conta" 
                                VisibleIndex="4" Width="100px">
                            </dxwgv:GridViewDataTextColumn>
                        </Columns>
                        <Settings ShowFooter="True" ShowVerticalScrollBar="True" 
                            VerticalScrollableHeight="400" ShowGroupFooter="VisibleAlways" 
                            ShowGroupPanel="True" />
                        <StylesEditors>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="uspViewMetaDespesaOriginaisEmpresaAno" 
                        ...
                        <SelectParameters>
                            ...
                            <asp:SessionParameter DefaultValue="" Name="Ano" SessionField="sAno" 
                                Type="String" />
                            <asp:QueryStringParameter Name="idCat" QueryStringField="idCat" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
            </tr>
