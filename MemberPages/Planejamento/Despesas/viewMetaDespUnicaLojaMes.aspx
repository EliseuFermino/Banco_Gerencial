<%@ Page Language="VB" AutoEventWireup="false" CodeFile="viewMetaDespUnicaLojaMes.aspx.vb" Inherits="MemberPages_Planejamento_Despesas_viewMetaDespUnicaLojaMes" %>
            ...
            <tr>
                <td >
                    <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" 
                        ...
                        KeyFieldName="idCod" Width="500px" Theme="DevEx">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="uspViewMetaDespesaOriginais" SelectCommandType="StoredProcedure">
                        <SelectParameters>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label1" runat="server" style="font-weight: 700" 
                        Text="Meta de Venda:" ForeColor="#333333"></asp:Label>
&nbsp;<asp:Label ID="lblVenda" runat="server" Text="Label" ForeColor="Black"></asp:Label>
                </td>
            </tr>
        </table>
