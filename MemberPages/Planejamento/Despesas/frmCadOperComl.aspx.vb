...
Partial Class MemberPages_Planejamento_frmCadOperComl
    Inherits System.Web.UI.Page

    Dim strConn As String = clData_gerManager.dbConnect
    Private connBI As String = clDataDb_gerBI.dbConnect
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not IsPostBack Then
            ...
            Me.NewItem.Value = 5    'Traz lista de Operações Comerciais
            Call AdicionarItem()

            Me.NewItem.Value = Me.cboPosicao.CallPosicao     'Traz lista de Operações Comerciais
            Call AdicionarPosicao()

            oVem.AtualizarEstatisticaPrograma(50, User.Identity.Name)
    ...
    Sub DefinirOpcaoSalvar()
        On Error Resume Next
        oOrc.HabilitarSalvar(btnSalvar1, cboAno.CallAno, cboPosicao.CallPosicao, 7, User.Identity.Name)
    End Sub
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        CType(Master.FindControl("lblTitle"), Label).Text = "Orçamento " & Me.cboAno.CallAno & " - Operações Comerciais"
    End Sub
    ...
    Protected Sub Page_PreRenderComplete(sender As Object, e As EventArgs) Handles Me.PreRenderComplete
        If Not IsPostBack Then
            ...
            Dim vDepartamento As String = LCase(Trim(oProj.BuscarDepartamentoDoUsuario(Page.User.Identity.Name)))
            Me.NewItem.Value = oVem.Buscar_IDSubGrupo(Me.cboGrupo_Sub.CallGrupo)

            'If vDepartamento = "comercial" Then
