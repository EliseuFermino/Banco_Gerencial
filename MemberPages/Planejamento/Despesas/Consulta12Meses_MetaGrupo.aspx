<%@ Page Title="Consulta Meta de Venda por Seção Original" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="Consulta12Meses_MetaGrupo.aspx.vb" Inherits="Consulta12Meses_MetaGrupo" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <Columns>
            ...
            <dxwgv:GridViewBandColumn Caption="Janeiro" VisibleIndex="6">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vOri_01" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
            ...
            <dxwgv:GridViewBandColumn Caption="Fevereiro" VisibleIndex="7">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vOri_02" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
                    </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewBandColumn Caption="Março" VisibleIndex="8">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vOri_03" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
                    </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewBandColumn Caption="Abril" VisibleIndex="9">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vOri_04" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
                    </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewBandColumn Caption="Maio" VisibleIndex="10">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vOri_05" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
                    </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewBandColumn Caption="Junho" VisibleIndex="13">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vOri_06" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
                    </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewBandColumn Caption="Julho" VisibleIndex="16">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vOri_07" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
                    </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewBandColumn Caption="Agosto" VisibleIndex="19">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vOri_08" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
                    </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewBandColumn Caption="Setembro" VisibleIndex="22">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vOri_09" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
                    </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewBandColumn Caption="Outubro" VisibleIndex="25">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vOri_10" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
                    </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewBandColumn Caption="Novembro" VisibleIndex="28">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vOri_11" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
                    </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewBandColumn Caption="Dezembro" VisibleIndex="31">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vOri_12" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
                    </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewBandColumn Caption="Ano" VisibleIndex="4" Name="bandOrcamento" FixedStyle="Left">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vOri_99" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
            ...
            <dxwgv:GridViewBandColumn Caption="Realizado" VisibleIndex="3" Name="bandRealizado" FixedStyle="Left">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vRea_99" ToolTip="Valor da meta" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
            ...
            <dxwgv:GridViewBandColumn Caption="RealizadoAA" FixedStyle="Left" Name="bandRealizadoAA" VisibleIndex="2">
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="R$" FieldName="vRea_AA" VisibleIndex="0" Width="100px">
                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                        </PropertiesTextEdit>
        ...
        SelectCommand="uspConsulta12Meses_Grupo_Filial" 
