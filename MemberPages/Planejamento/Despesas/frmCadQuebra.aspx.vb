...
Partial Class MemberPages_Planejamento_frmCadQuebra
    ...
    Sub TipoTrigger()
        If Me.rnd_Grupo.Checked = True Then
            strTrigger = "uspReaMesBuscaQuebras"
    ...
    Sub Atualizar()
        ...
        If Me.rnd_Grupo.Checked = True Then
            ...
            Me.lbl_percHist1_Total.Text = ((CDbl(Me.lbl_vlrHist1_Total.Text) / CDbl(Session("VendaRealAA1"))) * 100).ToString("n2")

            Me.lbl_percHist2_Total.Text = ((CDbl(Me.lbl_vlrHist2_Total.Text) / CDbl(Session("VendaRealAA2"))) * 100).ToString("n2")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Call TipoTrigger()
        Call Definir_varFilial()
        cboGrupo_Sub.Enabled_cboGrupo = False
    ...
    Sub DefinirOpcaoSalvar()
        On Error Resume Next
        oOrc.HabilitarSalvar(Me.btnSalvar1, cboAno.CallAno, cboPosicao.CallPosicao, 6, User.Identity.Name)
    ...
    Sub AtualizarConsulta()
        ...
        cmdTest.Parameters("@idCod").Value = Me.cboGrupo_Sub.CallGrupo
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        CType(Master.FindControl("lblTitle"), Label).Text = "Orçamento " & Me.cboAno.CallAno & " - Quebra Total - PGR332"
    End Sub
    ...
    Protected Sub Page_PreRenderComplete(sender As Object, e As EventArgs) Handles Me.PreRenderComplete
        If Not IsPostBack Then
            Dim oVem As New VendaEmpresaMes
            Me.NewItem.Value = oVem.Buscar_IDSubGrupo(6)
    ...
    Sub Busca_Rev(ByVal iMes As String)
        ...
        If rnd_Grupo.Checked = True Then
            ...
            comando.Parameters("@idCod").Value = cboGrupo_Sub.CallGrupo
        End If
