...
Partial Class MemberPages_Planejamento_frmCadReceitaComercial
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not IsPostBack Then
            ...
            Me.NewItem.Value = 14    'Traz lista de Operações Comerciais
            Call AdicionarItem()

            Me.NewItem.Value = Me.cboPosicao.CallPosicao     'Traz lista de Operações Comerciais
            Call AdicionarPosicao()

            oVem.AtualizarEstatisticaPrograma(56, User.Identity.Name)
    ...
    Sub DefinirOpcaoSalvar()
        On Error Resume Next
        oOrc.HabilitarSalvar(btnSalvar1, cboAno.CallAno, cboPosicao.CallPosicao, 48, User.Identity.Name)
    End Sub
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Orçamento " & Me.cboAno.CallAno & " - Receita Comercial - PGR56"
        End If
