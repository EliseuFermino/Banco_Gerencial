<%@ Page Title="Cadastro de Metas de Despesa" Language="VB" AutoEventWireup="false" CodeFile="frmCadDespesa.aspx.vb" Inherits="MemberPages_Planejamento_frmCadDespesa" MasterPageFile="~/MemberPages/Site.master" %>
...
<div id="moldura">
    ...
    <div id="divFilial">
        <uc1:wucListaLojasComCorporacao runat="server" ID="cboFilial" Visible_cboCorporacao="true" />        
    </div>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
     ...
     <div id="divN2">   
         <dxe:ASPxComboBox ID="ASPxComboBox1" runat="server" AutoPostBack="true" TextField  ></dxe:ASPxComboBox>      
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <Triggers>
            <asp:PostBackTrigger ControlID="btnSalvar1" />
        </Triggers>
        <ContentTemplate>
	...
	txt_vlrMeta02.Focus();
        ...
        <tr>
            ...
            <td align="right" bgcolor="#DFEEFF" class="auto-style29" 
            ...
            <td align="right" bgcolor="#DFEEFF" class="auto-style31" 
	...
	txt_vlrMeta02.Focus();
        ...
        <tr>
            <td class="style2">
                &nbsp;</td>
            <td align="right" bgcolor="#CCCCCC" class="auto-style29" 
            ...
            <td align="right" bgcolor="#CCCCCC" class="auto-style31" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:SqlDataSource ID="dsListaSubgrupo" runat="server" 
                                        ...
                                        SelectCommand="dbo.usp_ListaDespesas" 
