...
Partial Class MemberPages_Planejamento_frmCadOutrasReceitas
...
#Region " PAGE"
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        CType(Master.FindControl("lblTitle"), Label).Text = "Orçamento " & Me.cboAno.CallAno & " - Outras Receitas"
    End Sub
...
#End Region
    ...
    Sub PreencherGrupo()
        ...
        strSQL = "SELECT GrupoDesc AS CatLinhaDesc, idCat AS CatLinhaCod from Cadastros.tblCategoriaLinha WHERE idGrupo = 39"
    ...
    Sub Busca_CatCod()
        ...
        Try
            ...
            While reader5.Read
                ...
                Me.lblCatCod.Text = 8 ' - AQUI DEFINI O GRUPO DE DESPESA QUE SERA SALVO.NESSE CASO, 39-OUTRAS RECEITAS reader5.GetSqlInt16(0).ToString()
...
#Region " Buscar Históricos"
    ...
    Sub Busca_Hist4(ByVal iMes As String)
        ...
        If rnd_Grupo.Checked = True Then
            ...
            comando.Parameters("@idCod").Value = Session("sPROGRAMA")
        Else
            comando.Parameters.Add(New SqlParameter("@idCod", Data.SqlDbType.VarChar))
            comando.Parameters("@idCod").Value = Me.cboSubgrupo.SelectedValue

            comando.Parameters.Add(New SqlParameter("@Grupo", Data.SqlDbType.SmallInt))
            comando.Parameters("@Grupo").Value = 39
        End If
...
#End Region
    ...
    Sub Atualizar()
        ...
        lblOBS.Text = cboGrupo.SelectedValue & " ---- " & oVem.varDesc
    ...
    Private Sub BuscarMetaDeVendaMensal()
        ...
        'Buscar Meta de Venda Mensal
        oVem.BuscaOriGrupoMes(3, 1, Me.cboAno.CallAno, 1, vvFilial)
        Me.txt_vlrVenda_01.Text = oVem.vlrOri
        oVem.BuscaOriGrupoMes(3, 1, Me.cboAno.CallAno, 2, vvFilial)
        Me.txt_vlrVenda_02.Text = oVem.vlrOri
        oVem.BuscaOriGrupoMes(3, 1, Me.cboAno.CallAno, 3, vvFilial)
        Me.txt_vlrVenda_03.Text = oVem.vlrOri
        oVem.BuscaOriGrupoMes(3, 1, Me.cboAno.CallAno, 4, vvFilial)
        Me.txt_vlrVenda_04.Text = oVem.vlrOri
        oVem.BuscaOriGrupoMes(3, 1, Me.cboAno.CallAno, 5, vvFilial)
        Me.txt_vlrVenda_05.Text = oVem.vlrOri
        oVem.BuscaOriGrupoMes(3, 1, Me.cboAno.CallAno, 6, vvFilial)
        Me.txt_vlrVenda_06.Text = oVem.vlrOri
        oVem.BuscaOriGrupoMes(3, 1, Me.cboAno.CallAno, 7, vvFilial)
        Me.txt_vlrVenda_07.Text = oVem.vlrOri
        oVem.BuscaOriGrupoMes(3, 1, Me.cboAno.CallAno, 8, vvFilial)
        Me.txt_vlrVenda_08.Text = oVem.vlrOri
        oVem.BuscaOriGrupoMes(3, 1, Me.cboAno.CallAno, 9, vvFilial)
        Me.txt_vlrVenda_09.Text = oVem.vlrOri
        oVem.BuscaOriGrupoMes(3, 1, Me.cboAno.CallAno, 10, vvFilial)
        Me.txt_vlrVenda_10.Text = oVem.vlrOri
        oVem.BuscaOriGrupoMes(3, 1, Me.cboAno.CallAno, 11, vvFilial)
        Me.txt_vlrVenda_11.Text = oVem.vlrOri
        oVem.BuscaOriGrupoMes(3, 1, Me.cboAno.CallAno, 12, vvFilial)
    ...
    Private Sub Salvar()
        ...
        Call SalvarGrupoDespesa()   'Salva o grupo 39 - Total de Outrras Receitas
