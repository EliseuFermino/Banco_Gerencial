...
Partial Class MemberPages_Planejamento_frmCadImpostos
    ...
    Sub TipoTrigger()
        If Me.rnd_Grupo.Checked = True Then
            strTrigger = "uspReaMesBuscaImpostos"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not IsPostBack Then
            ...
            Me.NewItem.Value = 2    'Traz lista de Impostos
            Call AdicionarItem()
    ...
    Sub DefinirOpcaoSalvar()
        On Error Resume Next
        oOrc.HabilitarSalvar(Me.btnSalvar1, cboAno.CallAno, cboPosicao.CallPosicao, 2, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        CType(Master.FindControl("lblTitle"), Label).Text = "Orçamento " & Me.cboAno.CallAno & " - Impostos"
    End Sub
