...
Partial Class Consulta12Meses_MetSubgrupo_TodasLojas
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Not IsPostBack Then
            ...
            oVem.AtualizarEstatisticaPrograma(176, User.Identity.Name)
            ...
            Me.cboGrupo.AutoPostBack_cboSubgrupo = False
    ...
    Private Sub Atualizar()
        ...
        oFun.Grid_Title(ASPxGridView1, "Grupo: " & cboGrupo.CallGrupoDesc & " - Subgrupo: " & cboGrupo.CallSubgrupoDesc & ".")
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        End If
        CType(Master.FindControl("lblTitle"), Label).Text = "Orçamento - Despesas 12 Meses - Todas Filiais - por Subgrupo - PGR176'"
    End Sub
