<%@ Page Title="Consulta Meta de Venda por Seção Original" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="Consulta12Meses_MetaGrupo_TodasLojas.aspx.vb" Inherits="Consulta12Meses_MetaGrupo_TodasLojas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <%--------------------------------------------------------------------------------------------------------------------------------------------%>
        ...
        SelectCommand="uspConsulta12Meses_Grupo_Filial_Todas" 
