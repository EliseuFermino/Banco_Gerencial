    <%@ Page Title="DRE Analitica" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="viewDRE.aspx.vb" Inherits="MemberPages_viewDRE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <div id="divCheckGroup">
            <div class ="divCheck">
                <dx:ASPxCheckBox ID="chkVerOriginal" runat="server" Text="Ver Meta Original" AutoPostBack ="false" Theme ="DevEx" 
                    Checked="True" ForeColor="Orange" CheckState="Checked">
        ...
        <div id="Grid">
            <dx:ASPxCallbackPanel ID="cbPanel" runat="server" Width="100%" Theme ="Metropolis" ClientInstanceName="cbPanel" SettingsLoadingPanel-Text="Atualizando Orçamento">
                <PanelCollection>
                    <dx:PanelContent>

                        <asp:Label ID="lblOBS" runat="server" Text="Label" ForeColor="Red"></asp:Label>
                        ...
                        <dx:ASPxGridView ID="gridGrupoMes" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                <dx:GridViewCommandColumn VisibleIndex="0" Width="10px" FixedStyle="Left">
                                ...
                                <dx:GridViewDataTextColumn Caption="ID" FieldName="idGrupo" VisibleIndex="1" 
                                    Width="40px" FixedStyle="Left">
                                </dx:GridViewDataTextColumn>
                                <%--Diferenças--%>

                                <dx:GridViewBandColumn Caption="Realizado" VisibleIndex="5" 
                                    Name="band_Realizado">
                                    <Columns>
                                ...
                                <dx:GridViewBandColumn Caption="Meta Revista" VisibleIndex="4" 
                                ...
                                <dx:GridViewBandColumn Caption="Meta Original" VisibleIndex="3" 
                                ...
                                <dx:GridViewBandColumn Caption="Orçamento 2014" VisibleIndex="7" 
                                    ...
                                    <Columns>
                                        <dx:GridViewDataTextColumn Caption="Valor" FieldName="vlrRealAA" 
                                            ...
                                            <Settings AllowAutoFilter="False" ShowFilterRowMenu="False" />
                                            <HeaderStyle BackColor="#99FF99" ForeColor="#003300" />
                                ...
                                <dx:GridViewDataTextColumn Caption="Descrição" FieldName="descConta" 
                                    VisibleIndex="2" Width="200px" FixedStyle="Left">
                            ...
                            <Settings ShowTitlePanel="True" 
                                VerticalScrollableHeight="380" ShowFilterBar="Visible" ShowFilterRow="True" ShowFilterRowMenu="True" ShowFooter="True" HorizontalScrollBarMode="Auto" />
                        ...
                        <asp:SqlDataSource ID="dsGrupoMes" runat="server" 
                            ...
                            SelectCommand="dbo.uspBuscarDRE_Analitica" SelectCommandType="StoredProcedure">
                            <SelectParameters>
          ...
          <!--Insera os dados nessa area-->
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ContentTemplate>
                    ...
                    <uc1:wucBotaoExcel runat="server" ID="btnExcel1"  CallGridViewID="ASPxGridView1"/>
