<%@ Page Language="VB" AutoEventWireup="false" CodeFile="viewMetaDespUnicaEmpresaMes.aspx.vb" Inherits="MemberPages_Planejamento_Despesas_viewMetaDespUnicaLojaMes" %>
            ...
            <tr>
                <td >
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="uspViewMetaDespesaOriginaisEmpresa" 
...
&nbsp;<asp:Label ID="lblVenda" runat="server" Text="Label"></asp:Label>
        ...
        <dxe:ASPxButton ID="ASPxButton1" runat="server" 
            ...
            Text="Exportar para excel" Width="170px" Height="18px" Theme="DevEx">
        </dxe:ASPxButton>
&nbsp;
