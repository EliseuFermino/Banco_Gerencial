...
Partial Class MemberPages_Planejamento_frmCadOutrasReceitas
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not IsPostBack Then
            ...
            Me.NewItem.Value = 8    'Traz lista de Operações Comerciais
            Call AdicionarItem()

            Me.NewItem.Value = Me.cboPosicao.CallPosicao     'Traz lista de Operações Comerciais
            Call AdicionarPosicao()

            oVem.AtualizarEstatisticaPrograma(168, User.Identity.Name)
    ...
    Sub DefinirOpcaoSalvar()
        oOrc.HabilitarSalvar(btnSalvar1, cboAno.CallAno, cboPosicao.CallPosicao, 39, User.Identity.Name)
    End Sub
