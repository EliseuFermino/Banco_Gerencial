<%@ Page Language="VB" AutoEventWireup="false" CodeFile="viewMetaDespUnicaLojaAno.aspx.vb" Inherits="MemberPages_Planejamento_Despesas_viewMetaDespUnicaLojaMes" %>
...
<%@ Register Src="~/Controles/wucListaLojas.ascx" TagPrefix="uc4" TagName="wucListaLojas" %>
    ...
    <div>
        ...
        <table cellspacing="1" class="style1">
            <tr>
                ...
                <td class="style5">
                    <uc4:wucListaLojas runat="server" ID="cboFilial" />
                </td>
                <td>
                    &nbsp;</td>
                <td>
            ...
            <tr>
                <td >
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="uspViewMetaDespesaOriginaisAno" 
