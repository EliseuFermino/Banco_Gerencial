<%@ Page Title="Cadastro de Metas de Despesa" Language="VB" AutoEventWireup="false" CodeFile="frmCadOutrasReceitas.aspx.vb" Inherits="MemberPages_Planejamento_frmCadOutrasReceitas" MasterPageFile="~/MemberPages/Site.master" %>
...
&nbsp;&nbsp;<span class="style58">Sub:</span>
                    <asp:DropDownList ID="cboSubgrupo" runat="server" AutoPostBack="True" 
                        ...
                        DataTextField="CatLinhaDescDet" DataValueField="CatLinhaCodDet"  Enabled="true"
                        Width="200px">
                    </asp:DropDownList>
                </td>
            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:SqlDataSource ID="dsListaSubgrupo" runat="server" 
                                        ...
                                        SelectCommand="SELECT idSubgrupo AS CatLinhaCodDet, SubGrupoDesc AS CatLinhaDescDet, idGrupo AS CatLinhaCod FROM Cadastros.tblCategoriaLinhaDet WHERE (idGrupo = 39) AND idSubgrupo IN (145,146,147,275,148,149) ORDER BY Ordem">
                                    </asp:SqlDataSource>
                                </td>
                                <td>
                ...
                <td class="style25" align="left" 
                    ...
                    <asp:Panel ID="Panel1" runat="server" Height="200px" ScrollBars="Vertical">
                        ...
                        <dxe:ASPxButton ID="link_SubgrupoMes" runat="server" 
                            CssFilePath="~/App_Themes/Aqua/{0}/styles.css" CssPostfix="Aqua" 
                            HorizontalAlign="Left" Text="09 - Subgrupo " Width="195px">
                        </dxe:ASPxButton>
