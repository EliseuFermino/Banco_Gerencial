...
#End Region
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            oVem.AtualizarEstatisticaPrograma(381, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Then
            Session("sVendaAnoAtual") = oDW.BuscarVendaSecao_AnoAtual(Me.cboFilial.CallFilial, Me.cboSecao.CallSecao)
            Call Atualizar()
            CType(Master.FindControl("lblTitle"), Label).Text = "Orçamento " & Me.cboAno.CallAno & " - Sell-Out por Seção Comercial - PGR381"
