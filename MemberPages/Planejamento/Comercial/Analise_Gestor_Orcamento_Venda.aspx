<%@ Page Title="" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="Analise_Gestor_Orcamento_Venda.aspx.vb" Inherits="MemberPages_Planejamento_Comercial_Analise_Gestor_Orcamento_Venda" %>
            ...
            <PanelCollection>
                <dx:PanelContent>
                    ...
                    <dx:ASPxGridView ID="grid" runat="server" DataSourceID="dsDados" AutoGenerateColumns="False" KeyFieldName="idProdutoSecao" Width="100%" ClientInstanceName="grid">
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="descComprador" FixedStyle="Left" ShowInCustomizationForm="True" VisibleIndex="1" Width="150px" Caption="Comprador" ToolTip="Nome do Comprador da seção.">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="desSecao" FixedStyle="Left" ShowInCustomizationForm="True" VisibleIndex="2" Width="200px" Caption="Seção do Comprador" ToolTip="Seção do Comprador. Há compradores que podem ter mais de uma seção.">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewBandColumn Caption="Meta" ShowInCustomizationForm="True" VisibleIndex="3">
                                <Columns>
                            ...
                            <dx:GridViewBandColumn Caption="Histórico 2022" ShowInCustomizationForm="True" ToolTip="Histórico da Venda Realizada e Participações por Gestor e Total da Empresa do Ano de 2022." VisibleIndex="4">
                                <Columns>
...
UpdateAnaliseGrid();
		            ...
		            <asp:SqlDataSource ID="dsDados" runat="server" ConnectionString="<%$ ConnectionStrings:gerBIConnectionString %>" SelectCommand="dbo.usp_Ver_Meta_Compradores_Do_Gestor" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:SessionParameter Name="Ano" SessionField="sANO" Type="Int16" />
                            <asp:SessionParameter Name="idGestor" SessionField="sGESTOR" Type="Int64" />                           
                        </SelectParameters>
                    </asp:SqlDataSource>
