...
Partial Class MemberPages_Planejamento_Margem_Coml_frmCadMargemSecaoFinal
...
#Region " Preencher Historico 1 "
    ...
    Private Sub Preencher_Hist1_Mes01(ByVal iFilial As String)
        oVem.BuscaSecao_VendaMargem_Rea(Me.cboAno.CallAno - 1, 1, iFilial, Me.cboSecao.CallSecao, 5)
    ...
    Private Sub Preencher_Hist1_Mes02(ByVal iFilial As String)
        oVem.BuscaSecao_VendaMargem_Rea(Me.cboAno.CallAno - 1, 2, iFilial, Me.cboSecao.CallSecao, 5)
    ...
    Private Sub Preencher_Hist1_Mes03(ByVal iFilial As String)
        oVem.BuscaSecao_VendaMargem_Rea(Me.cboAno.CallAno - 1, 3, iFilial, Me.cboSecao.CallSecao, 5)
    ...
    Private Sub Preencher_Hist1_Mes04(ByVal iFilial As String)
        oVem.BuscaSecao_VendaMargem_Rea(Me.cboAno.CallAno - 1, 4, iFilial, Me.cboSecao.CallSecao, 5)
    ...
    Private Sub Preencher_Hist1_Mes05(ByVal iFilial As String)
        oVem.BuscaSecao_VendaMargem_Rea(Me.cboAno.CallAno - 1, 5, iFilial, Me.cboSecao.CallSecao, 5)
    ...
    Private Sub Preencher_Hist1_Mes06(ByVal iFilial As String)
        oVem.BuscaSecao_VendaMargem_Rea(Me.cboAno.CallAno - 1, 6, iFilial, Me.cboSecao.CallSecao, 5)
    ...
    Private Sub Preencher_Hist1_Mes07(ByVal iFilial As String)
        oVem.BuscaSecao_VendaMargem_Rea(Me.cboAno.CallAno - 1, 7, iFilial, Me.cboSecao.CallSecao, 5)
    ...
    Private Sub Preencher_Hist1_Mes08(ByVal iFilial As String)
        oVem.BuscaSecao_VendaMargem_Rea(Me.cboAno.CallAno - 1, 8, iFilial, Me.cboSecao.CallSecao, 5)
    ...
    Private Sub Preencher_Hist1_Mes09(ByVal iFilial As String)
        oVem.BuscaSecao_VendaMargem_Rea(Me.cboAno.CallAno - 1, 9, iFilial, Me.cboSecao.CallSecao, 5)
    ...
    Private Sub Preencher_Hist1_Mes10(ByVal iFilial As String)
        oVem.BuscaSecao_VendaMargem_Rea(Me.cboAno.CallAno - 1, 10, iFilial, Me.cboSecao.CallSecao, 5)
    ...
    Private Sub Preencher_Hist1_Mes11(ByVal iFilial As String)
        oVem.BuscaSecao_VendaMargem_Rea(Me.cboAno.CallAno - 1, 11, iFilial, Me.cboSecao.CallSecao, 5)
    ...
    Private Sub Preencher_Hist1_Mes12(ByVal iFilial As String)
        oVem.BuscaSecao_VendaMargem_Rea(Me.cboAno.CallAno - 1, 12, iFilial, Me.cboSecao.CallSecao, 5)
...
#End Region
    ...
    Sub Atualizar()
        ...
        Call BuscaMeta(cboAno.CallAno, cboFilial.CallFilial, cboSecao.CallSecao, Me.cboPosicao.CallPosicao, 97)
...
#End Region
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Then
            Session("sVendaAnoAtual") = oDW.BuscarVendaSecao_AnoAtual(Me.cboFilial.CallFilial, Me.cboSecao.CallSecao)
            Call Atualizar()
            CType(Master.FindControl("lblTitle"), Label).Text = "Comercial - Orçamento " & Me.cboAno.CallAno & " - Margem Final "

        End If

    End Sub

    Protected Sub cboSecao_ListCompradorChanged(sender As Object, e As EventArgs) Handles cboSecao.ListCompradorChanged
        Call Atualizar()
    End Sub
    ...
    Protected Sub btnSalvar1_Click(sender As Object, e As EventArgs) Handles btnSalvar1.Click
        ...
        Else
            Salvar("97", Me.cboAno.CallAno, 1, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta01.Text, Me.txt_percCresc01.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("97", Me.cboAno.CallAno, 2, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta02.Text, Me.txt_percCresc02.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("97", Me.cboAno.CallAno, 3, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta03.Text, Me.txt_percCresc03.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("97", Me.cboAno.CallAno, 4, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta04.Text, Me.txt_percCresc04.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("97", Me.cboAno.CallAno, 5, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta05.Text, Me.txt_percCresc05.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("97", Me.cboAno.CallAno, 6, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta06.Text, Me.txt_percCresc06.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("97", Me.cboAno.CallAno, 7, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta07.Text, Me.txt_percCresc07.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("97", Me.cboAno.CallAno, 8, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta08.Text, Me.txt_percCresc08.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("97", Me.cboAno.CallAno, 9, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta09.Text, Me.txt_percCresc09.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("97", Me.cboAno.CallAno, 10, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta10.Text, Me.txt_percCresc10.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("97", Me.cboAno.CallAno, 11, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta11.Text, Me.txt_percCresc11.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("97", Me.cboAno.CallAno, 12, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta12.Text, Me.txt_percCresc12.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("97", Me.cboAno.CallAno, 99, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMetaTotal.Text, Me.lblCrescAno.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
    ...
    Protected Sub gridHistorico_CustomSummaryCalculate(sender As Object, e As DevExpress.Data.CustomSummaryEventArgs) Handles gridHistorico.CustomSummaryCalculate
        ...
        oFun.Grid_Footer_Calculate(sender, e, gridHistorico, "percCresc_AA2_AA3", "vlrVenda_AA2", "vlrVenda_AA3", Funcoes.CalculateType.Growth)
        oFun.Grid_Footer_Calculate(sender, e, gridHistorico, "percCresc_Venda", "vlrMetaVenda", "vlrVenda_AA1", Funcoes.CalculateType.Growth)

        oFun.Grid_Footer_Calculate(sender, e, gridHistorico, "percCresc_Lucro_AA2_AA3", "vlrLucro_AA2", "vlrLucro_AA3", Funcoes.CalculateType.Growth)
        oFun.Grid_Footer_Calculate(sender, e, gridHistorico, "percCresc_Lucro", "vlrMetaLucro", "vlrLucro_AA1", Funcoes.CalculateType.Growth)

        oFun.Grid_Footer_Calculate(sender, e, gridHistorico, "percMargem_AA3", "vlrLucro_AA3", "vlrVenda_AA3", Funcoes.CalculateType.ValueOverRevenue)
        oFun.Grid_Footer_Calculate(sender, e, gridHistorico, "percMargem_AA2", "vlrLucro_AA2", "vlrVenda_AA2", Funcoes.CalculateType.ValueOverRevenue)
        oFun.Grid_Footer_Calculate(sender, e, gridHistorico, "percMargem_AA1", "vlrLucro_AA1", "vlrVenda_AA1", Funcoes.CalculateType.ValueOverRevenue)
        oFun.Grid_Footer_Calculate(sender, e, gridHistorico, "percMargem_Meta", "vlrMetaLucro", "vlrMetaVenda", Funcoes.CalculateType.ValueOverRevenue)
        oFun.Grid_Footer_Calculate(sender, e, gridHistorico, "dif_Meta_AA", "percMargem_Meta", "percMargem_AA1", Funcoes.CalculateType.Decrease)
        oFun.Grid_Footer_Calculate(sender, e, gridHistorico, "dif_AA3_AA2", "percMargem_AA3", "percMargem_AA2", Funcoes.CalculateType.Decrease)
    End Sub

    Protected Sub gridHistorico_HtmlDataCellPrepared(sender As Object, e As DevExpress.Web.ASPxGridViewTableDataCellEventArgs) Handles gridHistorico.HtmlDataCellPrepared
        oFun.Grid_RedIsNegative(e, "percCresc_Lucro_AA2_AA3")
        oFun.Grid_RedIsNegative(e, "percCresc_AA2_AA3")
        oFun.Grid_RedIsNegative(e, "percCresc_Lucro")
        oFun.Grid_RedIsNegative(e, "percCresc_Venda")
        oFun.Grid_RedIsNegative(e, "percMargem_AA3")
        oFun.Grid_RedIsNegative(e, "percMargem_AA2")
        oFun.Grid_RedIsNegative(e, "percMargem_AA1")
        oFun.Grid_RedIsNegative(e, "dif_Meta_AA")
        oFun.Grid_RedIsNegative(e, "dif_AA3_AA2")
        oFun.Grid_RedIsNegative(e, "percCresc_Lucro_AA2_AA3")
    ...
    Protected Sub Page_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
        If Not IsPostBack Then
            Dim vDeptoUsuario As String
            vDeptoUsuario = Trim(oPro.BuscarDepartamentoDoUsuario(Page.User.Identity.Name))
            If vDeptoUsuario = "Gestor_Comercial" Then
    ...
    Protected Sub cboSize_SelectedIndexChanged_cboSize(sender As Object, e As EventArgs) Handles cboSize.SelectedIndexChanged_cboSize
        oFun.Grid_Size(gridHistorico, cboSize.CallSize)

    End Sub


    Protected Sub gridHistorico_CustomUnboundColumnData(sender As Object, e As ASPxGridViewColumnDataEventArgs) Handles gridHistorico.CustomUnboundColumnData
        oFun.Grid_Calculate(e, "dif_Meta_AA", "percMargem_Meta", "percMargem_AA1", Funcoes.CalculateType.Decrease)
        oFun.Grid_Calculate(e, "dif_AA3_AA2", "percMargem_AA3", "percMargem_AA2", Funcoes.CalculateType.Decrease)
    End Sub

    Protected Sub gridHistorico_HtmlFooterCellPrepared(sender As Object, e As ASPxGridViewTableFooterCellEventArgs) Handles gridHistorico.HtmlFooterCellPrepared
