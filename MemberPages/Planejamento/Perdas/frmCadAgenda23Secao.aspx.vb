...
Partial Class MemberPages_Planejamento_Margem_frmCadAgenda23Secao
...
#Region "Preencher Historico 1"
    ...
    Public Sub BuscaVendaReal_Hist(ByVal txt_vlrHist As Label, ByVal txt_percHist As Label, iMes As Byte, iFilial As Int16)
        oData.GetDataDB_Parameter4("Agenda23.uspBuscarAgenda23", Conexao.gerPerdas, "@Ano", cboAno.CallAno - 1, "@Mes", iMes, "@idFilial", iFilial, "idSecao", cboSecao.CallSecao)
    ...
    Private Sub Preencher_Hist1_Mes01(ByVal iFilial As String)
        BuscaVendaReal_Hist(txt_vlrHist1_01, txt_percHist1_01, 1, iFilial)
    End Sub

    Private Sub Preencher_Hist1_Mes02(ByVal iFilial As String)
        BuscaVendaReal_Hist(txt_vlrHist1_02, txt_percHist1_02, 2, iFilial)
    End Sub

    Private Sub Preencher_Hist1_Mes03(ByVal iFilial As String)
        BuscaVendaReal_Hist(txt_vlrHist1_03, txt_percHist1_03, 3, iFilial)
    End Sub

    Private Sub Preencher_Hist1_Mes04(ByVal iFilial As String)
        BuscaVendaReal_Hist(txt_vlrHist1_04, txt_percHist1_04, 4, iFilial)
    End Sub

    Private Sub Preencher_Hist1_Mes05(ByVal iFilial As String)
        BuscaVendaReal_Hist(txt_vlrHist1_05, txt_percHist1_05, 5, iFilial)
    End Sub

    Private Sub Preencher_Hist1_Mes06(ByVal iFilial As String)
        BuscaVendaReal_Hist(txt_vlrHist1_06, txt_percHist1_06, 6, iFilial)
    End Sub

    Private Sub Preencher_Hist1_Mes07(ByVal iFilial As String)
        BuscaVendaReal_Hist(txt_vlrHist1_07, txt_percHist1_07, 7, iFilial)
    End Sub

    Private Sub Preencher_Hist1_Mes08(ByVal iFilial As String)
        BuscaVendaReal_Hist(txt_vlrHist1_08, txt_percHist1_08, 8, iFilial)
    End Sub

    Private Sub Preencher_Hist1_Mes09(ByVal iFilial As String)
        BuscaVendaReal_Hist(txt_vlrHist1_09, txt_percHist1_09, 9, iFilial)
    End Sub

    Private Sub Preencher_Hist1_Mes10(ByVal iFilial As String)
        BuscaVendaReal_Hist(txt_vlrHist1_10, txt_percHist1_10, 10, iFilial)
    End Sub

    Private Sub Preencher_Hist1_Mes11(ByVal iFilial As String)
        BuscaVendaReal_Hist(txt_vlrHist1_11, txt_percHist1_11, 11, iFilial)
    End Sub

    Private Sub Preencher_Hist1_Mes12(ByVal iFilial As String)
        BuscaVendaReal_Hist(txt_vlrHist1_12, txt_percHist1_12, 12, iFilial)
    End Sub
...
#Region "Preencher Historico 2"
    ...
    Public Sub BuscaVendaReal_Hist2(ByVal txt_vlrHist As Label, ByVal txt_percHist As Label, iMes As Byte, iFilial As Int16)
        oData.GetDataDB_Parameter4("Agenda23.uspBuscarAgenda23", Conexao.gerPerdas, "@Ano", cboAno.CallAno - 2, "@Mes", iMes, "@idFilial", iFilial, "idSecao", cboSecao.CallSecao)
        txt_vlrHist.Text = oData.vlr
        txt_percHist.Text = oData.perc
    End Sub
    ...
    Sub BuscaVendaReal_Hist2(ByVal iAno As String, ByVal iFilial As String, ByVal iSecao As String)
        ...
        BuscaVendaReal_Hist2(txt_vlrHist2_01, txt_percHist2_01, 1, iFilial)
        BuscaVendaReal_Hist2(txt_vlrHist2_02, txt_percHist2_02, 2, iFilial)
        BuscaVendaReal_Hist2(txt_vlrHist2_03, txt_percHist2_03, 3, iFilial)
        BuscaVendaReal_Hist2(txt_vlrHist2_04, txt_percHist2_04, 4, iFilial)
        BuscaVendaReal_Hist2(txt_vlrHist2_05, txt_percHist2_05, 5, iFilial)
        BuscaVendaReal_Hist2(txt_vlrHist2_06, txt_percHist2_06, 6, iFilial)
        BuscaVendaReal_Hist2(txt_vlrHist2_07, txt_percHist2_07, 7, iFilial)
        BuscaVendaReal_Hist2(txt_vlrHist2_08, txt_percHist2_08, 8, iFilial)
        BuscaVendaReal_Hist2(txt_vlrHist2_09, txt_percHist2_09, 9, iFilial)
        BuscaVendaReal_Hist2(txt_vlrHist2_10, txt_percHist2_10, 10, iFilial)
        BuscaVendaReal_Hist2(txt_vlrHist2_11, txt_percHist2_11, 11, iFilial)
        BuscaVendaReal_Hist2(txt_vlrHist2_12, txt_percHist2_12, 12, iFilial)
...
#Region "Preencher Historico 3"
    ...
    Public Sub BuscaVendaReal_Hist3(ByVal txt_vlrHist As Label, ByVal txt_percHist As Label, iMes As Byte, iFilial As Int16)
        oData.GetDataDB_Parameter4("Agenda23.uspBuscarAgenda23", Conexao.gerPerdas, "@Ano", cboAno.CallAno - 3, "@Mes", iMes, "@idFilial", iFilial, "idSecao", cboSecao.CallSecao)
        txt_vlrHist.Text = oData.vlr
        txt_percHist.Text = oData.perc
    End Sub

    Sub BuscaVendaReal_Hist3(ByVal iAno As String, ByVal iFilial As String, ByVal iSecao As String)
        BuscaVendaReal_Hist3(txt_vlrHist3_01, txt_percHist3_01, 1, iFilial)
        BuscaVendaReal_Hist3(txt_vlrHist3_02, txt_percHist3_02, 2, iFilial)
        BuscaVendaReal_Hist3(txt_vlrHist3_03, txt_percHist3_03, 3, iFilial)
        BuscaVendaReal_Hist3(txt_vlrHist3_04, txt_percHist3_04, 4, iFilial)
        BuscaVendaReal_Hist3(txt_vlrHist3_05, txt_percHist3_05, 5, iFilial)
        BuscaVendaReal_Hist3(txt_vlrHist3_06, txt_percHist3_06, 6, iFilial)
        BuscaVendaReal_Hist3(txt_vlrHist3_07, txt_percHist3_07, 7, iFilial)
        BuscaVendaReal_Hist3(txt_vlrHist3_08, txt_percHist3_08, 8, iFilial)
        BuscaVendaReal_Hist3(txt_vlrHist3_09, txt_percHist3_09, 9, iFilial)
        BuscaVendaReal_Hist3(txt_vlrHist3_10, txt_percHist3_10, 10, iFilial)
        BuscaVendaReal_Hist3(txt_vlrHist3_11, txt_percHist3_11, 11, iFilial)
        BuscaVendaReal_Hist3(txt_vlrHist3_12, txt_percHist3_12, 12, iFilial)
...
#End Region
    ...
    Private Sub Preencher_Hist1_Meta_Mes01(ByVal iFilial As String)
        oVem.BuscaRevSecaoMes(4, Me.cboSecao.CallSecao, Me.cboAno.CallAno - 1, 1, iFilial)
    ...
    Private Sub Preencher_Hist1_Meta_Mes02(ByVal iFilial As String)
        oVem.BuscaRevSecaoMes(4, Me.cboSecao.CallSecao, Me.cboAno.CallAno - 1, 2, iFilial)
    ...
    Private Sub Preencher_Hist1_Meta_Mes03(ByVal iFilial As String)
        oVem.BuscaRevSecaoMes(4, Me.cboSecao.CallSecao, Me.cboAno.CallAno - 1, 3, iFilial)
    ...
    Private Sub Preencher_Hist1_Meta_Mes04(ByVal iFilial As String)
        oVem.BuscaRevSecaoMes(4, Me.cboSecao.CallSecao, Me.cboAno.CallAno - 1, 4, iFilial)
    ...
    Private Sub Preencher_Hist1_Meta_Mes05(ByVal iFilial As String)
        oVem.BuscaRevSecaoMes(4, Me.cboSecao.CallSecao, Me.cboAno.CallAno - 1, 5, iFilial)
    ...
    Private Sub Preencher_Hist1_Meta_Mes06(ByVal iFilial As String)
        oVem.BuscaRevSecaoMes(4, Me.cboSecao.CallSecao, Me.cboAno.CallAno - 1, 6, iFilial)
    ...
    Private Sub Preencher_Hist1_Meta_Mes07(ByVal iFilial As String)
        oVem.BuscaRevSecaoMes(4, Me.cboSecao.CallSecao, Me.cboAno.CallAno - 1, 7, iFilial)
    ...
    Private Sub Preencher_Hist1_Meta_Mes08(ByVal iFilial As String)
        oVem.BuscaRevSecaoMes(4, Me.cboSecao.CallSecao, Me.cboAno.CallAno - 1, 8, iFilial)
    ...
    Private Sub Preencher_Hist1_Meta_Mes09(ByVal iFilial As String)
        oVem.BuscaRevSecaoMes(4, Me.cboSecao.CallSecao, Me.cboAno.CallAno - 1, 9, iFilial)
    ...
    Private Sub Preencher_Hist1_Meta_Mes10(ByVal iFilial As String)
        oVem.BuscaRevSecaoMes(4, Me.cboSecao.CallSecao, Me.cboAno.CallAno - 1, 10, iFilial)
    ...
    Private Sub Preencher_Hist1_Meta_Mes11(ByVal iFilial As String)
        oVem.BuscaRevSecaoMes(4, Me.cboSecao.CallSecao, Me.cboAno.CallAno - 1, 11, iFilial)
    ...
    Private Sub Preencher_Hist1_Meta_Mes12(ByVal iFilial As String)
        oVem.BuscaRevSecaoMes(4, Me.cboSecao.CallSecao, Me.cboAno.CallAno - 1, 12, iFilial)
    ...
    Sub Atualizar()
        ...
        Call BuscaMeta(cboAno.CallAno, cboFilial.CallFilial, cboSecao.CallSecao, Me.cboPosicao.CallPosicao, 4)
...
#End Region
    ...
    Private Sub CalcularCrescimento_Mes01()
        ...
        Else
            ...
            oFun.Label_RedIsNegative(lblCresc01_M1)
        End If
    ...
    Private Sub CalcularCrescimento_Mes02()
        ...
        Else
            ...
            oFun.Label_RedIsNegative(lblCresc02_M1)
        End If
    End Sub
    ...
    Private Sub CalcularCrescimento_Mes03()
        ...
        Else
            ...
            oFun.Label_RedIsNegative(lblCresc03_M1)
        End If
    End Sub
    ...
    Private Sub CalcularCrescimento_Mes04()
        ...
        Else
            ...
            oFun.Label_RedIsNegative(lblCresc04_M1)
        End If
    End Sub
    ...
    Private Sub CalcularCrescimento_Mes05()
        ...
        Else
            ...
            oFun.Label_RedIsNegative(lblCresc05_M1)
        End If
    ...
    Private Sub CalcularCrescimento_Mes06()
        ...
        Else
            ...
            oFun.Label_RedIsNegative(lblCresc06_M1)
        End If
    ...
    Private Sub CalcularCrescimento_Mes07()
        ...
        End If
        oFun.Label_RedIsNegative(lblCresc07_M1)
    End Sub
    ...
    Private Sub CalcularCrescimento_Mes08()
        ...
        Else
            ...
            oFun.Label_RedIsNegative(lblCresc08_M1)
        End If
    ...
    Private Sub CalcularCrescimento_Mes09()
        ...
        Else
            ...
            oFun.Label_RedIsNegative(lblCresc09_M1)
        End If
    ...
    Private Sub CalcularCrescimento_Mes10()
        ...
        Else
            ...
            oFun.Label_RedIsNegative(lblCresc10_M1)
        End If
    ...
    Private Sub CalcularCrescimento_Mes11()
        ...
        Else
            ...
            oFun.Label_RedIsNegative(lblCresc11_M1)
        End If
    ...
    Private Sub CalcularCrescimento_Mes12()
        ...
        Else
            ...
            oFun.Label_RedIsNegative(lblCresc12_M1)
        End If
    End Sub
...
#Region " Page"
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Orçamento " & Me.cboAno.CallAno & " - Agenda 23 por Seção - PGR54"
        End If
    End Sub
...
#End Region
    ...
    Protected Sub btnSalvar1_Click(sender As Object, e As EventArgs) Handles btnSalvar1.Click
        ...
        Else
            Salvar("4", Me.cboAno.CallAno, 1, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta01.Text, Me.txt_percCresc01.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("4", Me.cboAno.CallAno, 2, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta02.Text, Me.txt_percCresc02.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("4", Me.cboAno.CallAno, 3, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta03.Text, Me.txt_percCresc03.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("4", Me.cboAno.CallAno, 4, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta04.Text, Me.txt_percCresc04.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("4", Me.cboAno.CallAno, 5, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta05.Text, Me.txt_percCresc05.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("4", Me.cboAno.CallAno, 6, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta06.Text, Me.txt_percCresc06.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("4", Me.cboAno.CallAno, 7, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta07.Text, Me.txt_percCresc07.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("4", Me.cboAno.CallAno, 8, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta08.Text, Me.txt_percCresc08.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("4", Me.cboAno.CallAno, 9, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta09.Text, Me.txt_percCresc09.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("4", Me.cboAno.CallAno, 10, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta10.Text, Me.txt_percCresc10.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("4", Me.cboAno.CallAno, 11, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta11.Text, Me.txt_percCresc11.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            Salvar("4", Me.cboAno.CallAno, 12, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMeta12.Text, Me.txt_percCresc12.Text, Me.cboPosicao.CallPosicao, User.Identity.Name)
            'Salvar("2", Me.cboAno.CallAno, 99, Me.cboFilial.CallFilial, Me.cboSecao.CallSecao, Me.txt_vlrMetaTotal.Text, Me.lblCrescAno.Text, Me.cboPosicao.CallPosicao)
