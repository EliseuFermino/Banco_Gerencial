<%@ Page Language="VB" AutoEventWireup="false" CodeFile="viewQuebraOriginalAno.aspx.vb" Inherits="MemberPages_Planejamento_Quebras_viewQuebraOriginalMes" Theme="" %>
...
<head runat="server">
    <title>Meta Original de Quebra Total - Ano</title>
    <style type="text/css">
        .style1
        {
            width: 100%;
                ...
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <table cellspacing="1" class="style1">
                                <tr>
                                    <td align="left" bgcolor="#62B0FF" class="style5" colspan="3">
                                        <span class="style7">&nbsp;Meta de Quebra por Seção - por Ano</span></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td bgcolor="#99CCFF" colspan="3" style="padding: 4px 0px 4px 4px">
                    ...
                    Width="400px" KeyFieldName="ListaReduzida" EnableTheming="True" Theme="DevEx">
                            ...
                            Width="13px" />
                                            ...
                                            <SettingsText Title="Meta de Quebra Total por Seção - Ano" />
                                            <TotalSummary>
                    ...
                    SelectCommand="viewOriLoja_QuebraAno" SelectCommandType="StoredProcedure">
                                            <SelectParameters>
