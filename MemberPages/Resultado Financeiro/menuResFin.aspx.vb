...
Partial Class MemberPages_Resultado_Financeiro_menuResFin
    ...
    Protected Sub ASPxTabControl1_TabClick(ByVal source As Object, ByVal e As DevExpress.Web.TabControlCancelEventArgs) Handles ASPxTabControl1.TabClick
        Dim index As Integer = Int32.Parse(e.Tab.VisibleIndex)
        Me.multiTabs.ActiveViewIndex = index
    End Sub
