<%@ Page Language="VB" AutoEventWireup="false" CodeFile="viewImpostoCompraImportacao2.aspx.vb" Inherits="MemberPages_Resultado_Financeiro_viewImpostoCompraImportacao" MasterPageFile="~/MemberPages/Resultado Financeiro/mpResultadoFinanceiro.master" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Imposto da Importação - Total</title>
    <style type="text/css">
        .style1
        {
            width: 100%;
...
<body>
    ...
    <div>
        ...
        <span class="style2">Filial 1 - Impostos da Exportação - Total&nbsp;&nbsp;
        </span>
        <br />
