<%@ Page Title="Comercial - Tela Inicial" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="menuPrincipal_Comercial.aspx.vb" Inherits="MemberPages_menuPrincipal_Comercial" %>
                ...
                <div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="fa fa-bar-chart" ></span>&nbsp Margem Negativa - TOP 50 - Comprador: <span><asp:Label ID="Label1" runat="server" Text="" ></asp:Label></span> </h4>
...
cboPaneLucroItemNegativo.PerformCallback();	
                         ...
                         <div id="divTop30_Lucro_Negativo" class="Separacao_Separacao" style="overflow-x:auto;">
                          ...
                          <dx:ASPxGridView ID="grid_Top30_Lucro_Negativo" runat="server" DataSourceID="ds_Top30_Lucro_Negativo" AutoGenerateColumns="False" Width="910px" KeyFieldName="CodProduto">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Nº" FieldName="rnk" ReadOnly="True" ToolTip="Posição no TOP " VisibleIndex="1" Width="30px">
                                    <Settings AllowAutoFilter="False" />
                                </dx:GridViewDataTextColumn>
                        ...
                        <asp:SqlDataSource ID="ds_Top30_Lucro_Negativo" runat="server" ConnectionString="<%$ ConnectionStrings:gerVendaItemConnectionString %>" SelectCommand="Dia.uspAtualizar_TOP_LucroFinal_Negativo_Comprador" SelectCommandType="StoredProcedure">
                            <SelectParameters>
      ...
      <div class="row Quebra_Pagina_Row">
                ...
                <div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="fa fa-bar-chart" ></span>&nbsp Margem entre 0.00 e 5,00% - Comprador: <span><asp:Label ID="Label2" runat="server" Text="" ></asp:Label></span> </h4>
						...
						<div class="widget-body">
							<div class="widget-main">
                                            ...
                                            <dx:ASPxCallbackPanel ID="ASPxCallbackPanel1" runat="server" Width="100%" ClientInstanceName="cboPaneLucroItemNegativo" Theme="Metropolis" SettingsLoadingPanel-Text="Aguarde. Atualizando">
<SettingsLoadingPanel Text="Aguarde. Atualizando"></SettingsLoadingPanel>
                <PanelCollection>
                    <dx:PanelContent>  
...
cboPaneLucroItemNegativo.PerformCallback();	
                         ...
                         <div id="div1" class="Separacao_Separacao" style="overflow-x:auto;">

                          <dx:ASPxGridView ID="gridNegativo5" runat="server" DataSourceID="ds_Top30_Lucro_Negativo5" AutoGenerateColumns="False" Width="910px" KeyFieldName="CodProduto">
                              <Toolbars>
                                <dx:GridViewToolbar EnableAdaptivity="true">
                                    <Items>
                                        <dx:GridViewToolbarItem Command="ExportToXls" Text="Exportar para Excel - XLS" ToolTip="Versão do Excel 2007 para baixo" />
                        ...
                        <asp:SqlDataSource ID="ds_Top30_Lucro_Negativo5" runat="server" ConnectionString="<%$ ConnectionStrings:gerVendaItemConnectionString %>" SelectCommand="Dia.uspAtualizar_TOP_LucroFinal_Negativo_Comprador_5" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:SessionParameter DbType="Date" Name="Dia" SessionField="sDIA" />
                                <asp:SessionParameter DbType="String" Name="idComprador" SessionField="sCOMPRADOR" />
                            </SelectParameters>
      ...
      <div class="row Quebra_Pagina_Row">
                ...
                <div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="fa fa-bar-chart" ></span>&nbsp Crescimento de Vendas Total - Comprador: <span><asp:Label ID="lblComprador_GR1" runat="server" Text="" ></asp:Label></span> </h4>
						...
						<div class="widget-body">
							<div class="widget-main" style="overflow-x:auto ">
                                        ...
                                        <uc1:wuc_KPI_Comprador runat="server" ID="wuc_KPI_Comprador" />
      ...
      <div class="row Quebra_Pagina_Row">
                ...
                <div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="fa fa-bar-chart" ></span> &nbsp Gráfico de Metas x Realizado <span class="bolder"> por Mês </span><span>- Comprador: <asp:Label ID="lblComprador_GR2" runat="server" Text="" ></asp:Label></span></h4>
						...
						<div class="widget-body">
							<div class="widget-main" style="overflow-x:auto;">
                                ...
                                <uc1:wuc_Gestor_Meta_x_Real_Mes_Graph_Comprador runat="server" ID="wuc_Gestor_Meta_x_Real_Mes_Graph_Comprador" />	
        ...
        <div class="row Quebra_Pagina_Row">
            ...
            <div class="col-md-12">
			    <div class="widget-box">
				    <div class="widget-header">
					    <h4 class="widget-title"><span class="fa fa-bar-chart" ></span> &nbsp Gráfico de Metas x Realizado <span class="bolder"> por Ano </span><span> - Comprador: <asp:Label ID="lblComprador_GR3" runat="server" Text="" ></asp:Label></span></h4>
				    ...
				    <div class="widget-body">
					    <div class="widget-main" style="overflow-x:auto;">
                            ...
                            <uc1:wuc_Gestor_Meta_x_Real_Ano_Graph_Comprador runat="server" ID="wuc_Gestor_Meta_x_Real_Ano_Graph_Comprador" />
