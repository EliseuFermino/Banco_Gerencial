...
Partial Class MemberPages_Vendas_VendaAcompanhamento_Textil
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = " &nbsp  Acompanhamento de Vendas Diárias - Departamento 4 - Textil - PGR386"
    ...
    Private Sub AtualizarVendaAno()
        ...
        Me.txtVendaAno.Text = CDec(oCon.spScalar_pAno(Conexao.gerManager, "Vendas.uspBuscarVendaEmpresaAno_Textil", Year(DateAdd(DateInterval.Day, -1, Me.cboDia.Value)))).ToString("n0")
    End Sub
    ...
    Private Sub Atualizar()
        ...
        oFun.Grid_Title(ASPxGridView1, "Dia " & FormatDateTime(cboDia.Value, DateFormat.ShortDate) & " - " & descDia & " -  Acompanhamento de Vendas do Departamento 4 - TEXTIL")
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            oVen.AtualizarEstatisticaPrograma(386, Page.User.Identity.Name)
