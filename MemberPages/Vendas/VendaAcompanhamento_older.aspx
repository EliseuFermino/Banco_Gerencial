<%@ Page Title="Ranking de Vendas Diário - por Loja" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="VendaAcompanhamento_older.aspx.vb" Inherits="MemberPages_Vendas_VendaAcompanhamento_older" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <dx:ASPxTimer ID="ASPxTimer1" runat="server" Interval="60000">
        ...
        cbPanelVendaAcompanhamento.PerformCallback()  ;  
    }" />  
        </dx:ASPxTimer> 
...
<%--    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <dx:ASPxCallbackPanel ID="cbPanelVendaAcompanhamento" runat="server" Width="100%" ClientInstanceName="cbPanelVendaAcompanhamento" Theme="Metropolis" Images-LoadingPanel-AlternateText="Aguarde. Atualizando" >
        <Images>
        ...
        <LoadingPanelImage AlternateText="Aguarde. Atualizando"></LoadingPanelImage>
            ...
            <div id="divRanking_Loja_Total"> 
                  <dx:ASPxGridView ID="gridRankingTotal" runat="server" 
                    ...
                    Theme="SoftOrange" style="margin-bottom: 0px" DataSourceID="dsVendaLojaTotal"  >
                    <TotalSummary>
