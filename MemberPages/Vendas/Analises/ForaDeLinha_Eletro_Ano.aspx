<%@ Page Title="Fora de Linha - Eletro - Ano" Language="VB" MasterPageFile="~/MemberPages/Vendas/Analises/mpForaDeLinha.master" AutoEventWireup="false" CodeFile="ForaDeLinha_Eletro_Ano.aspx.vb" Inherits="MemberPages_Vendas_Analises_ForaDeLinha_Eletro_Ano" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentForaDeLinha" Runat="Server">
    ...
    <div id="divTotal" class ="LayoutGridSecao ">
        <dx:ASPxGridView ID="grid_Total" runat="server" DataSourceID="dsDepartamento5" AutoGenerateColumns="False" KeyFieldName="descSemana">
            <Columns>
                <dx:GridViewDataTextColumn Caption="Ano" FieldName="NomeMes" VisibleIndex="0" Width="100px">
        ...
        <asp:SqlDataSource ID="dsDepartamento5" runat="server" ConnectionString="<%$ ConnectionStrings:DW_Condor_One_ConnectionString %>" SelectCommand="Analises.sp_ForaDeLinha_Departamento5_Ano" SelectCommandType="StoredProcedure">
            <SelectParameters>
    ...
    <div id="divSecao50"  class="LayoutGridSecao" >
        ...
        <asp:SqlDataSource ID="dsSecao50" runat="server" ConnectionString="<%$ ConnectionStrings:DW_Condor_One_ConnectionString %>" SelectCommand="Analises.sp_ForaDeLinha_Secao50_Ano" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
    ...
    <div id="divSecao51" class ="LayoutGridSecao ">
        ...
        <asp:SqlDataSource ID="dsSecao51" runat="server" ConnectionString="<%$ ConnectionStrings:DW_Condor_One_ConnectionString %>" SelectCommand="Analises.sp_ForaDeLinha_Secao51_Ano" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
    ...
    <div id="divSecao52" class ="LayoutGridSecao">
        ...
        <asp:SqlDataSource ID="dsSecao52" runat="server" ConnectionString="<%$ ConnectionStrings:DW_Condor_One_ConnectionString %>" SelectCommand="Analises.sp_ForaDeLinha_Secao52_Ano" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
    ...
    <div id="divSecao53" class ="LayoutGridSecao">
        ...
        <asp:SqlDataSource ID="dsSecao53" runat="server" ConnectionString="<%$ ConnectionStrings:DW_Condor_One_ConnectionString %>" SelectCommand="Analises.sp_ForaDeLinha_Secao53_Ano" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
    ...
    <div id="divSecao54" class ="LayoutGridSecao ">
        ...
        <asp:SqlDataSource ID="dsSecao54" runat="server" ConnectionString="<%$ ConnectionStrings:DW_Condor_One_ConnectionString %>" SelectCommand="Analises.sp_ForaDeLinha_Secao54_Ano" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
    ...
    <div id="divSecao55" class ="LayoutGridSecao ">
        ...
        <asp:SqlDataSource ID="dsSecao55" runat="server" ConnectionString="<%$ ConnectionStrings:DW_Condor_One_ConnectionString %>" SelectCommand="Analises.sp_ForaDeLinha_Secao55_Ano" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
