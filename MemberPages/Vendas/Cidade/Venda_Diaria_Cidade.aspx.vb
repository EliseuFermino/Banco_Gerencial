...
Partial Class MemberPages_Venda_Diaria_Cidade
...
#Region " Page"
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Vendas Diárias por Cidade "
        End If
    End Sub
...
#End Region
    ...
    Private Sub mySession()
        ...
        If cboTipo.SelectedItem.Value = 1 Then
            Session("sTIPO") = 1
        Else
            Session("sTIPO") = 2
        End If
