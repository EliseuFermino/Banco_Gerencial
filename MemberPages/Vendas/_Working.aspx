<%@ Page Title="Ranking de Vendas Diário - por Loja" Language="VB" MasterPageFile="~/MemberPages/SiteVendas.master" AutoEventWireup="false" CodeFile="_Working.aspx.vb" Inherits="MemberPages_Vendas_Working" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <link rel="icon" type="image/png" href="../../image/filiais.png">
        ...
        <ContentTemplate>
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                <ContentTemplate>
                    ...
                    <div id="div1" class="Separacao">
                        <uc6:wucLista_Filial_Empresa ID="cboFilial_ItensMaisVendidos2" runat="server" />
                    </div>
