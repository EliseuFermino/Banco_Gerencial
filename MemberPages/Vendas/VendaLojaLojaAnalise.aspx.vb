...
Partial Class MemberPages_Vendas_LojaLoja_Analise
...
#Region " PAGE"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            oVem.AtualizarEstatisticaPrograma(263, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Analise e Projeção de Vendas Loja a Loja - PGR263"
        End If
