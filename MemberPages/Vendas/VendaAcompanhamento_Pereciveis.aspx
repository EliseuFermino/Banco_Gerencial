<%@ Page Title="Pereciveis - Acompanhamento de Vendas Diarias" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="VendaAcompanhamento_Pereciveis.aspx.vb" Inherits="MemberPages_Vendas_VendaAcompanhamento_Pereciveis" %>
...
<%@ Register Src="~/Controles/wuc_KPI_Secao_Depto_Pereciveis.ascx" TagPrefix="uc1" TagName="wuc_KPI_Secao_Depto_Pereciveis" %>
    ...
    <div id="divGraficoGestor">
        ...
        <div class="row Quebra_Pagina_Row">
                ...
                <div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="fa fa-bar-chart" ></span> &nbsp Gráfico de Crescimento de Vendas Total do Departamento 3 - Pereciveis </h4>
						...
						<div class="widget-body">
							<div class="widget-main" style="overflow-x:auto" >
                               ...
                               <uc1:wuc_KPI_Secao_Depto_Pereciveis runat="server" ID="wuc_KPI_Secao_Depto_Pereciveis" />
    ...
    <div id="divGraficoMetaRealizado">
        ...
        <div class="row Quebra_Pagina_Row">
                ...
                <div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="fa fa-bar-chart" ></span> &nbsp Gráfico de Metas x Realizado <span class="bolder"> por Mês </span> do Departamento 2 - Pereciveis</h4>
...
<Legend Name="Default Legend" AlignmentHorizontal="Center" AlignmentVertical="BottomOutside" Direction="LeftToRight" Visibility="True"></Legend>
        ...
        <div id="divGraficoMetaRealizadoAno">
                ...
                <div class="col-md-12">
					<div class="widget-box">
						<div class="widget-header">
							<h4 class="widget-title"><span class="fa fa-bar-chart" ></span> &nbsp Gráfico de Metas x Realizado <span class="bolder">por Ano</span>  do Departamento 2 - Pereciveis</h4>
        ...
        <dx:ASPxCallbackPanel ID="cbPanelItens" runat="server" Width="100%" ClientInstanceName="cbPanelItens" Theme="Metropolis" SettingsLoadingPanel-Text="Aguarde&amp;hellip;">
                ...
                <div class="col-md-12">
					<div class="widget-box">
                        ...
                        <asp:SqlDataSource ID="ds_Top30_Lucro_Negativo" runat="server" ConnectionString="<%$ ConnectionStrings:gerVendaItemConnectionString %>" SelectCommand="Dia.uspBuscar_LucroNegativo_Top10_Empresa_Pereciveis" SelectCommandType="StoredProcedure">
                            <SelectParameters>
        ...
        <div class="row Quebra_Pagina_Row">
                ...
                <div class="col-md-12">
					<div class="widget-box">
                        ...
                        <asp:SqlDataSource ID="dsItensMaisVendidos" runat="server" ConnectionString="<%$ ConnectionStrings:gerVendaItemConnectionString %>" SelectCommand="Dia.uspBuscar_Venda_ItemMaisVendido_Top10_Empresa_Pereciveis" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:SessionParameter DbType="Date" Name="Dia" SessionField="sDIA" />
                            </SelectParameters>
                        </asp:SqlDataSource>
						...
						<div class="widget-body">
							<div class="widget-main">
                                ...
                                <dx:GridViewToolbar EnableAdaptivity="true">
                                    ...
                                    <asp:SqlDataSource ID="dsItensMenosVendidos" runat="server" ConnectionString="<%$ ConnectionStrings:gerVendaItemConnectionString %>" SelectCommand="Dia.uspBuscar_Volume_ItemMaisVendido_Top10_Empresa_Pereciveis" SelectCommandType="StoredProcedure">
                                        <SelectParameters>
                                            <asp:SessionParameter DbType="Date" Name="Dia" SessionField="sDIA" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                ...
                                <dx:GridViewToolbar EnableAdaptivity="true">
                                    <Items>
                                       ...
                                       <SettingsExport EnableClientSideExportAPI="true" ExcelExportMode="WYSIWYG"></SettingsExport>
                                        ...
                                        <asp:SqlDataSource ID="dsItensMaisVendidosLucro" runat="server" ConnectionString="<%$ ConnectionStrings:gerVendaItemConnectionString %>" SelectCommand="Dia.uspBuscar_Lucro_ItemMaisVendido_Top10_Empresa_Pereciveis" SelectCommandType="StoredProcedure">
                                            <SelectParameters>
                                                <asp:SessionParameter DbType="Date" Name="Dia" SessionField="sDIA" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
							...
							<div class="widget-main">
                                ...
                                <dx:GridViewToolbar EnableAdaptivity="true">
                                    ...
                                    <SettingsExport EnableClientSideExportAPI="true" ExcelExportMode="WYSIWYG"></SettingsExport>
                                            ...
                                            <asp:SqlDataSource ID="dsItensMenosVendidosEmpresa" runat="server" ConnectionString="<%$ ConnectionStrings:gerVendaItemConnectionString %>" SelectCommand="Dia.uspBuscar_Venda_ItemMenosVendido_Top10_Empresa_Pereciveis" SelectCommandType="StoredProcedure">
                                                <SelectParameters>
                                                    <asp:SessionParameter DbType="Date" Name="Dia" SessionField="sDIA" />
                                                </SelectParameters>
                                            </asp:SqlDataSource>
