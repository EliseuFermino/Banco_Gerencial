...
Partial Class MemberPages_Vendas_VendaAcompanhamentoMAD
    ...
    Private Sub AtualizarVendaAno()
        ...
        Me.lblVendaAno.Text = CDec(oCon.spScalar_pAno(Conexao.SQL14_gerManager, "Ranking.uspBuscarVendaEmpresaAno", Year(DateAdd(DateInterval.Day, -1, Me.cboDia.CallDia)))).ToString("n0")
    End Sub
