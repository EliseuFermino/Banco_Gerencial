...
Partial Class MemberPages_Vendas_VendaAcompanhamento_older
...
#End Region
    ...
    Protected Sub cbPanelVendaAcompanhamento_Callback(sender As Object, e As CallbackEventArgsBase) Handles cbPanelVendaAcompanhamento.Callback
