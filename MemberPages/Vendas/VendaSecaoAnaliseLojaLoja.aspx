<%@ Page Title="Analise Por Seção" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="VendaSecaoAnaliseLojaLoja.aspx.vb" Inherits="MemberPages_Vendas_VendaSecaoAnaliseLojaLoja" %>
                    ...
                    <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttributes="both"> 
                        ...
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="dsDadosVendas" EnableTheming="True" KeyFieldName="idSecao" style="margin-bottom: 0px" Theme="SoftOrange" Width="1000px">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewBandColumn Caption="Vendas" ShowInCustomizationForm="True" ToolTip="Grupo de vendas financeiras que compreende: Sugestão, Meta, Realizado e Percentual de Atingimento da Venda Realizada sobre a Meta de Venda." VisibleIndex="2">
                                    <Columns>
                            ...
                            <Settings HorizontalScrollBarMode="Visible" ShowFilterBar="Auto" ShowFilterRowMenu="True" ShowFooter="True" ShowGroupFooter="VisibleAlways" VerticalScrollableHeight="400" VerticalScrollBarMode="Visible" />
                                ...
                                <DetailRow>
                                    <dx:ASPxGridView ID="detailGrid" runat="server" AutoGenerateColumns="False" DataSourceID="dsDetail" EnableTheming="True" KeyFieldName="idFilial" style="margin-bottom: 0px" Theme="SoftOrange" Width="1000px" OnBeforePerformDataSelect="detailGrid_BeforePerformDataSelect"  OnHtmlDataCellPrepared="detailGrid_HtmlDataCellPrepared"  OnLoad="detailGrid_Load">
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewBandColumn Caption="Valor Check-Out" VisibleIndex="8">
                                                <Columns>
                        ...
                        <asp:SqlDataSource ID="dsDadosVendas" runat="server" ConnectionString="<%$ ConnectionStrings:gerManagerConnectionString %>" SelectCommand="Vendas_Dia.uspBuscar_VendaSecaoAnaliseLojaloja" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:SessionParameter Name="Ano" SessionField="sANO" Type="Int16" />
                                <asp:SessionParameter Name="Mes" SessionField="sMES" Type="Byte" />
