<%@ Page Title="Vendas por Loja" Language="VB" MasterPageFile="~/MemberPages/SiteVendas.master" AutoEventWireup="false" CodeFile="VendaAcompanhamentoCopy.aspx.vb" Inherits="MemberPages_Vendas_VendaAcompanhamentoCopy" %>
        ...
        <ContentTemplate>   
            ...
            <div class="divisao" >
                <div class="index-post">
                    ...
                    <div class="Esquerda">
                        <dx:ASPxRadioButton ID="rndTotal" runat="server" Checked="true" AutoPostBack="True" GroupName="grpTipo" Text="Total" Width="50px"></dx:ASPxRadioButton>
                    </div>

                    <div class="Esquerda">
                        <dx:ASPxRadioButton ID="rndSecao" runat="server" AutoPostBack="True" Text="Seção" GroupName="grpTipo" Width="50px"></dx:ASPxRadioButton>
                    </div>

                    <div class="Esquerda">
                        <dx:ASPxRadioButton ID="rndItem" runat="server"  AutoPostBack="True" Text="Item" GroupName="grpTipo" Visible="True"></dx:ASPxRadioButton>
                    </div> 

                    <div class="EsquerdaDetail">
                        <uc3:wucListaSecao ID="cboSecao" runat="server" cboSecao_VisibleLabel="false" AutoPostBack="true" />
                    </div>

                    <br />
                    <div id="EsquerdaDetail">
                        <uc4:wucProdutoEncontra ID="cboProduto" runat="server" />
                    </div>
            ...
            <section id="FiltroMercadologico">
