<%@ Page Title="" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="VendaAno.aspx.vb" Inherits="MemberPages_Vendas_VendaAno" %>
                ...
                <dx:PanelContent>
                    ...
                    <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" DataSourceID="dsDados" EnableTheming="True" Theme="SoftOrange" Width="100%">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="% Cresc 21 x 10" FieldName="percCresc" ShowInCustomizationForm="True" VisibleIndex="32" Width="115px" ToolTip="Percentual de Crescimento 2021 sobre 2010">                               
                                <Settings AllowAutoFilter="False" />
                            ...
                            <dx:GridViewBandColumn Caption="Venda 2010" Name="band2010" ShowInCustomizationForm="True" VisibleIndex="2">
                                <Columns>
...
<asp:SqlDataSource ID="dsDados" runat="server" ConnectionString="<%$ ConnectionStrings:DWConnectionString %>" SelectCommand="dbo.usp_Venda_por_Ano_Joanir" SelectCommandType="StoredProcedure">
                        <SelectParameters>
