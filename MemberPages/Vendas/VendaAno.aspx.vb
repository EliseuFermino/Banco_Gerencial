...
Partial Class MemberPages_Vendas_VendaAno
...
#Region " Page"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            oVen.AtualizarEstatisticaPrograma(407, User.Identity.Name)
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Analise de Vendas por Ano - PGR407"
        End If
    End Sub
...
#End Region
    ...
    Protected Sub grid_CustomSummaryCalculate(sender As Object, e As DevExpress.Data.CustomSummaryEventArgs) Handles grid.CustomSummaryCalculate
        ...
        oFun.Grid_Footer_Calculate(sender, e, grid, "percCresc", "vlr2021", "vlr2010", Funcoes.CalculateType.Growth)
