...
Partial Class MemberPages_Vendas_VendaAcompanhamentoJoanir
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If host = "200.150.68.29" Then
                lnkAcompanhamento.PostBackUrl = "~/MemberPages/Gerencial/AnaliseHoraJoanir.aspx"
            Else
                lnkAcompanhamento.PostBackUrl = "~/MemberPages/Gerencial/AnaliseHora.aspx"
            End If
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Acompanhamento de Vendas Diárias - PGR1"
