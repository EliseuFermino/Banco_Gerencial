...
Partial Class MemberPages_CentroCusto_NivelRateio_AberturaNivelRateio
...
#Region " Page"
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Total da Loja por Nivel de Rateio - PGR000"
        End If
    End Sub
