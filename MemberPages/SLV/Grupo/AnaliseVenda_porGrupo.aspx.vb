...
Partial Class MemberPages_SLV_AnaliseVenda_PorGrupo
    ...
    Protected Sub btnAtualizar_BotaoClick(sender As Object, e As EventArgs) Handles btnAtualizar.BotaoClick
        ...
        clData_gerManager.uspGrupoDias("SLV.AtualizarAnaliseVendaSecao_porGrupo", Me.cboSLV.CallGrupo, Me.cboDia.CallDiaInicial, Me.cboDia.CallDiaFinal, User.Identity.Name, 2400)
