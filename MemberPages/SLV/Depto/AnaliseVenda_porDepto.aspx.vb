...
Partial Class MemberPages_SLV_AnaliseVenda_PorDepto
    ...
    Protected Sub btnAtualizar_BotaoClick(sender As Object, e As EventArgs) Handles btnAtualizar.BotaoClick
        ...
        clData_gerManager.uspDeptoDias("SLV.AtualizarAnaliseVendaDepto", Me.cboDepto.CallDepto, Me.cboDia.CallDiaInicial, Me.cboDia.CallDiaFinal, User.Identity.Name)
        ...
        Me.lblGrafico.Text = "Crescimento de Venda do Departamento " & Me.cboDepto.CallDeptoDesc & "."
        Me.lblPeriodo.Text = "De " & Me.cboDia.CallDiaInicial & " à " & Me.cboDia.CallDiaFinal & "."

        Me.lblGrafico.Visible = True
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        CType(Master.Master.FindControl("lblTitle"), Label).Text = "Análise de Vendas - por Departamento"
    End Sub
