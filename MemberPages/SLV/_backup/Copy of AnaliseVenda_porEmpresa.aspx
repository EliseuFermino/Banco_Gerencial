<%@ Page Title="Análise de Vendas por Seção" Language="VB" MasterPageFile="~/MemberPages/SiteVendas.master" AutoEventWireup="false" CodeFile="Copy of AnaliseVenda_porEmpresa.aspx.vb" Inherits="MemberPages_SLV_AnaliseVenda_PorSecaoEmpresa" %>
                    ...
                    <ContentTemplate>
                        <table cellspacing="1" style="width: 1045px">
                            <tr>
                                ...
                                <td>
                                    <uc7:wuciListaMes ID="cboMesFinal" runat="server" />
                                </td>
                                <td>
                        ...
                        <table cellspacing="1" >
                            <tr>
                                <td>
                                    <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <TotalSummary>
                                            <dx:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="QtdeAA" 
                                                SummaryType="Custom" />
                                        </TotalSummary>
                                        <Columns>                                           
                         ...
                         <%--Dados Ano Anterior--%>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="percMargemAA" VisibleIndex="5" 
                                                Caption="% Marg AA" 
                                                ToolTip="Percentual de margem do ano anterior (mesmo período)" Width="60px">
                                                <CellStyle>
                                                    <BorderRight BorderColor="Gray" BorderStyle="Solid" BorderWidth="2px" />
                                                </CellStyle>
                                                <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False"></PropertiesTextEdit> 
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            SelectCommand="SELECT [descSecao], [QtdeAT], [vlrVendaAT], [percMargemAT], [QtdeAA], [vlrVendaAA], [percMargemAA], [vlrVendaMA], [QtdeMA], [percMargemMA], [percCresc], [vlrMeta], [percMargemMeta],[Tipo],[idFilial], [vlrMargemAA], [vlrMargemAT], [vlrMargemMA], [percCrescQtde], [percCrescLucro], [percPartAT], [percPartAA], [percPartMA] FROM [SLV].[AnaliseAnoAnterior] WHERE ([Usuario] = @Usuario) ORDER BY [idDepto],[idSecao]">
                            <SelectParameters>
