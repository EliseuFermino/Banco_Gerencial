...
Imports System.IO
    ...
    Sub Atualizar()
        ...
        If Me.cboPosicao.CallPosicao = 3 Then
            Call BuscaMetaNoBanco_BI()
        Else
        ...
        If Me.rnd_Grupo.Checked = True Then
            ...
            oVem.BuscaGrupo_ReaAno(Me.cboGrupo.SelectedValue, Me.cboAno.CallAno - 1, Me.cboFilial.CallFilial)
        ...
        If Me.rnd_Subgrupo.Checked = True Then
            oVem.BuscaSubgrupo_ReaAno(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno - 1, Me.cboFilial.CallFilial)
            Me.lbl_percHist1_Total.Text = oVem.percOri
    ...
    Private Sub BuscarMetaDeVendaMensal()
        ...
        If Me.cboPosicao.CallPosicao = 3 Then
            oBI.BuscaGrupoMes_Ori(1, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 1)
            Me.txt_vlrVenda_01.Text = oBI.vlrOri
            oBI.BuscaGrupoMes_Ori(1, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 2)
            Me.txt_vlrVenda_02.Text = oBI.vlrOri
            oBI.BuscaGrupoMes_Ori(1, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 3)
            Me.txt_vlrVenda_03.Text = oBI.vlrOri
            oBI.BuscaGrupoMes_Ori(1, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 4)
            Me.txt_vlrVenda_04.Text = oBI.vlrOri
            oBI.BuscaGrupoMes_Ori(1, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 5)
            Me.txt_vlrVenda_05.Text = oBI.vlrOri
            oBI.BuscaGrupoMes_Ori(1, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 6)
            Me.txt_vlrVenda_06.Text = oBI.vlrOri
            oBI.BuscaGrupoMes_Ori(1, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 7)
            Me.txt_vlrVenda_07.Text = oBI.vlrOri
            oBI.BuscaGrupoMes_Ori(1, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 8)
            Me.txt_vlrVenda_08.Text = oBI.vlrOri
            oBI.BuscaGrupoMes_Ori(1, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 9)
            Me.txt_vlrVenda_09.Text = oBI.vlrOri
            oBI.BuscaGrupoMes_Ori(1, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 10)
            Me.txt_vlrVenda_10.Text = oBI.vlrOri
            oBI.BuscaGrupoMes_Ori(1, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 11)
            Me.txt_vlrVenda_11.Text = oBI.vlrOri
            oBI.BuscaGrupoMes_Ori(1, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 12)
            Me.txt_vlrVenda_12.Text = oBI.vlrOri
        Else
            'Buscar Meta de Venda Mensal
    ...
    Private Sub BuscaMetaNoBanco_BI()
        ...
        ' **************************************************************************************
        If Me.rnd_Grupo.Checked = True Then
            oBI.BuscaGrupoMes_Ori(Me.cboGrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 1)
            Me.txt_vlrMeta01.Text = oBI.vlrOri
            Me.txt_percMeta01.Text = oBI.percOri
            oBI.BuscaGrupoMes_Ori(Me.cboGrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 2)
            Me.txt_vlrMeta02.Text = oBI.vlrOri
            Me.txt_percMeta02.Text = oBI.percOri
            oBI.BuscaGrupoMes_Ori(Me.cboGrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 3)
            Me.txt_vlrMeta03.Text = oBI.vlrOri
            Me.txt_percMeta03.Text = oBI.percOri
            oBI.BuscaGrupoMes_Ori(Me.cboGrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 4)
            Me.txt_vlrMeta04.Text = oBI.vlrOri
            Me.txt_percMeta04.Text = oBI.percOri
            oBI.BuscaGrupoMes_Ori(Me.cboGrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 5)
            Me.txt_vlrMeta05.Text = oBI.vlrOri
            Me.txt_percMeta05.Text = oBI.percOri
            oBI.BuscaGrupoMes_Ori(Me.cboGrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 6)
            Me.txt_vlrMeta06.Text = oBI.vlrOri
            Me.txt_percMeta06.Text = oBI.percOri
            oBI.BuscaGrupoMes_Ori(Me.cboGrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 7)
            Me.txt_vlrMeta07.Text = oBI.vlrOri
            Me.txt_percMeta07.Text = oBI.percOri
            oBI.BuscaGrupoMes_Ori(Me.cboGrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 8)
            Me.txt_vlrMeta08.Text = oBI.vlrOri
            Me.txt_percMeta08.Text = oBI.percOri
            oBI.BuscaGrupoMes_Ori(Me.cboGrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 9)
            Me.txt_vlrMeta09.Text = oBI.vlrOri
            Me.txt_percMeta09.Text = oBI.percOri
            oBI.BuscaGrupoMes_Ori(Me.cboGrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 10)
            Me.txt_vlrMeta10.Text = oBI.vlrOri
            Me.txt_percMeta10.Text = oBI.percOri
            oBI.BuscaGrupoMes_Ori(Me.cboGrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 11)
            Me.txt_vlrMeta11.Text = oBI.vlrOri
            Me.txt_percMeta11.Text = oBI.percOri
            oBI.BuscaGrupoMes_Ori(Me.cboGrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 12)
            Me.txt_vlrMeta12.Text = oBI.vlrOri
            Me.txt_percMeta12.Text = oBI.percOri
        Else
            oBI.BuscaSubgrupoMes_Ori(Me.cboSubgrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 1)
            Me.txt_vlrMeta01.Text = oBI.vlrOri
            Me.txt_percMeta01.Text = oBI.percOri
            oBI.BuscaSubgrupoMes_Ori(Me.cboSubgrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 2)
            Me.txt_vlrMeta02.Text = oBI.vlrOri
            Me.txt_percMeta02.Text = oBI.percOri
            oBI.BuscaSubgrupoMes_Ori(Me.cboSubgrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 3)
            Me.txt_vlrMeta03.Text = oBI.vlrOri
            Me.txt_percMeta03.Text = oBI.percOri
            oBI.BuscaSubgrupoMes_Ori(Me.cboSubgrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 4)
            Me.txt_vlrMeta04.Text = oBI.vlrOri
            Me.txt_percMeta04.Text = oBI.percOri
            oBI.BuscaSubgrupoMes_Ori(Me.cboSubgrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 5)
            Me.txt_vlrMeta05.Text = oBI.vlrOri
            Me.txt_percMeta05.Text = oBI.percOri
            oBI.BuscaSubgrupoMes_Ori(Me.cboSubgrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 6)
            Me.txt_vlrMeta06.Text = oBI.vlrOri
            Me.txt_percMeta06.Text = oBI.percOri
            oBI.BuscaSubgrupoMes_Ori(Me.cboSubgrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 7)
            Me.txt_vlrMeta07.Text = oBI.vlrOri
            Me.txt_percMeta07.Text = oBI.percOri
            oBI.BuscaSubgrupoMes_Ori(Me.cboSubgrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 8)
            Me.txt_vlrMeta08.Text = oBI.vlrOri
            Me.txt_percMeta08.Text = oBI.percOri
            oBI.BuscaSubgrupoMes_Ori(Me.cboSubgrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 9)
            Me.txt_vlrMeta09.Text = oBI.vlrOri
            Me.txt_percMeta09.Text = oBI.percOri
            oBI.BuscaSubgrupoMes_Ori(Me.cboSubgrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 10)
            Me.txt_vlrMeta10.Text = oBI.vlrOri
            Me.txt_percMeta10.Text = oBI.percOri
            oBI.BuscaSubgrupoMes_Ori(Me.cboSubgrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 11)
            Me.txt_vlrMeta11.Text = oBI.vlrOri
            Me.txt_percMeta11.Text = oBI.percOri
            oBI.BuscaSubgrupoMes_Ori(Me.cboSubgrupo.SelectedValue, Me.cboFilial.CallFilial, Me.cboAno.CallAno, 12)
            Me.txt_vlrMeta12.Text = oBI.vlrOri
            Me.txt_percMeta12.Text = oBI.percOri
        End If
    End Sub
    ...
    Sub DefinirOpcaoSalvar()
        If Me.cboAno.CallAno = 2013 Then
            If Me.rnd_Subgrupo.Checked = True Then
    ...
    Sub SalvarGrupoDespesa_BI()
        Dim sConnStr As String = strConn
        Dim cnBKTest As New SqlConnection(connBI)
        Dim cmdTest As New SqlCommand("uspCalculaTotalDespesa", cnBKTest)
    ...
    Private Sub TriggerSalvar()
        ...
        If Me.cboPosicao.CallPosicao = 3 Then   'Original
            Call Salvar_BI()
        Else
            Call Salvar()
        End If
    ...
    Private Sub Salvar_BI()
        Dim oVem As New VendaEmpresaMes
        'Salvar Subgrupo - Mes
        oBI.Salvar_Ori_Subgrupo_Mes(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno, 1, Me.cboFilial.CallFilial, Me.txt_vlrMeta01.Text, Me.txt_percMeta01.Text, User.Identity.Name, Me.cboGrupo.SelectedValue)
        oBI.Salvar_Ori_Subgrupo_Mes(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno, 2, Me.cboFilial.CallFilial, Me.txt_vlrMeta02.Text, Me.txt_percMeta02.Text, User.Identity.Name, Me.cboGrupo.SelectedValue)
        oBI.Salvar_Ori_Subgrupo_Mes(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno, 3, Me.cboFilial.CallFilial, Me.txt_vlrMeta03.Text, Me.txt_percMeta03.Text, User.Identity.Name, Me.cboGrupo.SelectedValue)
        oBI.Salvar_Ori_Subgrupo_Mes(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno, 4, Me.cboFilial.CallFilial, Me.txt_vlrMeta04.Text, Me.txt_percMeta04.Text, User.Identity.Name, Me.cboGrupo.SelectedValue)
        oBI.Salvar_Ori_Subgrupo_Mes(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno, 5, Me.cboFilial.CallFilial, Me.txt_vlrMeta05.Text, Me.txt_percMeta05.Text, User.Identity.Name, Me.cboGrupo.SelectedValue)
        oBI.Salvar_Ori_Subgrupo_Mes(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno, 6, Me.cboFilial.CallFilial, Me.txt_vlrMeta06.Text, Me.txt_percMeta06.Text, User.Identity.Name, Me.cboGrupo.SelectedValue)
        oBI.Salvar_Ori_Subgrupo_Mes(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno, 7, Me.cboFilial.CallFilial, Me.txt_vlrMeta07.Text, Me.txt_percMeta07.Text, User.Identity.Name, Me.cboGrupo.SelectedValue)
        oBI.Salvar_Ori_Subgrupo_Mes(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno, 8, Me.cboFilial.CallFilial, Me.txt_vlrMeta08.Text, Me.txt_percMeta08.Text, User.Identity.Name, Me.cboGrupo.SelectedValue)
        oBI.Salvar_Ori_Subgrupo_Mes(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno, 9, Me.cboFilial.CallFilial, Me.txt_vlrMeta09.Text, Me.txt_percMeta09.Text, User.Identity.Name, Me.cboGrupo.SelectedValue)
        oBI.Salvar_Ori_Subgrupo_Mes(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno, 10, Me.cboFilial.CallFilial, Me.txt_vlrMeta10.Text, Me.txt_percMeta10.Text, User.Identity.Name, Me.cboGrupo.SelectedValue)
        oBI.Salvar_Ori_Subgrupo_Mes(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno, 11, Me.cboFilial.CallFilial, Me.txt_vlrMeta11.Text, Me.txt_percMeta11.Text, User.Identity.Name, Me.cboGrupo.SelectedValue)
        oBI.Salvar_Ori_Subgrupo_Mes(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno, 12, Me.cboFilial.CallFilial, Me.txt_vlrMeta12.Text, Me.txt_percMeta12.Text, User.Identity.Name, Me.cboGrupo.SelectedValue)

        'Salvar Subgrupo - Ano
        oBI.Salvar_Ori_Subgrupo_Ano(Me.cboSubgrupo.SelectedValue, Me.cboAno.CallAno, Me.cboFilial.CallFilial, Me.lbl_vlrMetaTotal.Text, Me.lbl_percMetaTotal.Text, User.Identity.Name, Me.cboGrupo.SelectedValue)

        'Salvar Grupo - Mês
        oBI.Salvar_Ori_Grupo_Mes_BaseSubgrupo(Me.cboGrupo.SelectedValue, Me.cboAno.CallAno, Me.cboFilial.CallFilial, User.Identity.Name, Me.lblCatCod.Text)
        'Me.lblOBS.Text = oBI.varDesc
        Call SalvarGrupoDespesa_BI()   'Salva o grupo 14 - Total da Despesa
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        CType(Master.Master.FindControl("lblTitle"), Label).Text = "Orçamento 2013 - Despesas"
    End Sub
