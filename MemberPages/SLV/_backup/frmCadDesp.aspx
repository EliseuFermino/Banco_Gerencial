<%@ Page Title="Cadastro de Metas de Despesa" Language="VB" AutoEventWireup="false" CodeFile="frmCadDesp.aspx.vb" Inherits="MemberPages_Planejamento_frmCadDesp" MasterPageFile="~/MemberPages/SiteOrcamento.master" %>
    ...
    <div>
        ...
        <table class="style1">
            <tr>
                ...
                <td class="style52">
                    <uc5:wuciListaLojasComApoio ID="cboFilial" runat="server" />
                </td>
                <td class="style49">
...
&nbsp;&nbsp;<span class="style58">Sub:</span>
    ...
    <table cellpadding="0" cellspacing="0" class="style1">
        ...
        <tr>
            ...
            <td align="right" bgcolor="#DFEEFF" class="style6" 
        ...
        <tr>
            ...
            <td align="right" bgcolor="#CCCCCC" class="style6" 
                style="border-style: none solid solid none; border-width: 1px; border-color: #808080; padding-right: 2px;">
