...
Partial Class MemberPages_SLV_Item_ComparativoCrescimentoSecao
...
#End Region
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            oVem.AtualizarEstatisticaPrograma(230, User.Identity.Name)
    ...
    Protected Sub cboMesFinal_ListMesChanged(sender As Object, e As EventArgs) Handles cboMesFinal.ListMesChanged
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Comparativo de Crescimento por Seção - Mês - PGR230"
        End If
