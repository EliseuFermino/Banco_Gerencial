<%@ Page Title="Comparativo Crescimento Item" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="ComparativoCrescimentoSecaoDia.aspx.vb" Inherits="MemberPages_SLV_Item_ComparativoCrescimentoSecaoDia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div id="divMesmosDias">
        <dx:ASPxCheckBox ID="chkMesmosDias" runat="server" AutoPostBack="false" Theme="DevEx" Text="Mesmos Dias" ForeColor="#0033cc"></dx:ASPxCheckBox>
    </div>
            ...
            <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttributes="both">
                ...
                <div id="divDados">
                    <dx:ASPxGridView ID="grid" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" KeyFieldName="idProdutoSecao" Width="1020px">
                        ...
                        <Columns>
                            <dx:GridViewBandColumn Caption="Clientes" ShowInCustomizationForm="True" ToolTip="Número de clientes que compraram algum produto da seção" VisibleIndex="5">
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="2013" FieldName="numClienteAA" ShowInCustomizationForm="True" VisibleIndex="0" Width="80px">
                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                        </PropertiesTextEdit>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="2014" FieldName="numClienteAT" ShowInCustomizationForm="True" VisibleIndex="1" Width="80px">
                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                        </PropertiesTextEdit>
                                    </dx:GridViewDataTextColumn>
                                </Columns>
                            ...
                            <dx:GridViewBandColumn Caption="2014" Name="bandAnoAtual" VisibleIndex="2">
                                <Columns>
                            ...
                            <dx:GridViewBandColumn Caption="2013" Name="bandAnoAnterior" VisibleIndex="1">
                                <Columns>
                            ...
                            <dx:GridViewBandColumn Caption="% de Crescimento" VisibleIndex="3">
                                <Columns>
                            ...
                            <dx:GridViewBandColumn Caption="Preço Médio" VisibleIndex="4">
                                <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:gerVendaItemConnectionString %>" SelectCommand="Analises.usp_ComparativoCrescimentoSecao_Dia" SelectCommandType="StoredProcedure">
                        <SelectParameters>
