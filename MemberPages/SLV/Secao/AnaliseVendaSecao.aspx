<%@ Page Title="Análise de Vendas por Seção" Language="VB" MasterPageFile="~/MemberPages/SiteVendas.master" AutoEventWireup="false" CodeFile="AnaliseVendaSecao.aspx.vb" Inherits="MemberPages_SLV_AnaliseVendaSecao" %>
                        ...
                        <table  cellspacing="1" style="width: 1045px">
                            <tr>
                                <td style="width :100px">
                                    <asp:DropDownList ID="cboSecao" runat="server">
                                        <asp:ListItem Value="11">11-Leite</asp:ListItem>
                                        <asp:ListItem Value="13">13-Rotisseria</asp:ListItem>
                                        <asp:ListItem Value="17">17-Padaria</asp:ListItem>
                                        <asp:ListItem Value="18">18-Confeitaria</asp:ListItem>
                                        <asp:ListItem Value="21">21-Açougue</asp:ListItem>
                                        <asp:ListItem Value="23">23-Hortifrutri</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                         ...
                         <%--Dados Mês Anterior--%>
                               ...
                               <%--% Dados Ano Atual--%>
                                ...
                                <%--Meta--%>
                                            ...
                                            <dx:GridViewBandColumn Caption="Mês Anterior" Name="bandMesAnterior" VisibleIndex="4">
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Reais" FieldName="vlrVendaMA" ToolTip="Valor de venda do mês anterior (mesmo dias)" VisibleIndex="1" Width="90px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n0}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <HeaderStyle BackColor="#FF9900" HorizontalAlign="Center" />
                                                    </dx:GridViewDataTextColumn>
                                            ...
                                            <dx:GridViewBandColumn Caption="Crescimento" Name="bandCrescimento" VisibleIndex="16">
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn Caption="Vol." FieldName="percCrescQtde" ToolTip="Percentual de crescimento de Quantidade entre periodo atual e periodo do ano anterior" VisibleIndex="1" Width="60px">
                                                        <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                                        </PropertiesTextEdit>
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <CellStyle>
