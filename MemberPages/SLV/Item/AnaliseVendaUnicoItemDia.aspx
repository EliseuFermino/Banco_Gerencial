<%@ Page Title="Análise Item Diário - 2 Meses - PGR292" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="AnaliseVendaUnicoItemDia.aspx.vb" Inherits="MemberPages_SLV_Item_AnaliseVendaUnicoItemDia" %>
...
cbPanel.PerformCallback();
    ...
    <div id="divMenos60">
        <dx:ASPxButton ID="btnMenos60" runat="server" Text="- 60 dias" AutoPostBack="False" Theme="Metropolis" ToolTip="Menos 60 dias " >
            <ClientSideEvents Click="function(s, e) {
	        txtDias.SetValue(-60); }" />
        </dx:ASPxButton>
    </div>
    ...
    <div id="divMais60">
        <dx:ASPxButton ID="btnMais60" runat="server" Text="+ 60 dias" AutoPostBack="False" Theme="Metropolis" ToolTip="Mais 60 dias " >
            <ClientSideEvents Click="function(s, e) {			
		    txtDias.SetValue(60); 
...
<cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:gerVendaItemConnectionString %>" SelectCommand="Analises.usp_Unico_Item_porDia" SelectCommandType="StoredProcedure">
                        <SelectParameters>
...
<cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                    ...
                    <dxchartsui:WebChartControl ID="graph2" runat="server" DataSourceID="SqlDataSource1" Height="450px" Width="1000px" Visible="False">
                        <diagramserializable>
                            <cc1:XYDiagram>
                                <axisx visibleinpanesserializable="4" gridspacingauto="False" minorcount="1">
                                    <tickmarks crossaxis="True" />
                                ...
                                <axisy visibleinpanesserializable="-1" title-font="Tahoma, 9pt, style=Bold" title-text="Agenda 23 (Lixo)" title-visible="True">
                                    <tickmarks minorvisible="False" visible="False" />
                                    <label visible="False">
                                    </label>
                                    <range sidemarginsenabled="True" />
                                ...
                                <secondaryaxesy>
                                    <cc1:SecondaryAxisY Alignment="Near" AxisID="0" Name="Clientes AxisY " VisibleInPanesSerializable="4" Title-Antialiasing="False" Title-Font="Tahoma, 9pt, style=Bold" Title-Text="Divergência" Title-Visible="True">
                                        <tickmarks minorvisible="False" visible="False" />
                                        <label visible="False">
                                        </label>
                                        <range sidemarginsenabled="True" />
...
<cc1:SolidFillOptions></cc1:SolidFillOptions>
                        ...
                        <legend alignmenthorizontal="Center" alignmentvertical="BottomOutside" maxverticalpercentage="5" Visibility="False"></legend>
                        <seriesserializable>
                            <cc1:Series ArgumentDataMember="Dia" Name="vlrAgenda23" ValueDataMembersSerializable="vlrAg23" LabelsVisibility="True">
                                <viewserializable>
                                    <cc1:LineSeriesView MarkerVisibility="True">
                                        <linemarkeroptions BorderVisible="True" size="3">
                                        </linemarkeroptions>
                            ...
                            <cc1:Series ArgumentDataMember="Dia" Name="vlrDivergencia" ValueDataMembersSerializable="vlrDivergencia" LabelsVisibility="True">
                                <viewserializable>
                                    <cc1:LineSeriesView AxisYName="Clientes AxisY " MarkerVisibility="True" PaneName="Pane 5">
                                        <linemarkeroptions BorderVisible="True" size="5">
                                        </linemarkeroptions>
...
<cc1:PointOptions></cc1:PointOptions>
                        ...
                        <titles>
                            <cc1:ChartTitle Font="Tahoma, 12pt" Text="Análise Valor Agenda 23 (lixo) e Valor Divergência - Ano 2015" />
                        </titles>
...
<cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
    ...
    <dx:ASPxTextBox ID="txtDias" runat="server" Width="170px" ClientInstanceName="txtDias"></dx:ASPxTextBox>
            ...
            <ContentCollection >
                ...
                <dx:PopupControlContentControl >
                    <div>
                        ...
                        <p>O programa PGR292 "Análise Item Diário - 2 Meses" exibe as seguintes informações do produto selecionado:</p>
                        ...
                        <p>Essas informações são exibidas dia-a-dia em um período de 2 meses, sempre à partir do dia de ontem.</p>
                        ...
                        <asp:Image ID="Image10" runat="server" ImageUrl="~/MemberPages/Manual/PGR292/fig_09.png"  />
                      ...
                      <p>No segundo gráfico nós temos as informações de:</p>
                        ...
                        <asp:Image ID="Image11" runat="server" ImageUrl="~/MemberPages/Manual/PGR292/fig_11.png"  />
