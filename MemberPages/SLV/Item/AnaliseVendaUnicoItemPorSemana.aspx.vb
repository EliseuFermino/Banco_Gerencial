...
Partial Class MemberPages_SLV_Item_AnaliseVendaUnicoItemPorSemana
...
#Region " Page"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            oVen.AtualizarEstatisticaPrograma(295, User.Identity.Name)
        End If

        If pcManual.IsCallback Then
            oVen.AtualizarEstatisticaPrograma(300, User.Identity.Name)
        End If
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Análise Semanal - PGR295 - Uma semana vai de Segunda à Domingo"
        End If
    End Sub
