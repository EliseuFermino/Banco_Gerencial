<%@ Page Title="Comparativo Crescimento Item" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="AnaliseCompCrescItem_Deptos.aspx.vb" Inherits="MemberPages_SLV_AnaliseCompCrescItem_Deptos" %>
...
<LoadingPanelStyle VerticalAlign="Bottom"></LoadingPanelStyle>
        <PanelCollection>
            <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttributes="both">
                ...
                <div id="divDados">
                    <dx:ASPxGridView ID="grid" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" KeyFieldName="CodProduto" Width="1000px" Visible="False">
                        <TotalSummary>
...
<dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="Estoque em " VisibleIndex="14" Name="bandEstoque"><Columns>
    ...
    <HeaderStyle BackColor="#003366" ForeColor="White" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:gerVendaItemConnectionString %>" SelectCommand="Analises.usp_AnaliseCompCrescItem" SelectCommandType="StoredProcedure">
                        <SelectParameters>                           
