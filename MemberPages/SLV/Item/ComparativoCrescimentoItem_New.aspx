<%@ Page Title="Comparativo Crescimento Item" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="ComparativoCrescimentoItem_New.aspx.vb" Inherits="MemberPages_SLV_Item_ComparativoCrescimentoItem_New" %>
                ...
                <div id="divDados">
                    <dx:ASPxGridView ID="grid" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" KeyFieldName="CodProduto" Width="1000px">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="Comprador" FieldName="nomeCompradorAbrev" ShowInCustomizationForm="True" ToolTip="Nome do Comprador que compra o produto" VisibleIndex="13" Width="90px">
                                <Settings AllowAutoFilter="True" AutoFilterCondition="Contains" />
                            ...
                            <dx:GridViewDataTextColumn Caption="EAN" FieldName="EAN" ShowInCustomizationForm="True" VisibleIndex="15" Width="120px">
