...
Partial Class MemberPages_SLV_SLV001_W
...
#Region " grid"
    ...
    Protected Sub grid_CustomUnboundColumnData(sender As Object, e As DevExpress.Web.ASPxGridViewColumnDataEventArgs) Handles grid.CustomUnboundColumnData
        ...
        oFun.Grid_Calculate(e, "vlrDif_Vendas", "vAT", "vAA", Funcoes.CalculateType.Decrease)
        oFun.Grid_Calculate(e, "vlrDif_Volume", "qAT", "qAA", Funcoes.CalculateType.Decrease)
        oFun.Grid_Calculate(e, "vlrDif_LucroPDV", "mAT", "mAA", Funcoes.CalculateType.Decrease)
    ...
    Protected Sub grid_HtmlDataCellPrepared(sender As Object, e As ASPxGridViewTableDataCellEventArgs) Handles grid.HtmlDataCellPrepared
        ...
        oFun.Grid_RedIsNegative(e, "vlrDif_Vendas")
        oFun.Grid_RedIsNegative(e, "vlrDif_Volume")
        oFun.Grid_RedIsNegative(e, "vlrDif_LucroPDV")
