<%@ Page Title="" Language="VB" MasterPageFile="~/MemberPages/Patrimonio/mPatrimonio.master" AutoEventWireup="false" CodeFile="CadPatrimonio.aspx.vb" Inherits="MemberPages_Patrimonio_CadPatrimonio" %>
    ...
    <div class="container">
       ...
       <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        ...
        <div id="divCabecalho" class="container bg-warning fundo2">         
            ...
            <div class="row">    
                <div class="col-md-5 "><h2 class="Negrito"><span class="glyphicon glyphicon-file"></span> Cadastro de Furtos</h2></div>            
