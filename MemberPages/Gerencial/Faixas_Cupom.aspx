<%@ Page Title="" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="Faixas_Cupom.aspx.vb" Inherits="MemberPages_Gerencial_Faixas_Cupom" %>
...
<LoadingPanelImage AlternateText="Aguarde. Atualizando"></LoadingPanelImage>
            <PanelCollection>
                <dx:PanelContent>
                    ...
                    <dx:ASPxGridView ID="grid" runat="server" DataSourceID="dsDados" AutoGenerateColumns="False">
		...
		<asp:SqlDataSource ID="dsDados" runat="server" ConnectionString="<%$ ConnectionStrings:gerTempConnectionString %>" SelectCommand="dbo.usp_Buscar_Faixas_Cupons" SelectCommandType="StoredProcedure">
                        <SelectParameters>
    ...
    <uc1:wucObsPrograma runat="server" ID="wucObsPrograma" Anotacao1="Database: gerTemp" Anotacao2="Stored Procedure: dbo.usp_Buscar_Faixas_Cupons" />
