...
Partial Class MemberPages_Gerencial_Faixas_Cupom_Aniversario
...
#Region " Page"
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        If Not IsPostBack Then
            CType(Master.FindControl("lblTitle"), Label).Text = "Cupons de Vendas por Faixas - Aniversário - PGR399"
        End If
    End Sub
