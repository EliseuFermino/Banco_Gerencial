<%@ Page Title="" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="AnaliseSecaoMensal.aspx.vb" Inherits="MemberPages_Gerencial_AnaliseSecao" %>
...
<SettingsLoadingPanel Text="Aguarde. Atualizando"></SettingsLoadingPanel>
    ...
    <div id="divCrescimentoVenda">
        <dxchartsui:WebChartControl ID="graphCrescimentoVenda" runat="server" DataSourceID="dsCrescVenda" Height="300px" Width="1000px">
            <diagramserializable>
                <cc1:XYDiagram PaneDistance="5">
                    <axisx visibleinpanesserializable="-1" interlaced="True" minorcount="1">
...
<WholeRange AlwaysShowZeroLevel="False"></WholeRange>
            ...
            <seriesserializable>
                <cc1:Series ArgumentDataMember="Periodo" LabelsVisibility="True" Name="% de Crescimento de Vendas" ValueDataMembersSerializable="percCresc" ArgumentScaleType="Qualitative" SeriesPointsSorting="Ascending">
                    ...
                    <labelserializable>
                        <cc1:SideBySideBarSeriesLabel LineVisible="True" Indent="1" TextPattern="{V:n2}">
                            <fillstyle>
                                <optionsserializable>
                                    <cc1:SolidFillOptions />
                                </optionsserializable>
    ...
    <div id="divNumCliente">
        <dxchartsui:WebChartControl ID="graphNumCliente" runat="server" DataSourceID="dsGraphTicket" Height="300px" Width="1000px">
            <diagramserializable>
                <cc1:XYDiagram>
                    <axisx visibleinpanesserializable="-1" minorcount="1">
                        ...
                        <numericscaleoptions autogrid="False" gridoffset="1" gridspacing="0.5" />
                    </axisx>
            ...
            <legend alignmenthorizontal="Center" alignmentvertical="BottomOutside" Visibility="False"></legend>
            <seriesserializable>
                <cc1:Series ArgumentDataMember="Periodo" LabelsVisibility="True" Name="Nº de Clientes" ValueDataMembersSerializable="numCliente" ArgumentScaleType="Qualitative">
                    <viewserializable>
                    ...
                    <labelserializable>
                        <cc1:StackedLineSeriesLabel Angle="90" LineVisible="True" Font="Tahoma, 7pt" TextPattern="{V:n0}">
                            <fillstyle>
                                <optionsserializable>
                                    <cc1:SolidFillOptions />
                                </optionsserializable>
    ...
    <div id="divCrescimentoClientes">
        <dxchartsui:WebChartControl ID="graphNCrescimentoClientes" runat="server" DataSourceID="dsCrescCliente" Height="300px" Width="1000px" AppearanceNameSerializable="Nature Colors">
            <diagramserializable>
                <cc1:XYDiagram>
                    <axisx visibleinpanesserializable="-1" reverse="True" minorcount="1">
                        <qualitativescaleoptions autogrid="False" gridoffset="1" />
                        <label angle="90">
                        </label>
                        <range sidemarginsenabled="True" />
...
<cc1:SolidFillOptions></cc1:SolidFillOptions>
            ...
            <seriesserializable>
                <cc1:Series ArgumentDataMember="Periodo" Name="Volume por Cliente" ValueDataMembersSerializable="VolumeCliente" LabelsVisibility="True" ArgumentScaleType="Qualitative">
                    <viewserializable>
                        <cc1:StackedLineSeriesView>
                    ...
                    <labelserializable>
                        <cc1:StackedLineSeriesLabel LineVisible="True" Angle="90" Font="Tahoma, 7pt" TextPattern="{V:n2}">
                            <fillstyle>
                                <optionsserializable>
                                    <cc1:SolidFillOptions />
                                </optionsserializable>
...
<cc1:SolidFillOptions></cc1:SolidFillOptions>
            ...
            <legend alignmenthorizontal="Center" alignmentvertical="BottomOutside" Visibility="False"></legend>
            <seriesserializable>
                <cc1:Series ArgumentDataMember="Periodo" LabelsVisibility="True" Name="Ticket Médio" ValueDataMembersSerializable="TicketMedio" ArgumentScaleType="Qualitative">
                    <viewserializable>
                        <cc1:StackedLineSeriesView MarkerVisibility="True">
                            <linemarkeroptions size="5" BorderVisible="True">
                            </linemarkeroptions>
                    ...
                    <labelserializable>
                        <cc1:StackedLineSeriesLabel Angle="90" LineVisible="True" Font="Tahoma, 7pt" TextPattern="{V:n2}">
                            <fillstyle>
                                <optionsserializable>
                                    <cc1:SolidFillOptions />
                                </optionsserializable>
