<%@ Page Title="Projeção de Vendas" Language="VB" MasterPageFile="~/MemberPages/SiteVendas.master" AutoEventWireup="false" CodeFile="ProjecaoVendaSecao.aspx.vb" Inherits="MemberPages_Gerencial_ProjecaoVendaSecao" %>
                ...
                <dxwgv:GridViewToolbar EnableAdaptivity="true">
                    ...
                    <TotalSummary>
                        ...
                        <dxwgv:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="percAting" 
                            SummaryType="Custom" />
                        <dxwgv:ASPxSummaryItem DisplayFormat="{0:n2}" FieldName="perCrescAting" SummaryType="Custom" />
                    ...
                    <Columns>
                        ...
                        <dxe:GridViewBandColumn Caption="% Margem" ToolTip="Percentual de Margem PDV e Margem Final" VisibleIndex="7">
                            <Columns>
                                <dxe:GridViewDataTextColumn Caption="PDV" FieldName="percMargReal" VisibleIndex="0" Width="60px">
                                    <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                    </PropertiesTextEdit>
                                    <Settings AllowAutoFilter="False" />
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn Caption="Final" FieldName="percMargCheia" VisibleIndex="1" Width="60px">
                                    <PropertiesTextEdit DisplayFormatString="{0:n2}" EncodeHtml="False">
                                    </PropertiesTextEdit>
                                    <Settings AllowAutoFilter="False" />
                                </dxe:GridViewDataTextColumn>
