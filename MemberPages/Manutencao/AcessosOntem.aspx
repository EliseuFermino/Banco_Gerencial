<%@ Page Title="Acessos de Ontem" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="AcessosOntem.aspx.vb" Inherits="MemberPages_Manutencao_AcessosOntem" %>
                ...
                <dx:PanelContent runat="server" SupportsDisabledAttributes="both">
                    <dx:ASPxGridView ID="gridAcessoHoje" runat="server" AutoGenerateColumns="False" DataSourceID="dsAcessoHoje" KeyFieldName="idPrograma" Width="1220px">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="DescPrograma" ShowInCustomizationForm="True" VisibleIndex="2" Caption="Nome do Programa" Width="500px">
                    ...
                    <asp:SqlDataSource ID="dsAcessoHoje" runat="server" ConnectionString="<%$ ConnectionStrings:gerContSQL1ConnectionString %>" SelectCommand="Estatistica.uspBuscarAcessosOntem" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                </dx:PanelContent>
            </PanelCollection>
