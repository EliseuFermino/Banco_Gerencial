<%@ Page Title="" Language="VB" MasterPageFile="~/MemberPages/RPM/masterRPM.master" AutoEventWireup="false" CodeFile="rpmTarefasHoje.aspx.vb" Inherits="MemberPages_RPM_rpmTarefasHoje" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:gerRPMConnectionString %>"  
    SelectCommand="Dados.uspBuscarTarefasHoje" SelectCommandType="StoredProcedure">
