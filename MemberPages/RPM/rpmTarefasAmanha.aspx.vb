...
Partial Class MemberPages_RPM_rpmTarefasAmanha
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            oFun.Grid_Title(grid, "Tarefas de Amanhã - " & DateAndTime.Today.AddDays(1) & ".")
        End If
    End Sub
    ...
    Sub BuscarTarefa_RPM()
        ...
        Try
            ...
            While reader5.Read
                ...
                cboDia.Text = CDate(reader5.GetSqlString(2))    'Prazo
