<%@ Page Title="" Language="VB" MasterPageFile="~/MemberPages/RPM/masterRPM.master" AutoEventWireup="false" CodeFile="rpmTarefasAmanha.aspx.vb" Inherits="MemberPages_RPM_rpmTarefasAmanha" %>
          ...
          .dxbButton_Aqua
{
	...
	OnGridFocusedRowChanged();
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="Conclusão" FieldName="Conclusao" VisibleIndex="7" Width="80px">
                <PropertiesTextEdit DisplayFormatString="{0:dd/MM/yyyy} " EncodeHtml="False">
                </PropertiesTextEdit>
                <CellStyle HorizontalAlign="Center">
                </CellStyle>
        ...
        <Settings ShowFilterRow="True" ShowGroupPanel="True" VerticalScrollableHeight="400" ShowTitlePanel="True" ShowFooter="True" />
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:gerRPMConnectionString %>"  
    SelectCommand="Dados.uspBuscarTarefasAmanha" SelectCommandType="StoredProcedure">
