...
Partial Class MemberPages_RPM_rpmTodasTarefas
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            oFun.Grid_Title(grid, "Todas as Tarefas")
            grid.SettingsDataSecurity.AllowReadUnlistedFieldsFromClientApi = DevExpress.Utils.DefaultBoolean.True
        End If
    End Sub
...
#Region " ALTERAÇÃO"
    ...
    Sub BuscarTarefa_RPM()
        ...
        Dim strSQL As String = "SELECT Descricao, Solicitante, CONVERT(CHAR(10),Prazo,103) AS Prazo,Duração,Status,Categoria,Projeto,CONVERT(CHAR(10),Conclusao,103) AS Conclusao FROM Dados.vwTodasTarefas WHERE ID = " & Me.txtTarefaID.Value & ""
