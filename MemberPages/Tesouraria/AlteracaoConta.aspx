<%@ Page Title="Alterar Coadastro" Language="VB" MasterPageFile="~/MemberPages/Site.master" AutoEventWireup="false" CodeFile="AlteracaoConta.aspx.vb" Inherits="Tesouraria_AlteracaoConta" %>
...
&nbsp;</td>
            ...
            <tr>
                <td class="auto-style21">Cta. Destino Banco:</td>
                <td class="auto-style12">
                    <asp:TextBox ID="txtCtaDestinoBanco" runat="server" Enabled="false" TabIndex="81"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>  <%--Cta. Destino Banco--%>
            <tr>
                <td class="auto-style21">Cta. Destino Agência:</td>
                <td class="auto-style12">
                    <asp:TextBox ID="txtCtaDestinoAgencia" runat="server" Enabled="false" TabIndex="82"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>  <%--Cta. Destino Agencia--%>
            <tr>
                <td class="auto-style5">Cta. Destino DV:</td>
                <td class="auto-style14">
                    <asp:TextBox ID="txtCtaDestinoDV" runat="server" Width="63px" Enabled="false" TabIndex="83"></asp:TextBox>
                </td>
                    ...
                    <table cellspacing="1" class="auto-style1">
                        <tr>
                            <td class="auto-style11">
                                &nbsp;</td>
                            <td class="auto-style11">
                                <asp:Button ID="btnAlterar" runat="server" Text="Alterar" Width="100px" style="height: 26px" TabIndex="85" />
                            </td>
                            <td>
                                &nbsp;</td>
                            <td>&nbsp;</td>
                ...
                <td>                    
                    <ajaxToolkit:TextBoxWatermarkExtender ID="TBWE_Complemento" runat="server" 
                        TargetControlID="txtComplemento"
                         WatermarkText="Apto., Sobrado, Bloco e etc." WatermarkCssClass="watermarked" 
                          />                        
                </td>
