...
Partial Class Default2
    ...
    Private Sub CreateCookies()
        ...
        If Request.Cookies("gerUserName") Is Nothing Then

            Dim aCookie As New HttpCookie("gerUserName")

            aCookie.Value = User.Identity.Name
        ...
        Else
            ...
            Dim cookie As HttpCookie = HttpContext.Current.Request.Cookies("gerUserName")
