<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wuc_KPI_Secao_Depto_Bazar.ascx.vb" Inherits="Controles_wuc_KPI_Secao_Depto_Bazar" %>
...
<%-- <div class="container-fluid">
   ...
   <div class="row">
    ...
    <cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                ...
                                <asp:SqlDataSource ID="dsCrescimentoVendas" runat="server" ConnectionString="<%$ ConnectionStrings:DW_VendasConnectionString %>" SelectCommand="uspBuscarCrescimentoVendas_12Meses_Bazar" SelectCommandType="StoredProcedure">
