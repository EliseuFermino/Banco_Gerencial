<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wucAnoMesFilial.ascx.vb" Inherits="Controles_wuciAno" %>
<%@ Register assembly="DevExpress.Web.v18.2, Version=18.2.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>
<%@ Register src="wucBotaoAtualizar.ascx" tagname="wucBotaoAtualizar" tagprefix="uc1" %>
<%@ Register src="wuciListaLojasComApoio.ascx" tagname="wuciListaLojasComApoio" tagprefix="uc2" %>
<style type="text/css">
    .auto-style1 {
        width: 168px;
    }
    ...
    <tr>
        ...
        <td align="left" class="auto-style3" valign="top">
            <dx:ASPxComboBox ID="cboAno" runat="server" DataSourceID="dsListaAno" 
                EnableTheming="True" TextField="Ano" Theme="DevEx" ValueField="Ano" 
                Width="70px" ShowShadow="False" Native="True">
            </dx:ASPxComboBox>
    <asp:SqlDataSource ID="dsListaAno" runat="server" 
        ...
        <td align="left" valign="top" class="auto-style6">
            <dx:ASPxComboBox ID="cboMes" runat="server" EnableTheming="True" 
                SelectedIndex="1" Theme="DevEx" Width="110px" DropDownRows="12" 
                ShowShadow="False" Native="True">
                <Items>
        ...
        <td align="left" valign="top">
            <uc2:wuciListaLojasComApoio ID="cboFilial" runat="server" />
        </td>
        <td align="left" valign="top">
