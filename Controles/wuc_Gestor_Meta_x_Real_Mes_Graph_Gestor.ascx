<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wuc_Gestor_Meta_x_Real_Mes_Graph_Gestor.ascx.vb" Inherits="Controles_wuc_Gestor_Meta_x_Real_Mes_Graph_Gestor" %>
...
<Legend Name="Default Legend" AlignmentHorizontal="Center" AlignmentVertical="BottomOutside" Direction="LeftToRight" Visibility="True"></Legend>
        ...
        <asp:SqlDataSource ID="ds_Graph_Mes_Empresa" runat="server" ConnectionString="<%$ ConnectionStrings:gerMetasConnectionString %>" SelectCommand="Gestor.usp_Graph_Mes_Empresa" SelectCommandType="StoredProcedure">
            <SelectParameters>
