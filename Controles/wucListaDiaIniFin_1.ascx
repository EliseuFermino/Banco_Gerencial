<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wucListaDiaIniFin_1.ascx.vb" Inherits="Controles_wucListaDiaIniFin_1" %>
...
<style type="text/css">
    ...
    #div_wucListaDiaIniFin {       
        ...
        <div id="div_wucListaDiaIniFin">
            ...
            <dx:ASPxDateEdit ID="cboDiaInicial" runat="server" Theme="Mulberry" AutoPostBack="true" 
            ...
            <div id="divDiaFinal">
            <dx:ASPxDateEdit ID="cboDiaFinal" runat="server" Theme="Mulberry"  AutoPostBack="true"
            ...
            <div id="divMesmosDias">
                <dx:ASPxCheckBox ID="chkMesmosDias" runat="server" Visible ="False" Theme ="DevEx" ForeColor ="Blue" Text ="Mesmos Dias" AutoPostBack="true"  
