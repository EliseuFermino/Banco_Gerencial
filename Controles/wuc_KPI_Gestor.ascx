<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wuc_KPI_Gestor.ascx.vb" Inherits="Controles_wuc_KPI_Gestor" %>
...
<%-- <div class="container-fluid">
   ...
   <div class="row">
    ...
    <cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                ...
                                <asp:SqlDataSource ID="dsCrescimentoVendas" runat="server" ConnectionString="<%$ ConnectionStrings:DW_VendasConnectionString %>" SelectCommand="uspBuscarCrescimentoVendas_12Meses_Gestor" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
