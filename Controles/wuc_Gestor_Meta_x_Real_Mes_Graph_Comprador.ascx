<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wuc_Gestor_Meta_x_Real_Mes_Graph_Comprador.ascx.vb" Inherits="Controles_wuc_Gestor_Meta_x_Real_Mes_Graph_Comprador" %>
...
<Legend Name="Default Legend" AlignmentHorizontal="Center" AlignmentVertical="BottomOutside" Direction="LeftToRight" Visibility="True"></Legend>
        ...
        <asp:SqlDataSource ID="ds_Graph_Mes_Empresa" runat="server" ConnectionString="<%$ ConnectionStrings:gerMetasConnectionString %>" SelectCommand="Comprador.usp_Graph_Mes_Empresa" SelectCommandType="StoredProcedure">
            <SelectParameters>
