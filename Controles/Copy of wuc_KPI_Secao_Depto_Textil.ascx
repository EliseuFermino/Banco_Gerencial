<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Copy of wuc_KPI_Secao_Depto_Textil.ascx.vb" Inherits="Controles_wuc_KPI_Secao_Depto_Textil" %>
...
<%-- <div class="container-fluid">
   ...
   <div class="row">
    ...
    <cc1:SolidFillOptions></cc1:SolidFillOptions>
                                    ...
                                    <seriesserializable>
                                        <cc1:Series ArgumentDataMember="descMes" LabelsVisibility="True" Name="2016" ValueDataMembersSerializable="numDadosAAAA">
                                            <viewserializable>
                                        ...
                                        <cc1:Series ArgumentDataMember="descMes" LabelsVisibility="True" Name="2017" ValueDataMembersSerializable="numDadosAAA">
                                            <viewserializable>
                                                <cc1:SideBySideBarSeriesView>
                                                </cc1:SideBySideBarSeriesView>
                                            </viewserializable>
                                        ...
                                        <cc1:Series ArgumentDataMember="descMes" Name="2018" ValueDataMembersSerializable="numDadosAA" LabelsVisibility="True">
                                            <viewserializable>
                                        ...
                                        <cc1:Series ArgumentDataMember="descMes" Name="2019" ValueDataMembersSerializable="numDadosAT" LabelsVisibility="True">
                                            <viewserializable>
                                                <cc1:SideBySideBarSeriesView Transparency="90">
                                                    <fillstyle fillmode="Solid">
                                                        <optionsserializable>
    ...
    <cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                ...
                                <asp:SqlDataSource ID="dsCrescimentoVendas" runat="server" ConnectionString="<%$ ConnectionStrings:DW_VendasConnectionString %>" SelectCommand="uspBuscarCrescimentoVendas_12Meses_Textil" SelectCommandType="StoredProcedure">
