<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wucListaGrupo_Subgrupo_24122022.ascx.vb" Inherits="Controles_wucListaGrupo_Subgrupo" %>
...
<table>
    ...
    SelectCommand="WITH cte As(
SELECT idGrupo, GrupoDesc, Ordem FROM Cadastros.tblCategoriaLinha WHERE (idCat = @idCat)">
        <SelectParameters>
