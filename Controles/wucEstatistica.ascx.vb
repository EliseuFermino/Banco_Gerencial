...
Partial Class Controles_wucEstatistica
    ...
    Protected Sub rndEquipe_CheckedChanged(sender As Object, e As EventArgs) Handles rndEquipe.CheckedChanged
        If Me.rndEquipe.Checked = True Then
            Me.gridDuracaoEquipe.Visible = True
            Me.gridDuracaoLote.Visible = False
        End If
    End Sub

    Protected Sub rndLote_CheckedChanged(sender As Object, e As EventArgs) Handles rndLote.CheckedChanged
        If Me.rndLote.Checked = True Then
            Me.gridDuracaoEquipe.Visible = False
            Me.gridDuracaoLote.Visible = True
        End If
    End Sub
End Class
