<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wuc_KPI_Secao_Depto.ascx.vb" Inherits="Controles_wuc_KPI_Secao_Depto" %>
...
<%-- <div class="container-fluid">
   ...
   <div class="row">
    ...
    <cc1:SolidFillOptions></cc1:SolidFillOptions>
                                    ...
                                    <seriesserializable>
                                        <cc1:Series ArgumentDataMember="descMes" LabelsVisibility="True" Name="2018" ValueDataMembersSerializable="numDadosAAAAA">
                                            <legendpointoptionsserializable>
                                                <cc1:PointOptions>
                                                </cc1:PointOptions>
                                            </legendpointoptionsserializable>
                                            <viewserializable>
                                                <cc1:SideBySideBarSeriesView BarWidth="0.7">
                                        ...
                                        <cc1:Series ArgumentDataMember="descMes" LabelsVisibility="True" Name="2020" ValueDataMembersSerializable="numDadosAAA">
                                            ...
                                            <viewserializable>
                                                <cc1:SideBySideBarSeriesView BarWidth="0.7" Color="147, 137, 83">
                                        ...
                                        <cc1:Series ArgumentDataMember="descMes" Name="2021" ValueDataMembersSerializable="numDadosAA" LabelsVisibility="True">
                                            <viewserializable>
                                                <cc1:SideBySideBarSeriesView Transparency="90" BarWidth="0.7" Color="0, 45, 138">
                                                    <fillstyle fillmode="Solid">
                                                        <optionsserializable>
                                                            <cc1:SolidFillOptions />
                                                        </optionsserializable>
                                        ...
                                        <cc1:Series ArgumentDataMember="descMes" Name="2022" ValueDataMembersSerializable="numDadosAT" LabelsVisibility="True">
                                            <viewserializable>
                                                <cc1:SideBySideBarSeriesView Transparency="90" BarWidth="0.7" Color="0, 176, 80">
                                                    <fillstyle fillmode="Solid">
                                                        <optionsserializable>
                                                            <cc1:SolidFillOptions />
                                                        </optionsserializable>
    ...
    <cc1:PointOptions></cc1:PointOptions>
                                    ...
                                    <titles>
                                        <cc1:ChartTitle Font="Tahoma, 12pt" Text="Percentual de Crescimento de Vendas - Últimos 5 Anos" TextColor="Black" />
                                    </titles>
    ...
    <cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                                ...
                                <asp:SqlDataSource ID="dsCrescimentoVendas" runat="server" ConnectionString="<%$ ConnectionStrings:DW_VendasConnectionString %>" SelectCommand="uspBuscarCrescimentoVendas_12Meses" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="idFilial" SessionField="sFILIAL" Type="Int16" DefaultValue="99" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
