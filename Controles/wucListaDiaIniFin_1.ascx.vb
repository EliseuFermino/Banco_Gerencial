...
Partial Class Controles_wucListaDiaIniFin_1
    ...
    Public Property Visible_divDescPerioodo_a() As Boolean
        Get
            Return divDescPeriodoE.Visible
        End Get
        Set(ByVal value As Boolean)
            divDescPeriodoE.Visible = value
        End Set
    End Property
