...
Public Class clData_DW_Condor

    Public Shared dbConnect As String = ConnectionStrings("DW_Condor_One_ConnectionString").ConnectionString
    ...
    Public Shared Sub uspFilialDias(ByVal NomeProcedureStored As String, ByVal iFilial As Int16, ByVal iDiaInicial As Date, ByVal iDiaFinal As Date, ByVal iUsuario As String)
        ...
        Dim Parameter1 As New SqlClient.SqlParameter("@DiaInicial", iDiaInicial)
        Parameter1.Direction = ParameterDirection.Input
        Parameter1.DbType = DbType.Date
        Command.Parameters.Add(Parameter1)

        Dim Parameter2 As New SqlClient.SqlParameter("@DiaFinal", iDiaFinal)
        Parameter2.Direction = ParameterDirection.Input
    ...
    Public Shared Sub uspDeptoDias(ByVal NomeProcedureStored As String, ByVal iDepto As Int16, ByVal iDiaInicial As Date, ByVal iDiaFinal As Date, ByVal iUsuario As String)
        ...
        Dim Parameter0 As New SqlClient.SqlParameter("@idDepto", iDepto)
        Parameter0.Direction = ParameterDirection.Input
        Parameter0.DbType = DbType.Int16
        Command.Parameters.Add(Parameter0)
    ...
    Public Shared Sub uspGrupoDias_FilialSecao(ByVal NomeProcedureStored As String, ByVal iFilial As Int16, ByVal iSecao As Int32, ByVal iDiaInicial As Date, ByVal iDiaFinal As Date, ByVal iUsuario As String, iTimeOut As Int16)
        ...
        Dim Parameter1 As New SqlClient.SqlParameter("@idSecao", iSecao)
        Parameter1.Direction = ParameterDirection.Input
        Parameter1.DbType = DbType.Int32
        Command.Parameters.Add(Parameter1)
    ...
    Public Shared Sub usp6_TM(ByVal NomeProcedureStored As String, _
                 ByVal iVar1 As String, ByVal iVar2 As String, ByVal iVar3 As String, ByVal iVar4 As String, ByVal iVar5 As String, ByVal iVar6 As String, _
                 ByVal iParam1 As String, ByVal iParam2 As String, ByVal iParam3 As String, _
                 ByVal iParam4 As String, ByVal iParam5 As String, ByVal iParam6 As String, iTimeOut As Int16)
        ...
        Command.Parameters.AddWithValue(iVar4, iParam4)
        Command.Parameters.AddWithValue(iVar5, iParam5)
        Command.Parameters.AddWithValue(iVar6, iParam6)
    ...
    Public Function BuscarVenda_AnoAtual(ByVal iFilial As Int16) As Decimal

        Dim con As New SqlConnection(dbConnect)
        Dim comando As New SqlCommand("Analises.uspBuscarVendaAnoAtual", con)
        ...
        Try
            ...
            While reader5.Read
                ...
                BuscarVenda_AnoAtual = reader5.GetSqlMoney(0)
            End While
        ...
        Return BuscarVenda_AnoAtual

    End Function

    Public Function BuscarVendaSecao_AnoAtual(ByVal iFilial As Int16, ByVal iSecao As Int32) As Decimal

        Dim con As New SqlConnection(dbConnect)
        Dim comando As New SqlCommand("Analises.uspBuscarVendaAnoAtualSecao", con)
        comando.CommandType = CommandType.StoredProcedure
        ...
        Try
            ...
            While reader5.Read
                ...
                BuscarVendaSecao_AnoAtual = reader5.GetSqlMoney(0)
            End While
        ...
        Return BuscarVendaSecao_AnoAtual

    End Function

    Public Function BuscarVendaReal_AnoAnteriores(ByVal iAno As Int32, ByVal iFilial As Int16) As Decimal

        Dim con As New SqlConnection(dbConnect)
        Dim comando As New SqlCommand("Vendas_Ano.uspBuscarVendaRealAnosAnteriores", con)
        comando.CommandType = CommandType.StoredProcedure
        ...
        Try
            ...
            While reader5.Read
                ...
                BuscarVendaReal_AnoAnteriores = reader5.GetSqlMoney(0)
            End While
        ...
        Return BuscarVendaReal_AnoAnteriores

    End Function

    Public Shared Function BuscarDepartamento(ByVal nomeUsuario As String) As Integer
        Dim conn As New SqlConnection(dbConnect)
        Dim cmd As New SqlCommand("Cadastros.uspBuscarDepartamento", conn)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add(New SqlParameter("@Usuario", SqlDbType.VarChar))
        cmd.Parameters("@Usuario").Value = nomeUsuario
        Try
            conn.Open()
            Dim reader5 As SqlDataReader
            ...
            While reader5.Read
                ...
                BuscarDepartamento = reader5.GetSqlByte(0)
            End While
