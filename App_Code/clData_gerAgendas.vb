...
Public Class clData_gerAgendas




    Public Shared dbConnect As String = ConnectionStrings("gerAgendasConnectionString").ConnectionString
    ...
    Public Shared Sub uspAnoMesWithTimeOut(NomeProcedureStored As String, iAno As Integer, iMes As Integer, iTimeOut As Integer)
