...
Public Class clData_gerManager


    Public Shared dbConnect As String = ConnectionStrings("gerManagerConnectionString").ConnectionString
    ...
    Public Shared Sub uspGrupoDias(ByVal NomeProcedureStored As String, ByVal iGrupo As Int16, ByVal iDiaInicial As Date, ByVal iDiaFinal As Date, ByVal iUsuario As String, iTimeOut As Int16)
    ...
    Public Shared Sub uspFornecedorDiaInicialFinal(ByVal NomeProcedureStored As String, ByVal iFornecedor As Int32, ByVal iDiaInicial As Date, ByVal iDiaFinal As Date, ByVal iUsuario As String)
        ...
        Dim Parameter0 As New SqlClient.SqlParameter("@idFornecedor", iFornecedor)
        Parameter0.Direction = ParameterDirection.Input
        Parameter0.DbType = DbType.Int32
        Command.Parameters.Add(Parameter0)
    ...
    Public Shared Sub uspFornecedorAnalise(ByVal NomeProcedureStored As String, ByVal iFornecedor As Int32, ByVal iDiaInicial As Date, ByVal iDiaFinal As Date,
                                           ByVal iUsuario As String, iBaseCNPJ As Boolean, iTipoMercadologico As Byte, iMercadologico As Int16)
        ...
        Dim Parameter4 As New SqlClient.SqlParameter("@BaseCNPJ", iBaseCNPJ)
        Parameter4.Direction = ParameterDirection.Input
        Parameter4.DbType = DbType.Boolean
        Command.Parameters.Add(Parameter4)

        Dim Parameter5 As New SqlClient.SqlParameter("@TipoMercadologico", iTipoMercadologico)
        Parameter5.Direction = ParameterDirection.Input
        Parameter5.DbType = DbType.Byte
        Command.Parameters.Add(Parameter5)

        Dim Parameter6 As New SqlClient.SqlParameter("@Mercadologico", iMercadologico)
